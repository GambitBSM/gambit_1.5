...
enum energy_deposition_function {
  ...
  GAMBIT /**< In GAMBIT the DarkAges module is not called by CLASS but by GAMBIT itself and the respective tables will be populated by GAMBIT and passed to CLASS */
};
