...
#ifndef HAVE_MATHEMATICA

  // Just use the dummy functions if Mathematica is missing
  #define BE_FUNCTION_I_MATH BE_FUNCTION_I_DUMMY
  #define BE_VARIABLE_I_MATH BE_VARIABLE_I_DUMMY
