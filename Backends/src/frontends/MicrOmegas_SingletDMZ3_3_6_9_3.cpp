...
///  \file
///
///  Frontend for MicrOmegas SingletDMZ3 3.6.9.2 backend
///
///  *********************************************
///
...
#include "gambit/Backends/frontends/MicrOmegas_SingletDMZ3_3_6_9_2.hpp"
#include <unistd.h>
...
BE_INI_FUNCTION
{
     ...
     *VWdecay = VWdecayOpt;
     ...
     logger() << LogTags::debug << "Initializing MicrOmegas SingletDMZ3 with ";
