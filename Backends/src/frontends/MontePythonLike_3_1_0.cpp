...
BE_NAMESPACE
{
  ...
  CosmoBit::Classy_cosmo_container ccc;
  
  double get_MP_loglike(std::string like)
  {
...
BE_INI_FUNCTION
{
	...
	//CosmoBit::Classy_cosmo_container ccc = *Dep::classy_python_obj;
	...
	if(first_run)
	{
		...
		ccc.data = MontePythonLike.attr("Data")("",path_dict,experiments,mcmc_parameters);
		...
		pybind11::object BAO = bao.attr("bao")(bao_path, ccc.data, command_line);
		ccc.likelihoods["bao"] = BAO;
