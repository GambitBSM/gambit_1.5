...
///  \file
///
///  Frontend for MicrOmegas DiracDM 3.6.9.2 backend
///
///  *********************************************
///
...
#include "gambit/Backends/frontends/MicrOmegas_DiracDM_3_6_9_2.hpp"
#include <unistd.h>
...
BE_INI_FUNCTION
{
     ...
     *VWdecay = VWdecayOpt;
     ...
     logger() << LogTags::debug << "Initializing MicrOmegas DiracDM with ";
     ...
     error = assignVal((char*)"lF", lambda);
