...
BE_NAMESPACE
{
  ...
  void fill_cosmomodel(AlterBBN::AlterBBN_2_0::relicparam * input_relicparam, map_str_dbl & AlterBBN_input)
  {
    ...
    if(first_run)
    {
      ...
      {
        if(known_relicparam_options.count(it->first)==0) // check if unknown option contained in AlterBBN_input map
        {
