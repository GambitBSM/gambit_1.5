...
BE_NAMESPACE
{
  ...
  void fill_cosmomodel(AlterBBN_2_0::relicparam * input_relicparam, map_str_dbl & AlterBBN_input)
  {
    ...
    // to overwrite the default value of another relicparam structure member add a line like the ones
  ...
  {
    AlterBBN_2_0::relicparam input_relicparam;
