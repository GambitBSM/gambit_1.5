...
BE_INI_FUNCTION
{
  ...
  *already_calculated = false;
  ...
  logger().send("Message from \'DarkAges_1.2.0_ini\'. Starting now to execute \'calc_f_decay\'.",LogTags::info);
  calc_f_decay(Energies,dNdE_e,dNdE_ph,mass,lifetime);
  logger().send("Message from \'DarkAges_1.2.0_ini\'. Done executing \'calc_f_decay\'.",LogTags::info);
}
END_BE_INI_FUNCTION
