...
int main()
{
  ...
  /* Manually setting result variable in LibFirstCopy */
  
  double tempDouble = 1.234;
  std::cout << "Manually setting variable 'someDouble' in LibFirstCopy to: " << tempDouble << std::endl;
  GAMBIT::Backend::LibFirstCopy::setSomeDouble(tempDouble);
  myResult = GAMBIT::Backend::LibFirstCopy::returnResult();
  std::cout << "Function 'returnResult' returned: " << myResult << std::endl; 
  ...
  int myTotal; 
  myTotal = GAMBIT::Backend::LibFortranCode::total(2,3);
