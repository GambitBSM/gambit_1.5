#ifndef __boss__Info_Pythia_8_209_h__
#define __boss__Info_Pythia_8_209_h__
...
#include "backend_types/Pythia_8_209/abstract_Info.h"
...
private:
  ...
  void setHasUnresolvedBeams(bool hasUnresBeamsIn)
    {hasUnresBeams = hasUnresBeamsIn;}
        ...
        public:
            int& LHEFversionSave_ref__BOSS();

            std::vector<double,std::allocator<double> >& sigmaLHEFSave_ref__BOSS();

            std::map<std::basic_string<char, std::char_traits<char>, std::allocator<char> >,std::basic_string<char, std::char_traits<char>, std::allocator<char> >,std::less<std::basic_string<char, std::char_traits<char>, std::allocator<char> > >,std::allocator<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, std::basic_string<char, std::char_traits<char>, std::allocator<char> > > > >*& eventAttributes_ref__BOSS();

            std::map<std::basic_string<char, std::char_traits<char>, std::allocator<char> >,double,std::less<std::basic_string<char, std::char_traits<char>, std::allocator<char> > >,std::allocator<std::pair<const std::basic_string<char, std::char_traits<char>, std::allocator<char> >, double> > >*& weights_detailed_ref__BOSS();

            std::vector<double,std::allocator<double> >*& weights_compressed_ref__BOSS();
        ...
        public:
            ...
            std::basic_string<char,std::char_traits<char>,std::allocator<char> > getEventAttribute__BOSS(std::basic_string<char,std::char_traits<char>,std::allocator<char> >);

            std::basic_string<char,std::char_traits<char>,std::allocator<char> > getGeneratorValue__BOSS();

            std::basic_string<char,std::char_traits<char>,std::allocator<char> > getGeneratorAttribute__BOSS(unsigned int, std::basic_string<char,std::char_traits<char>,std::allocator<char> >);

            std::basic_string<char,std::char_traits<char>,std::allocator<char> > getWeightsDetailedAttribute__BOSS(std::basic_string<char,std::char_traits<char>,std::allocator<char> >, std::basic_string<char,std::char_traits<char>,std::allocator<char> >);

            std::basic_string<char,std::char_traits<char>,std::allocator<char> > getWeightsCompressedAttribute__BOSS(std::basic_string<char,std::char_traits<char>,std::allocator<char> >);

            std::basic_string<char,std::char_traits<char>,std::allocator<char> > getScalesValue__BOSS();
        ...
        private:
            ...
            void setHardDiff__BOSS(bool, bool, bool, double, double, double);

            void setHardDiff__BOSS(bool, bool, bool, double, double);

            void setHardDiff__BOSS(bool, bool, bool, double);

            void setHardDiff__BOSS(bool, bool, bool);

            void setHardDiff__BOSS(bool, bool);

            void setHardDiff__BOSS(bool);

            void setHardDiff__BOSS();
...
#endif /* __boss__Info_Pythia_8_209_h__ */
