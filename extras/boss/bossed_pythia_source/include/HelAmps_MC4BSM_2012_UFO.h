...
#ifndef HelAmps_MC4BSM_2012_UFO_H
#define HelAmps_MC4BSM_2012_UFO_H
...
namespace Pythia8_MC4BSM_2012_UFO 
{
...
void FFS4P0_1(complex<double> F2[], complex<double> S3[], complex<double> COUP,
    double M1, double W1, complex<double> F1[]);
...
}  // end namespace Pythia8_MC4BSM_2012_UFO

#endif  // HelAmps_MC4BSM_2012_UFO_H
