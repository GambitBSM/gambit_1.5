...
def copyFilesToSourceTree(verbose=False):
    ...
    # cp_source = os.path.join(cfg.extra_output_dir, gb.gambit_backend_types_basedir, gb.gambit_backend_name_full)
    # cp_target = os.path.join(cfg.include_paths[0], gb.gambit_backend_types_basedir, gb.gambit_backend_name_full)
    # source_target_tuples.append( (cp_source, cp_target) )
