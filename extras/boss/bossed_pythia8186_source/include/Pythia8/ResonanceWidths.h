#ifndef __boss__ResonanceWidths_Pythia_8_186_h__
#define __boss__ResonanceWidths_Pythia_8_186_h__
...
#include "backend_types/Pythia_8_186/abstract_ResonanceWidths.h"
#include "gambit/Backends/abstracttypedefs.h"
#include "gambit/Backends/wrappertypedefs.h"
namespace Pythia8 { 
class ResonanceWidths : public virtual Abstract_ResonanceWidths {
...
protected:
  ...
  double numInt2BW(double mHatIn, double m1, double Gamma1, double mMin1,
    double m2, double Gamma2, double mMin2, int psMode = 1);
        ...
        public:
            Abstract_ResonanceWidths* pointerCopy__BOSS();

            void pointerAssign__BOSS(Abstract_ResonanceWidths* in);


        public:
            void initBasic__BOSS(int);

            bool init__BOSS(Pythia8::Abstract_Info*, Pythia8::Abstract_Settings*, Pythia8::Abstract_ParticleData*, Pythia8::Abstract_Couplings*);

            double width__BOSS(int, double, int, bool, bool, int);

            double width__BOSS(int, double, int, bool, bool);

            double width__BOSS(int, double, int, bool);

            double width__BOSS(int, double, int);

            double width__BOSS(int, double);

            double widthOpen__BOSS(int, double);

            double widthStore__BOSS(int, double);

        protected:
            void calcPreFac__BOSS();

            void calcWidth__BOSS();

            double numInt1BW__BOSS(double, double, double, double, double);

            double numInt2BW__BOSS(double, double, double, double, double, double, double);
...
#define ENUMS_DECLARED
#include "backend_types/Pythia_8_186/abstract_ResonanceGmZ.h"
#include "gambit/Backends/abstracttypedefs.h"
#include "gambit/Backends/wrappertypedefs.h"
namespace Pythia8 { 
class ResonanceGmZ : public virtual Abstract_ResonanceGmZ, public ResonanceWidths {
...
private:
  ...
  virtual void calcWidth(bool calledFromInit = false);
        ...
        public:
            Abstract_ResonanceGmZ* pointerCopy__BOSS();

            void pointerAssign__BOSS(Abstract_ResonanceGmZ* in);
...
#endif /* __boss__ResonanceWidths_Pythia_8_186_h__ */
