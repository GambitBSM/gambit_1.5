...
#include "gambit/Backends/wrappertypedefs.h"
namespace Pythia8 { 
class CoupSM : public virtual Abstract_CoupSM {
...
protected:
  ...
  AlphaEM     alphaEMlocal;
        ...
        public:
            Abstract_CoupSM* pointerCopy__BOSS();

            void pointerAssign__BOSS(Abstract_CoupSM* in);


        public:
            void init__BOSS(Pythia8::Abstract_Settings&, Pythia8::Abstract_Rndm*);
...
public:
 ...
 Couplings() : isSUSY(false) {}
  bool isSUSY;
        ...
        public:
            Abstract_Couplings* pointerCopy__BOSS();

            void pointerAssign__BOSS(Abstract_Couplings* in);

        public:
            bool& isSUSY_ref__BOSS();
