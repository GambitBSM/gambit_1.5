...
extern "C" {
  ...
  void C_DDCALC0_simple_2014_init(const bool *);
  ...
  void C_DDCALC0_simple_2014_setemin(const double *);
  ...
  void C_DDCALC0_simple_2014_calcrates();
  ...
  int C_DDCALC0_simple_2014_events();
  ...
  double C_DDCALC0_simple_2014_background();
  ...
  double C_DDCALC0_simple_2014_signal();
  ...
  double C_DDCALC0_simple_2014_signalsi();
  ...
  double C_DDCALC0_simple_2014_signalsd();
  ...
  double C_DDCALC0_simple_2014_loglikelihood();
  ...
  double C_DDCALC0_simple_2014_logpvalue();
  ...
  double C_DDCALC0_simple_2014_scaletopvalue(const double *);
...
void SIMPLE_2014_Init(const bool intervals=true) {
  C_DDCALC0_simple_2014_init(&intervals);
};
...
void SIMPLE_2014_SetEmin(const double Emin) {
  C_DDCALC0_simple_2014_setemin(&Emin);
};
...
void SIMPLE_2014_CalcRates() {
  C_DDCALC0_simple_2014_calcrates();
}
...
int SIMPLE_2014_Events() {
  return C_DDCALC0_simple_2014_events();
}
...
double SIMPLE_2014_Background() {
  return C_DDCALC0_simple_2014_background();
}
...
double SIMPLE_2014_Signal() {
  return C_DDCALC0_simple_2014_signal();
}
...
double SIMPLE_2014_SignalSI() {
  return C_DDCALC0_simple_2014_signalsi();
}
...
double SIMPLE_2014_SignalSD() {
  return C_DDCALC0_simple_2014_signalsd();
}
...
double SIMPLE_2014_LogLikelihood() {
  return C_DDCALC0_simple_2014_loglikelihood();
}
...
double SIMPLE_2014_LogPValue() {
  return C_DDCALC0_simple_2014_logpvalue();
}
...
double SIMPLE_2014_ScaleToPValue(const double logp=-2.302585) {
  return C_DDCALC0_simple_2014_scaletopvalue(&logp);
}
