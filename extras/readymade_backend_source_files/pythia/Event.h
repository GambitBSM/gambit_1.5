...
private:
  ...
  ParticleData* particleDataPtr;  //!
        ...
        public:
            ...
            {
                Pythia8::Particle* _temp_p = new Pythia8::Particle(front());
                Pythia8::Particle*& _temp_pr = _temp_p;
                return _temp_pr;
            }
            Pythia8::Particle*& at_GAMBIT(int i)
            {
                Pythia8::Particle* _temp_p = new Pythia8::Particle(at(i));
                Pythia8::Particle*& _temp_pr = _temp_p;
                return _temp_pr;
            }
            Pythia8::Particle*& back_GAMBIT()
            {
                Pythia8::Particle* _temp_p = new Pythia8::Particle(back());
                Pythia8::Particle*& _temp_pr = _temp_p;
                return _temp_pr;
            }
