...
class X : public virtual Abstract_X 
{
    public:
        ...
        X() : i(0) { /* Just test code: */ std::cout << "Making an X with regular constructor in BOSSMinimalExample_1_1." << std::endl; }

        X(int i_in) : i(i_in) { /* Just test code: */ std::cout << "Making an X with int constructor in BOSSMinimalExample_1_1." << std::endl; }
...
class Y : public virtual Abstract_Y
{
    public:
        ...
        Y() { /* Just test code: */ std::cout << "Making a Y with regular constructor in BOSSMinimalExample_1_1." << std::endl; }

        Y(X x_in) : x(x_in)
        {
            x = x_in;
            /* Just test code: */ std::cout << "Making a Y with X-arged constructor in BOSSMinimalExample_1_1." << std::endl;
        }
