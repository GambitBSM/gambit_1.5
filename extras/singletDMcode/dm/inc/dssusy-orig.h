...
* useful global variables + roption
     ...
     & cos2be,sin2be,zg,lgzg,delrho,alph3mz
      character*5 roption
      common /iuseful/ lsp,kln
      common /ruseful/ pi,s2thw,sinthw,costhw,
     & cosbe,sinbe,cos2be,sin2be,zg,lgzg,delrho,alph3mz
...
* decay widths
      real*8 width(0:50),hdwidth(22,4)
...
* mixings
     ...
     & squlmx(6,3),squrmx(6,3),sqdlmx(6,3),sqdrmx(6,3)
      common /mixing/ neunmx,chaumx,chavmx,
...
* DarkSUSY version and root directory
      ...
      character*128 dsroot
      common/dsver/dsversion,dsroot
* rr
...
c save common blocks
     ...
     &  /qnum/,/mixing/,/sugrainput/,/dsver/,/yklsp/
***                                                                 ***
************************* end of susy.h *******************************
