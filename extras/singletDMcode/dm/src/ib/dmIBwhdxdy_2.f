...
*****************************************************************************
      ...
      real*8 function dmIBwhdxdy_2(x,y,m0,mw,mhc,mc1,mc2)
      real*8 x,y,m0,mw,mhc,mc1,mc2

      dmIBwhdxdy_2 = 
     -   (8*m0**3*mc2*(-2*mc2**2 + mhc**2 + mw**2 + m0**2*(-2 + 4*x))*
     -    (mw**2*(mhc**4*mw**4*(1 - 3*x) - mhc**2*mw**6*(-3 + x) + 
     -         mhc**8*x - mhc**6*mw**2*(1 + x) + mw**8*(1 + 4*x) - 
