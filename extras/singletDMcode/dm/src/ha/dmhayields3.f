*****************************************************************************
*** function dshayields3 calculates the yield above threshold (yieldk=1) or the
...
*****************************************************************************
      ...
      real*8 function dmhayields3(eh,emuth,hno,yieldk,istat)
      implicit none
      include 'dshacom.h'
...
c------------------------ functions ------------------------------------
      ...
      real*8 dmhayields4,dmhaemean,dmhayieldfth,dmhayielddec
...
c..."complex" channels
     ...
     &      has0m(1),emuth,6,yieldk,istat)
          yield=yield+has0br(8,hno)*dmhayields4(e2,emuth,1,yieldk,istat)
        endif
     ...
     &       has0m(2),emuth,6,yieldk,istat)
          yield=yield+has0br(9,hno)*dmhayields4(e2,emuth,2,yieldk,istat)
        endif
     ...
     &       has0m(3),emuth,6,yieldk,istat)
          yield=yield
     &      +has0br(10,hno)*dmhayields4(e2,emuth,3,yieldk,istat)
        endif
     ...
     +    dmhayieldfth(eh,has0m(hno),map(5),hascm,emuth,5,yieldk,istat)
          yield=yield
     &      +has0br(11,hno)*dmhayields4(e2,emuth,4,yieldk,istat)
        endif
...
c---------- charged scalar bosons ----------
     ...
     &    5,yieldk,istat)
          ...
          yield=yield+hascbr(13)*
     &      dmhayields4(e2,emuth,1,yieldk,istat)
        endif
     ...
     &    5,yieldk,istat)
          ...
          yield=yield+hascbr(14)*
     &      dmhayields4(e2,emuth,2,yieldk,istat)
        endif
     ...
     &    5,yieldk,istat)
          ...
          yield=yield+hascbr(15)*
     &      dmhayields4(e2,emuth,3,yieldk,istat)
        endif
