...
BE_FUNCTION(cattleClassFactory, GAMBIT::Classes::LibFirst::v1_0::cattleClass*, (double), "_Z18cattleClassFactoryd")
BE_FUNCTION(BaseFactory, GAMBIT::Classes::LibFirst::v1_0::Base*, (), "_Z11BaseFactoryv")
