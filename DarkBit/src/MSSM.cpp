...
//      getMSSMmass("~e-_1", 0)
      ...
      SETUP_DS6_PROCESS(H1H2,      25,  35, h0_1,   h0_2,   1   )
      ...
      SETUP_DS6_PROCESS(H1Z0,      23,  35, Z0,     h0_2,   1   )
      SETUP_DS6_PROCESS(H2Z0,      23,  25, Z0      h0_1,   1   )
      SETUP_DS6_PROCESS(H3Z0,      23,  36, Z0,     A0,     1   )
      // Prefactor 0.5 since W+H- and W-H+ are summed in DS
      SETUP_DS6_PROCESS(WpHm,      24, -37, W+,     H-,     0.5 )
      SETUP_DS6_PROCESS(WmHp,      37, -24, H+,     W-,     0.5 )
