...
namespace Gambit
{
  ...
  namespace DarkBit
  {
    ...
    void get_SingletDM_DD_couplings(const Spectrum &spec, DM_nucleon_couplings &result, Models::safe_param_map<safe_ptr<double> > &Param)
    {
    ...
    void DD_couplings_SingletDM(DM_nucleon_couplings &result)
    {
      ...
      get_SingletDM_DD_couplings(spec, result, Param);
    }
    ...
    void TH_ProcessCatalog_SingletDM(DarkBit::TH_ProcessCatalog &result)
    {
      ...
      auto singletDM = boost::make_shared<SingletDM>(&catalog, gammaH, v, alpha_s, 0.0);
    ...
    void TH_ProcessCatalog_SingletDMZ3(DarkBit::TH_ProcessCatalog &result)
    {
      ...
      // Instantiate new SingletDM object
      auto singletDM = boost::make_shared<SingletDM>(&catalog, gammaH, v, alpha_s, vSigma_semi);
