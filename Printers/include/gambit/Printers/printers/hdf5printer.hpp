...
namespace Gambit
{
  namespace Printers
  {
    ...
    // Temp hack: Setting this to 1 for the MSSMEW scans. 
    static const std::size_t BUFFERLENGTH = 1; // 100; // Change to 10000 or something. Currently cannot change this dynamically though, sorry.
