...
{     
   namespace Models
   {
      ...
      class ScalarSingletDMZ3SimpleSpec;  
   }
   ...
   /// Specialisation of traits class needed to inform base spectrum class of the Model and Input types
   template <>
   struct SpecTraits<Models::ScalarSingletDMZ3SimpleSpec> : DefaultTraits
   {
      static std::string name() { return "ScalarSingletDMZ3SimpleSpec"; }
   ...
   { 
      ...
      class ScalarSingletDMZ3SimpleSpec : public Spec<ScalarSingletDMZ3SimpleSpec> 
      {
         private:
            SingletDMZ3Model params;

            typedef ScalarSingletDMZ3SimpleSpec Self;

         public:
            /// @{ Constructors/destructors
            ScalarSingletDMZ3SimpleSpec(const SingletDMZ3Model& p)
             : params(p)
            {}
