...
#ifndef __MajoranaDMSimpleSpec_hpp__
#define __MajoranaDMSimpleSpec_hpp__
...
{     
   namespace Models
   {
      ...
      class MajoranaDMSimpleSpec;  
   }

   /// Specialisation of traits class needed to inform base spectrum class of the Model and Input types
   template <>
   struct SpecTraits<Models::MajoranaDMSimpleSpec> : DefaultTraits
   {
      static std::string name() { return "MajoranaDMSimpleSpec"; }
      typedef SpectrumContents::MajoranaDM Contents;
   };

   namespace Models
   { 
      class MajoranaDMSimpleSpec : public Spec<MajoranaDMSimpleSpec> 
      {
         private:
            MajoranaDMModel params;

            typedef MajoranaDMSimpleSpec Self;

         public:
            /// @{ Constructors/destructors
            MajoranaDMSimpleSpec(const MajoranaDMModel& p)
             : params(p)
            {}
            ...
            double get_cos_XI()         const { return params.MajoranacosXI; }
            ...
            void set_cos_XI(double in)         { params.MajoranacosXI=in; }
