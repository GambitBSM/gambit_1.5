...
///  *********************************************
///
///  MSSM63atMSUSY translation function definitions
///
///  *********************************************
///
///  Authors
...
void MODEL_NAMESPACE::MSSM63atMSUSY_to_MSSM63atQ (const ModelParameters &myP, ModelParameters &targetP)
{
   ...
   // Copy all the parameters of MSSM63atMSUSY into MSSM63atQ
   ...
   {
      model_error().raise(LOCAL_INFO,"Parameter with name 'high_scale' (type Par::mass1) not found in Spectrum object! Translation from MSSM63atMSUSY to MSSM63atQ is not possible without this value. Please use a Spectrum wrapper which provides it.");
   }

   // Done! Check that everything is ok if desired.
   #ifdef MSSM63atMSUSY_DBUG
     std::cout << "MSSM63atMSUSY parameters:" << myP << std::endl;
