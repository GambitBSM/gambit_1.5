...
///  *********************************************
///
///  MSSMD30atQ_mA translation function definitions
///
...
//#define MSSM30atQ_mA_DBUG

using namespace Gambit::Utils;

#define MODEL MSSM30atQ_mA
  void MODEL_NAMESPACE::MSSM30atQ_mA_to_MSSM63atQ_mA (const ModelParameters &myP, ModelParameters &targetP)
  {
     ...
     // Whew, done!
     #ifdef MSSM30atQ_mA_DBUG
       std::cout << "MSSM30atQ_mA parameters:" << myP << std::endl;
       std::cout << "MSSM63atQ_mA parameters:" << targetP << std::endl;
     #endif
  }
