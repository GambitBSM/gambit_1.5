  ...
  elseif (ROOT_USES_CXX14)
    ...
    if (COMPILER_SUPPORTS_CXX17)
      ...
      if(COMPILER_SUPPORTS_CXX14)
        ...
        string(REGEX REPLACE ${CXX17} "-std=c++14" BACKEND_CXX_FLAGS "${BACKEND_CXX_FLAGS}")
      endif()
    endif()
  ...
  elseif (ROOT_USES_CXX11)
    ...
    if (COMPILER_SUPPORTS_CXX17 OR COMPILER_SUPPORTS_CXX14)
      ...
      if(COMPILER_SUPPORTS_CXX11)
        string(REGEX REPLACE "${CXX17}|${CXX14}" "-std=c++11" CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS}")
        string(REGEX REPLACE "${CXX17}|${CXX14}" "-std=c++11" BACKEND_CXX_FLAGS "${BACKEND_CXX_FLAGS}")
      endif()
    endif()
