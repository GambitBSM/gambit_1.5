...
if (NOT ROOT_FOUND OR ROOT_VERSION VERSION_GREATER 6)
  ...
  if (NOT ROOT_FOUND)
    message("${BoldRed}   No ROOT installation found. Excluding GreAT, Delphes and ROOT-dependent analyses in ColliderBit from GAMBIT configuration. ${ColourReset}")
...
if(ROOT_FOUND)
  ...
  if(RestFrames_FOUND)
    ...
    message("-- Excluding RestFrames since ROOT was not found.")
    set (EXCLUDE_RESTFRAMES TRUE)
endif()
