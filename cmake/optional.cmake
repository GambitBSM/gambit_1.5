...
if(CYTHON_FOUND)
  ...
  message("${BoldRed}   No Cython libraries found for Python: ${PYTHON_EXECUTABLE}.")
  if(${PYTHON_VERSION_MAJOR} EQUAL 3)
    message("${BoldRed}   Try: python3 -m pip install cython.")
  endif()
  message("${BoldRed}   Excluding Classy (and its children) from GAMBIT configuration.${ColourReset}")
  set(itch "${itch}" "classy")
endif()