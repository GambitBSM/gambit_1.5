...
MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::MSSMatMSUSY_mAmu_susy_scale_constraint(
...
void MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::apply()
{
   check_model_ptr();
...
double MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

const MSSMatMSUSY_mAmu_input_parameters& MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::get_input_parameters() const
{
   check_model_ptr();
...
MSSMatMSUSY_mAmu<Two_scale>* MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::get_model() const
{
   return model;
}

void MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<MSSMatMSUSY_mAmu<Two_scale>*>(model_);
}

void MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}

void MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
...
void MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::initialize()
{
   check_model_ptr();
...
void MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::update_scale()
{
   check_model_ptr();
...
void MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("MSSMatMSUSY_mAmu_susy_scale_constraint<Two_scale>: "
