...
#ifndef MSSMatMSUSY_mAmu_PHYSICAL_H
#define MSSMatMSUSY_mAmu_PHYSICAL_H
...
struct MSSMatMSUSY_mAmu_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMatMSUSY_mAmu_physical&);
