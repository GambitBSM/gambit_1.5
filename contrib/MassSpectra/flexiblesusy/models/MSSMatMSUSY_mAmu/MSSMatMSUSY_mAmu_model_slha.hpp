...
/**
 * @file MSSMatMSUSY_mAmu_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Thu 12 Oct 2017 13:49:56

#ifndef MSSMatMSUSY_mAmu_SLHA_H
#define MSSMatMSUSY_mAmu_SLHA_H
...
class MSSMatMSUSY_mAmu_slha : public Model {
public:
   explicit MSSMatMSUSY_mAmu_slha(const MSSMatMSUSY_mAmu_input_parameters& input_ = MSSMatMSUSY_mAmu_input_parameters());
   explicit MSSMatMSUSY_mAmu_slha(const Model&, bool do_convert_masses_to_slha = true);
   MSSMatMSUSY_mAmu_slha(const MSSMatMSUSY_mAmu_slha&) = default;
   MSSMatMSUSY_mAmu_slha(MSSMatMSUSY_mAmu_slha&&) = default;
   virtual ~MSSMatMSUSY_mAmu_slha() = default;
   MSSMatMSUSY_mAmu_slha& operator=(const MSSMatMSUSY_mAmu_slha&) = default;
   MSSMatMSUSY_mAmu_slha& operator=(MSSMatMSUSY_mAmu_slha&&) = default;
   ...
   const MSSMatMSUSY_mAmu_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   MSSMatMSUSY_mAmu_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   MSSMatMSUSY_mAmu_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
MSSMatMSUSY_mAmu_slha<Model>::MSSMatMSUSY_mAmu_slha(const MSSMatMSUSY_mAmu_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
MSSMatMSUSY_mAmu_slha<Model>::MSSMatMSUSY_mAmu_slha(const Model& model_,
...
template <class Model>
void MSSMatMSUSY_mAmu_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void MSSMatMSUSY_mAmu_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void MSSMatMSUSY_mAmu_slha<Model>::convert_to_slha()
{
...
template <class Model>
void MSSMatMSUSY_mAmu_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void MSSMatMSUSY_mAmu_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void MSSMatMSUSY_mAmu_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void MSSMatMSUSY_mAmu_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void MSSMatMSUSY_mAmu_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const MSSMatMSUSY_mAmu_physical& MSSMatMSUSY_mAmu_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
MSSMatMSUSY_mAmu_physical& MSSMatMSUSY_mAmu_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void MSSMatMSUSY_mAmu_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void MSSMatMSUSY_mAmu_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const MSSMatMSUSY_mAmu_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
