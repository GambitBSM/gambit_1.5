...
// File generated at Thu 12 Oct 2017 13:43:27
...
Eigen::ArrayXd MSSMatMSUSY_mAmu_input_parameters::get() const
{
   ...
   pars(8) = TYdInput(1,2);
   pars(9) = TYdInput(2,0);
   pars(10) = TYdInput(2,1);
   pars(11) = TYdInput(2,2);
   pars(12) = TYeInput(0,0);
   pars(13) = TYeInput(0,1);
   pars(14) = TYeInput(0,2);
   pars(15) = TYeInput(1,0);
   pars(16) = TYeInput(1,1);
   pars(17) = TYeInput(1,2);
   pars(18) = TYeInput(2,0);
   pars(19) = TYeInput(2,1);
   pars(20) = TYeInput(2,2);
   pars(21) = TYuInput(0,0);
   pars(22) = TYuInput(0,1);
   pars(23) = TYuInput(0,2);
   pars(24) = TYuInput(1,0);
   pars(25) = TYuInput(1,1);
   pars(26) = TYuInput(1,2);
   pars(27) = TYuInput(2,0);
   pars(28) = TYuInput(2,1);
   pars(29) = TYuInput(2,2);
...
void MSSMatMSUSY_mAmu_input_parameters::set(const Eigen::ArrayXd& pars)
{
   TanBeta = pars(0);
   MuInput = pars(1);
   mA2Input = pars(2);
   ...
   TYdInput(1,2) = pars(8);
   TYdInput(2,0) = pars(9);
   TYdInput(2,1) = pars(10);
   TYdInput(2,2) = pars(11);
   TYeInput(0,0) = pars(12);
   TYeInput(0,1) = pars(13);
   TYeInput(0,2) = pars(14);
   TYeInput(1,0) = pars(15);
   TYeInput(1,1) = pars(16);
   TYeInput(1,2) = pars(17);
   TYeInput(2,0) = pars(18);
   TYeInput(2,1) = pars(19);
   TYeInput(2,2) = pars(20);
   TYuInput(0,0) = pars(21);
   TYuInput(0,1) = pars(22);
   TYuInput(0,2) = pars(23);
   TYuInput(1,0) = pars(24);
   TYuInput(1,1) = pars(25);
   TYuInput(1,2) = pars(26);
   TYuInput(2,0) = pars(27);
   TYuInput(2,1) = pars(28);
   TYuInput(2,2) = pars(29);
...
std::ostream& operator<<(std::ostream& ostr, const MSSMatMSUSY_mAmu_input_parameters& input)
{
   ostr << "TanBeta = " << INPUT(TanBeta) << ", ";
   ostr << "MuInput = " << INPUT(MuInput) << ", ";
   ostr << "mA2Input = " << INPUT(mA2Input) << ", ";
