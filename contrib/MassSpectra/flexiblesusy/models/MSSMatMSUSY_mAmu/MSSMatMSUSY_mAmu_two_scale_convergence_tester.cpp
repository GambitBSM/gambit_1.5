...
// File generated at Sun 24 Sep 2017 15:44:14
...
MSSMatMSUSY_mAmu_convergence_tester<Two_scale>::MSSMatMSUSY_mAmu_convergence_tester(
   MSSMatMSUSY_mAmu<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<MSSMatMSUSY_mAmu<Two_scale> >(model, accuracy_goal, sg)
{
}

double MSSMatMSUSY_mAmu_convergence_tester<Two_scale>::max_rel_diff() const
{
   const MSSMatMSUSY_mAmu<Two_scale>& ol = get_last_iteration_model();
   const MSSMatMSUSY_mAmu<Two_scale>& ne = get_current_iteration_model();
