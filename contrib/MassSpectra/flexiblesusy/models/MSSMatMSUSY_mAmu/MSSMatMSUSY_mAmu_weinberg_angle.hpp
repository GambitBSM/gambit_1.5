...
/**
 * @class MSSMatMSUSY_mAmu_weinberg_angle
...
public:
   ...
   MSSMatMSUSY_mAmu_weinberg_angle(const MSSMatMSUSY_mAmu_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMatMSUSY_mAmu_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMatMSUSY_mAmu_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
