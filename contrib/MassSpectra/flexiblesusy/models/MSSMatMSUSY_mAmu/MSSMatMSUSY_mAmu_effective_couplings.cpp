...
// File generated at Wed 25 Oct 2017 18:00:03

#include "MSSMatMSUSY_mAmu_effective_couplings.hpp"
...
MSSMatMSUSY_mAmu_effective_couplings::MSSMatMSUSY_mAmu_effective_couplings(
   const MSSMatMSUSY_mAmu_mass_eigenstates& model_,
...
void MSSMatMSUSY_mAmu_effective_couplings::calculate_effective_couplings()
{
...
void MSSMatMSUSY_mAmu_effective_couplings::set_model(const MSSMatMSUSY_mAmu_mass_eigenstates& model_)
{
   model = model_;
   copy_mixing_matrices_from_model();
}

void MSSMatMSUSY_mAmu_effective_couplings::copy_mixing_matrices_from_model()
{
...
standard_model::Standard_model MSSMatMSUSY_mAmu_effective_couplings::initialise_SM() const
{
...
void MSSMatMSUSY_mAmu_effective_couplings::run_SM_strong_coupling_to(standard_model::Standard_model sm, double m)
{
   sm.run_to(m);
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::scalar_scalar_qcd_factor(double m_decay, double m_loop) const
{
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::scalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::pseudoscalar_fermion_qcd_factor(double m_decay, double m_loop) const
{
   std::complex<double> result(1.0, 0.0);
...
double MSSMatMSUSY_mAmu_effective_couplings::number_of_active_flavours(double m) const
{
...
double MSSMatMSUSY_mAmu_effective_couplings::scalar_scaling_factor(double m) const
{
...
double MSSMatMSUSY_mAmu_effective_couplings::pseudoscalar_scaling_factor(double m) const
{
   const double Nf = number_of_active_flavours(m);
   const double mtpole = qedqcd.displayPoleMt();
   const double l = Log(Sqr(m) / Sqr(mtpole));
...
double MSSMatMSUSY_mAmu_effective_couplings::get_hhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CphhVPVP(gO1));
}

double MSSMatMSUSY_mAmu_effective_couplings::get_hhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(Mhh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CphhVGVG(gO1));
}

double MSSMatMSUSY_mAmu_effective_couplings::get_AhVPVP_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.0049735919716217296 * Power(mass, 3.0) * AbsSqr(eff_CpAhVPVP(gO1));
}

double MSSMatMSUSY_mAmu_effective_couplings::get_AhVGVG_partial_width(int gO1) const
{
   const double mass = PHYSICAL(MAh)(gO1);
   return 0.039788735772973836 * Power(mass, 3.0) * AbsSqr(eff_CpAhVGVG(gO1));
}

std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CphhconjVWmVWm(int gI2) const
{
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CpbarFeFehhPL(int gO2, int gI2, int gI1) const
{
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CpbarFeFeAhPL(int gO2, int gI1, int gI2) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CpbarFdFdhhPL(int gO2, int gI2, int gI1) const
{
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CpbarFdFdAhPL(int gO2, int gI1, int gI2) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CpbarFuFuhhPL(int gO2, int gI2, int gI1) const
{
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CpbarFuFuAhPL(int gO2, int gI1, int gI2) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CphhSdconjSd(int gt1, int gt2, int gt3) const
{
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CphhSuconjSu(int gt1, int gt2, int gt3) const
{
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CphhSeconjSe(int gt1, int gt2, int gt3) const
{
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CphhHpmconjHpm(int gt1, int gt2, int gt3) const
{
   const auto g1 = MODELPARAMETER(g1);
   const auto g2 = MODELPARAMETER(g2);
   const auto vd = MODELPARAMETER(vd);
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CpbarChaChahhPL(int gt3, int gt1, int gt2) const
{
   const auto g2 = MODELPARAMETER(g2);
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CpAhSdconjSd(int gt1, int gt2, int gt3) const
{
   const auto TYd = MODELPARAMETER(TYd);
   const auto Yd = MODELPARAMETER(Yd);
   const auto Mu = MODELPARAMETER(Mu);
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CpAhSuconjSu(int gt1, int gt2, int gt3) const
{
   const auto TYu = MODELPARAMETER(TYu);
   const auto Yu = MODELPARAMETER(Yu);
   const auto Mu = MODELPARAMETER(Mu);
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CpAhSeconjSe(int gt1, int gt2, int gt3) const
{
   const auto TYe = MODELPARAMETER(TYe);
   const auto Ye = MODELPARAMETER(Ye);
   const auto Mu = MODELPARAMETER(Mu);
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CpAhHpmconjHpm(int gt1, int gt2, int gt3) const
{
   const auto g2 = MODELPARAMETER(g2);
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
...
std::complex<double> MSSMatMSUSY_mAmu_effective_couplings::CpbarChaChaAhPL(int gt3, int gt2, int gt1) const
{
   const auto g2 = MODELPARAMETER(g2);
...
void MSSMatMSUSY_mAmu_effective_couplings::calculate_eff_CphhVPVP(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
...
void MSSMatMSUSY_mAmu_effective_couplings::calculate_eff_CphhVGVG(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto g3 = MODELPARAMETER(g3);
...
void MSSMatMSUSY_mAmu_effective_couplings::calculate_eff_CpAhVPVP(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto MCha = MODELPARAMETER(MCha);
...
void MSSMatMSUSY_mAmu_effective_couplings::calculate_eff_CpAhVGVG(int gO1)
{
   const auto vd = MODELPARAMETER(vd);
   const auto vu = MODELPARAMETER(vu);
   const auto g3 = MODELPARAMETER(g3);
