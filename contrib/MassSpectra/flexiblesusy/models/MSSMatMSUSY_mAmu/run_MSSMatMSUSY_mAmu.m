Get["models/MSSMatMSUSY_mAmu/MSSMatMSUSY_mAmu_librarylink.m"];

handle = FSMSSMatMSUSY_mAmuOpenHandle[
    fsSettings -> {
...
spectrum    = FSMSSMatMSUSY_mAmuCalculateSpectrum[handle];
observables = FSMSSMatMSUSY_mAmuCalculateObservables[handle];
FSMSSMatMSUSY_mAmuCloseHandle[handle];
