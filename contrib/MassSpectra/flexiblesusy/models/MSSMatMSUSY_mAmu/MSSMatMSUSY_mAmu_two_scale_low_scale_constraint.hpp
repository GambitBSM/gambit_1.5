...
#ifndef MSSMatMSUSY_mAmu_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MSSMatMSUSY_mAmu_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MSSMatMSUSY_mAmu_low_scale_constraint.hpp"
...
template<>
class MSSMatMSUSY_mAmu_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MSSMatMSUSY_mAmu_low_scale_constraint() = default;
   MSSMatMSUSY_mAmu_low_scale_constraint(MSSMatMSUSY_mAmu<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSMatMSUSY_mAmu_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MSSMatMSUSY_mAmu low-scale constraint"; }
