...
#ifndef MSSMatMSUSY_mAmu_OBSERVABLES_H
#define MSSMatMSUSY_mAmu_OBSERVABLES_H
...
MSSMatMSUSY_mAmu_observables calculate_observables(
   const MSSMatMSUSY_mAmu_mass_eigenstates&, const softsusy::QedQcd&,
