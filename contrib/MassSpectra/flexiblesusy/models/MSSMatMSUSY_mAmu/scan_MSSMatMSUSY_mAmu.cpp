...
{
   std::cout <<
      "Usage: scan_MSSMatMSUSY_mAmu.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --MuInput=<value>\n"
      "  --mA2Input=<value>\n"
...
struct MSSMatMSUSY_mAmu_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
MSSMatMSUSY_mAmu_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   MSSMatMSUSY_mAmu_input_parameters& input)
{
   ...
   MSSMatMSUSY_mAmu_scan_result result;
...
void scan(int solver_type, MSSMatMSUSY_mAmu_input_parameters& input,
