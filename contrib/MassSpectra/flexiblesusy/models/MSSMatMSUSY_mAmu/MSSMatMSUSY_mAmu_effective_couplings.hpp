...
class MSSMatMSUSY_mAmu_effective_couplings {
public:
   MSSMatMSUSY_mAmu_effective_couplings(const MSSMatMSUSY_mAmu_mass_eigenstates&,
   ...
   void set_model(const MSSMatMSUSY_mAmu_mass_eigenstates& model_);
