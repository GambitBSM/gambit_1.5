...
namespace MSSMatMSUSY_mAmu_info {
   ...
   class MSSMatMSUSY_mAmu_particle_names : public Names {
   public:
      virtual ~MSSMatMSUSY_mAmu_particle_names() = default;
   ...
   class MSSMatMSUSY_mAmu_parameter_names : public Names {
   public:
      virtual ~MSSMatMSUSY_mAmu_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSMatMSUSY_mAmu_particle_names  particle_names_getter{};
   const MSSMatMSUSY_mAmu_parameter_names parameter_names_getter{};
