...
// File generated at Sun 24 Sep 2017 15:42:01
 ...
 */
Eigen::Matrix<double,3,3> MSSMatMSUSY_mAmu_susy_parameters::calc_beta_Yd_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMatMSUSY_mAmu_susy_parameters::calc_beta_Yd_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
Eigen::Matrix<double,3,3> MSSMatMSUSY_mAmu_susy_parameters::calc_beta_Yd_3_loop(const Susy_traces& susy_traces) const
{
