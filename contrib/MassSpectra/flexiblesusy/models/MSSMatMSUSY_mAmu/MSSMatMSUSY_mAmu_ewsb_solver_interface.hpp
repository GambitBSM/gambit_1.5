 ...
 *
 * This file was generated at Thu 12 Oct 2017 13:49:58 with FlexibleSUSY
 * 2.0.0 (git commit: unknown) and SARAH 4.11.0 .
 */

#ifndef MSSMatMSUSY_mAmu_EWSB_SOLVER_INTERFACE_H
#define MSSMatMSUSY_mAmu_EWSB_SOLVER_INTERFACE_H
...
class MSSMatMSUSY_mAmu_ewsb_solver_interface {
public:
   virtual ~MSSMatMSUSY_mAmu_ewsb_solver_interface() {}
   ...
   virtual int solve(MSSMatMSUSY_mAmu_mass_eigenstates&) = 0;
};
