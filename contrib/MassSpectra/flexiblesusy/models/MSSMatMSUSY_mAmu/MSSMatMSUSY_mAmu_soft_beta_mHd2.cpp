...
// File generated at Thu 10 May 2018 14:26:25
 ...
 */
double MSSMatMSUSY_mAmu_soft_parameters::calc_beta_mHd2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMatMSUSY_mAmu_soft_parameters::calc_beta_mHd2_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double MSSMatMSUSY_mAmu_soft_parameters::calc_beta_mHd2_3_loop(const Soft_traces& soft_traces) const
{
