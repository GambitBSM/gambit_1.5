...
class MSSMatMSUSY_mAmu_soft_parameters : public MSSMatMSUSY_mAmu_susy_parameters {
public:
   explicit MSSMatMSUSY_mAmu_soft_parameters(const MSSMatMSUSY_mAmu_input_parameters& input_ = MSSMatMSUSY_mAmu_input_parameters());
   MSSMatMSUSY_mAmu_soft_parameters(const MSSMatMSUSY_mAmu_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>&
   ...
   MSSMatMSUSY_mAmu_soft_parameters(const MSSMatMSUSY_mAmu_soft_parameters&) = default;
   MSSMatMSUSY_mAmu_soft_parameters(MSSMatMSUSY_mAmu_soft_parameters&&) = default;
   virtual ~MSSMatMSUSY_mAmu_soft_parameters() = default;
   MSSMatMSUSY_mAmu_soft_parameters& operator=(const MSSMatMSUSY_mAmu_soft_parameters&) = default;
   MSSMatMSUSY_mAmu_soft_parameters& operator=(MSSMatMSUSY_mAmu_soft_parameters&&) = default;
   ...
   MSSMatMSUSY_mAmu_soft_parameters calc_beta() const;
   MSSMatMSUSY_mAmu_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const MSSMatMSUSY_mAmu_soft_parameters&);
