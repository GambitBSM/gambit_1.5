...
/**
 * @file MSSMatMSUSY_mAmu_mass_eigenstates.hpp
 *
...
#ifndef MSSMatMSUSY_mAmu_MASS_EIGENSTATES_H
#define MSSMatMSUSY_mAmu_MASS_EIGENSTATES_H
...
class MSSMatMSUSY_mAmu_ewsb_solver_interface;
/**
 * @class MSSMatMSUSY_mAmu_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class MSSMatMSUSY_mAmu_mass_eigenstates : public MSSMatMSUSY_mAmu_soft_parameters {
public:
   explicit MSSMatMSUSY_mAmu_mass_eigenstates(const MSSMatMSUSY_mAmu_input_parameters& input_ = MSSMatMSUSY_mAmu_input_parameters());
   MSSMatMSUSY_mAmu_mass_eigenstates(const MSSMatMSUSY_mAmu_mass_eigenstates&) = default;
   MSSMatMSUSY_mAmu_mass_eigenstates(MSSMatMSUSY_mAmu_mass_eigenstates&&) = default;
   virtual ~MSSMatMSUSY_mAmu_mass_eigenstates() = default;
   MSSMatMSUSY_mAmu_mass_eigenstates& operator=(const MSSMatMSUSY_mAmu_mass_eigenstates&) = default;
   MSSMatMSUSY_mAmu_mass_eigenstates& operator=(MSSMatMSUSY_mAmu_mass_eigenstates&&) = default;
   ...
   void set_physical(const MSSMatMSUSY_mAmu_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const MSSMatMSUSY_mAmu_physical& get_physical() const;
   MSSMatMSUSY_mAmu_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<MSSMatMSUSY_mAmu_ewsb_solver_interface>&);
...
private:
   ...
   MSSMatMSUSY_mAmu_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{MSSMatMSUSY_mAmu_info::model_name,
                     &MSSMatMSUSY_mAmu_info::particle_names_getter,
                     &MSSMatMSUSY_mAmu_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<MSSMatMSUSY_mAmu_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const MSSMatMSUSY_mAmu_mass_eigenstates&);
