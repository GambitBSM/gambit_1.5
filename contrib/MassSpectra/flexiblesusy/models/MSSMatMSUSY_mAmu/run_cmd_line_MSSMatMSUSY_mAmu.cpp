...
{
   std::cout <<
      "Usage: run_cmd_line_MSSMatMSUSY_mAmu.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --MuInput=<value>\n"
      "  --mA2Input=<value>\n"
...
int run_solver(const MSSMatMSUSY_mAmu_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(MSSMatMSUSY_mAmu_slha_io::fill_slhaea(
...
int run(int solver_type, const MSSMatMSUSY_mAmu_input_parameters& input)
{
   int exit_code = 0;
