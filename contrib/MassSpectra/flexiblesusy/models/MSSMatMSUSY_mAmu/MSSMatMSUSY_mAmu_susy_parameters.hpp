...
#ifndef MSSMatMSUSY_mAmu_susy_parameters_H
#define MSSMatMSUSY_mAmu_susy_parameters_H
...
class MSSMatMSUSY_mAmu_susy_parameters : public Beta_function {
public:
   explicit MSSMatMSUSY_mAmu_susy_parameters(const MSSMatMSUSY_mAmu_input_parameters& input_ = MSSMatMSUSY_mAmu_input_parameters());
   MSSMatMSUSY_mAmu_susy_parameters(double scale_, int loops_, int thresholds_, const MSSMatMSUSY_mAmu_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   , const Eigen::Matrix<double,3,3>& Yu_, double Mu_, double g1_, double g2_,
   double g3_, double vd_, double vu_
);
   MSSMatMSUSY_mAmu_susy_parameters(const MSSMatMSUSY_mAmu_susy_parameters&) = default;
   MSSMatMSUSY_mAmu_susy_parameters(MSSMatMSUSY_mAmu_susy_parameters&&) = default;
   virtual ~MSSMatMSUSY_mAmu_susy_parameters() = default;
   MSSMatMSUSY_mAmu_susy_parameters& operator=(const MSSMatMSUSY_mAmu_susy_parameters&) = default;
   MSSMatMSUSY_mAmu_susy_parameters& operator=(MSSMatMSUSY_mAmu_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const MSSMatMSUSY_mAmu_input_parameters& get_input() const;
   MSSMatMSUSY_mAmu_input_parameters& get_input();
   void set_input_parameters(const MSSMatMSUSY_mAmu_input_parameters&);

   MSSMatMSUSY_mAmu_susy_parameters calc_beta() const;
   MSSMatMSUSY_mAmu_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMatMSUSY_mAmu_susy_parameters&);
