...
// File generated at Sun 24 Sep 2017 15:51:51
 ...
 */
Eigen::Matrix<double,3,3> MSSM_mAmu_soft_parameters::calc_beta_mu2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSM_mAmu_soft_parameters::calc_beta_mu2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSM_mAmu_soft_parameters::calc_beta_mu2_3_loop(const Soft_traces& soft_traces) const
{
