...
/**
 * @file MSSM_mAmu_mass_eigenstates.hpp
 *
...
#ifndef MSSM_mAmu_MASS_EIGENSTATES_H
#define MSSM_mAmu_MASS_EIGENSTATES_H
 ...
 */
class MSSM_mAmu_mass_eigenstates : public MSSM_mAmu_soft_parameters {
public:
   explicit MSSM_mAmu_mass_eigenstates(const MSSM_mAmu_input_parameters& input_ = MSSM_mAmu_input_parameters());
   MSSM_mAmu_mass_eigenstates(const MSSM_mAmu_mass_eigenstates&) = default;
   MSSM_mAmu_mass_eigenstates(MSSM_mAmu_mass_eigenstates&&) = default;
   virtual ~MSSM_mAmu_mass_eigenstates() = default;
   MSSM_mAmu_mass_eigenstates& operator=(const MSSM_mAmu_mass_eigenstates&) = default;
   MSSM_mAmu_mass_eigenstates& operator=(MSSM_mAmu_mass_eigenstates&&) = default;
   ...
   void set_physical(const MSSM_mAmu_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const MSSM_mAmu_physical& get_physical() const;
   MSSM_mAmu_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<MSSM_mAmu_ewsb_solver_interface>&);
   ...
   double get_lsp(MSSM_mAmu_info::Particles&) const;
...
private:
   ...
   MSSM_mAmu_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{MSSM_mAmu_info::model_name,
                     &MSSM_mAmu_info::particle_names_getter,
                     &MSSM_mAmu_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<MSSM_mAmu_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const MSSM_mAmu_mass_eigenstates&);
