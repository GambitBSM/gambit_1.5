...
#ifndef MSSM_mAmu_EFFECTIVE_COUPLINGS_H
#define MSSM_mAmu_EFFECTIVE_COUPLINGS_H
...
class MSSM_mAmu_effective_couplings {
public:
   MSSM_mAmu_effective_couplings(const MSSM_mAmu_mass_eigenstates&,
   ...
   void set_model(const MSSM_mAmu_mass_eigenstates& model_);
