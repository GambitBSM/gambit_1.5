...
// File generated at Thu 12 Oct 2017 13:57:03
...
Eigen::ArrayXd MSSM_mAmu_input_parameters::get() const
{
...
void MSSM_mAmu_input_parameters::set(const Eigen::ArrayXd& pars)
{
   TanBeta = pars(0);
   Qin = pars(1);
   MuInput = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const MSSM_mAmu_input_parameters& input)
{
