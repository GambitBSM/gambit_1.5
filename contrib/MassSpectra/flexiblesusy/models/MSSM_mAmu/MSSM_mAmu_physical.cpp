 ...
 * to be complex.
 */
void MSSM_mAmu_physical::convert_to_hk()
{
...
void MSSM_mAmu_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd MSSM_mAmu_physical::get_masses() const
{
...
void MSSM_mAmu_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
...
void MSSM_mAmu_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const MSSM_mAmu_physical& phys_pars)
{
