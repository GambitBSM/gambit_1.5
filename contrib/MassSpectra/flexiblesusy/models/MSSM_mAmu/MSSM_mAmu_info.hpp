...
#ifndef MSSM_mAmu_INFO_H
#define MSSM_mAmu_INFO_H
...
namespace MSSM_mAmu_info {
   ...
   enum Input_parameters : int { TanBeta, Qin, MuInput, mA2Input, Aeij0_0,
   ...
   class MSSM_mAmu_particle_names : public Names {
   public:
      virtual ~MSSM_mAmu_particle_names() = default;
   ...
   class MSSM_mAmu_parameter_names : public Names {
   public:
      virtual ~MSSM_mAmu_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSM_mAmu_particle_names  particle_names_getter{};
   const MSSM_mAmu_parameter_names parameter_names_getter{};
