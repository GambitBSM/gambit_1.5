...
#ifndef MSSM_mAmu_susy_parameters_H
#define MSSM_mAmu_susy_parameters_H
...
class MSSM_mAmu_susy_parameters : public Beta_function {
public:
   explicit MSSM_mAmu_susy_parameters(const MSSM_mAmu_input_parameters& input_ = MSSM_mAmu_input_parameters());
   MSSM_mAmu_susy_parameters(double scale_, int loops_, int thresholds_, const MSSM_mAmu_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   , const Eigen::Matrix<double,3,3>& Yu_, double Mu_, double g1_, double g2_,
   double g3_, double vd_, double vu_
);
   MSSM_mAmu_susy_parameters(const MSSM_mAmu_susy_parameters&) = default;
   MSSM_mAmu_susy_parameters(MSSM_mAmu_susy_parameters&&) = default;
   virtual ~MSSM_mAmu_susy_parameters() = default;
   MSSM_mAmu_susy_parameters& operator=(const MSSM_mAmu_susy_parameters&) = default;
   MSSM_mAmu_susy_parameters& operator=(MSSM_mAmu_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const MSSM_mAmu_input_parameters& get_input() const;
   MSSM_mAmu_input_parameters& get_input();
   void set_input_parameters(const MSSM_mAmu_input_parameters&);

   MSSM_mAmu_susy_parameters calc_beta() const;
   MSSM_mAmu_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const MSSM_mAmu_susy_parameters&);
