...
#include "MSSM_mAmu_low_scale_constraint.hpp"
...
template<>
class MSSM_mAmu_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MSSM_mAmu_low_scale_constraint() = default;
   MSSM_mAmu_low_scale_constraint(MSSM_mAmu<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSM_mAmu_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MSSM_mAmu low-scale constraint"; }
