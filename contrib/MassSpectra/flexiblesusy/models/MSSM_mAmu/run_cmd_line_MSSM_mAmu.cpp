...
{
   std::cout <<
      "Usage: run_cmd_line_MSSM_mAmu.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --Qin=<value>\n"
      "  --MuInput=<value>\n"
...
int run_solver(const MSSM_mAmu_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(MSSM_mAmu_slha_io::fill_slhaea(
...
int run(int solver_type, const MSSM_mAmu_input_parameters& input)
{
   int exit_code = 0;
