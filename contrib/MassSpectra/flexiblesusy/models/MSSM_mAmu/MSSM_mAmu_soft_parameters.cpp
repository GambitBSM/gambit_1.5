...
// File generated at Sun 24 Sep 2017 15:50:35
...
const int MSSM_mAmu_soft_parameters::numberOfParameters;

MSSM_mAmu_soft_parameters::MSSM_mAmu_soft_parameters(const MSSM_mAmu_input_parameters& input_)
   : MSSM_mAmu_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSM_mAmu_soft_parameters::MSSM_mAmu_soft_parameters(
   const MSSM_mAmu_susy_parameters& susy_model
   ...
   : MSSM_mAmu_susy_parameters(susy_model)
...
Eigen::ArrayXd MSSM_mAmu_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSM_mAmu_soft_parameters MSSM_mAmu_soft_parameters::calc_beta(int loops) const
{
   ...
   const MSSM_mAmu_susy_parameters susy_betas(MSSM_mAmu_susy_parameters::calc_beta(loops));

   return MSSM_mAmu_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

MSSM_mAmu_soft_parameters MSSM_mAmu_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MSSM_mAmu_soft_parameters::clear()
{
   MSSM_mAmu_susy_parameters::clear();
...
Eigen::ArrayXd MSSM_mAmu_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MSSM_mAmu_susy_parameters::get());
...
void MSSM_mAmu_soft_parameters::print(std::ostream& ostr) const
{
   MSSM_mAmu_susy_parameters::print(ostr);
...
void MSSM_mAmu_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MSSM_mAmu_susy_parameters::set(pars);
...
MSSM_mAmu_soft_parameters::Soft_traces MSSM_mAmu_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSM_mAmu_soft_parameters& soft_pars)
{
