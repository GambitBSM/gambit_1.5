...
{
   std::cout <<
      "Usage: scan_MSSM_mAmu.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --Qin=<value>\n"
      "  --MuInput=<value>\n"
...
struct MSSM_mAmu_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
MSSM_mAmu_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   MSSM_mAmu_input_parameters& input)
{
...
void scan(int solver_type, MSSM_mAmu_input_parameters& input,
