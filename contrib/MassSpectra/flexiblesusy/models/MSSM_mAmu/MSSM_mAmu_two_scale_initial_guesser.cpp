...
MSSM_mAmu_initial_guesser<Two_scale>::MSSM_mAmu_initial_guesser(
   MSSM_mAmu<Two_scale>* model_,
   const softsusy::QedQcd& qedqcd_,
   const MSSM_mAmu_low_scale_constraint<Two_scale>& low_constraint_,
   const MSSM_mAmu_susy_scale_constraint<Two_scale>& susy_constraint_,
   const MSSM_mAmu_high_scale_constraint<Two_scale>& high_constraint_
)
   : model(model_)
   , qedqcd(qedqcd_)
...
{
   if (!model)
      throw SetupError("MSSM_mAmu_initial_guesser: Error: pointer to model"
                       " MSSM_mAmu<Two_scale> must not be zero");
}
 ...
 */
void MSSM_mAmu_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void MSSM_mAmu_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void MSSM_mAmu_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void MSSM_mAmu_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MSSM_mAmu_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MSSM_mAmu_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void MSSM_mAmu_initial_guesser<Two_scale>::guess_soft_parameters()
{
