...
// File generated at Thu 10 May 2018 14:32:30
 ...
 */
double MSSM_mAmu_soft_parameters::calc_beta_BMu_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSM_mAmu_soft_parameters::calc_beta_BMu_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double MSSM_mAmu_soft_parameters::calc_beta_BMu_3_loop(const Soft_traces& soft_traces) const
{
