Get["models/MSSM_mAmu/MSSM_mAmu_librarylink.m"];

handle = FSMSSM_mAmuOpenHandle[
    fsSettings -> {
...
spectrum    = FSMSSM_mAmuCalculateSpectrum[handle];
observables = FSMSSM_mAmuCalculateObservables[handle];
FSMSSM_mAmuCloseHandle[handle];
