...
// File generated at Thu 10 May 2018 14:32:14
 ...
 */
Eigen::Matrix<double,3,3> MSSM_mAmu_soft_parameters::calc_beta_TYe_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSM_mAmu_soft_parameters::calc_beta_TYe_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceAdjYdTYd = TRACE_STRUCT.traceAdjYdTYd;
 ...
 */
Eigen::Matrix<double,3,3> MSSM_mAmu_soft_parameters::calc_beta_TYe_3_loop(const Soft_traces& soft_traces) const
{
