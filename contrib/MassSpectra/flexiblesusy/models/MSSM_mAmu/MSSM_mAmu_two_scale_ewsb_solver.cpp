...
/**
 * @file MSSM_mAmu_two_scale_ewsb_solver.cpp
 *
 * @brief implementation of EWSB solver for two-scale iteration
 *
 * This file was generated at Sun 24 Sep 2017 15:52:41 with FlexibleSUSY
...
#define CLASSNAME MSSM_mAmu_ewsb_solver<Two_scale>

/**
 * This method solves the EWSB conditions iteratively, trying several
 * root finding methods until a solution is found.
 */
int CLASSNAME::solve_iteratively(MSSM_mAmu_mass_eigenstates& model_to_solve)
{
...
int CLASSNAME::solve_iteratively_with(
   MSSM_mAmu_mass_eigenstates& model_to_solve, EWSB_solver* solver, const EWSB_vector_t& x_init)
{
 ...
 * @param solver solver
 */
void CLASSNAME::set_ewsb_solution(MSSM_mAmu_mass_eigenstates& model, const EWSB_solver* solver)
{
...
void CLASSNAME::set_best_ewsb_solution(MSSM_mAmu_mass_eigenstates& model, It first, It last)
{
...
int CLASSNAME::solve_iteratively_at(MSSM_mAmu_mass_eigenstates& model_to_solve, int l)
{
...
int CLASSNAME::solve(MSSM_mAmu_mass_eigenstates& model_to_solve)
{
   if (loop_order == 0) {
...
int CLASSNAME::solve_tree_level(MSSM_mAmu_mass_eigenstates& model)
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::initial_guess(const MSSM_mAmu_mass_eigenstates& model) const
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::tadpole_equations(const MSSM_mAmu_mass_eigenstates& model) const
{
 ...
 */
CLASSNAME::EWSB_vector_t CLASSNAME::ewsb_step(const MSSM_mAmu_mass_eigenstates& model) const
{
