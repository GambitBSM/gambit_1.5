...
#ifndef MSSM_mAmu_WEINBERG_ANGLE_H
#define MSSM_mAmu_WEINBERG_ANGLE_H
...
/**
 * @class MSSM_mAmu_weinberg_angle
...
public:
   ...
   MSSM_mAmu_weinberg_angle(const MSSM_mAmu_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSM_mAmu_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSM_mAmu_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
