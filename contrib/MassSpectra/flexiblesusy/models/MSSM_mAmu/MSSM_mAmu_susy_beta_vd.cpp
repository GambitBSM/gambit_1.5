...
// File generated at Sun 24 Sep 2017 15:50:27
 ...
 */
double MSSM_mAmu_susy_parameters::calc_beta_vd_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MSSM_mAmu_susy_parameters::calc_beta_vd_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double MSSM_mAmu_susy_parameters::calc_beta_vd_3_loop(const Susy_traces& susy_traces) const
{
