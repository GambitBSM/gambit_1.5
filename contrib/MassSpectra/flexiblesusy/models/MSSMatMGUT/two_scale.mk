...
MSSMatMGUT_INCLUDE_MK += $(DIR)/two_scale.mk

LIBMSSMatMGUT_SRC += \
		$(DIR)/MSSMatMGUT_two_scale_convergence_tester.cpp \
		$(DIR)/MSSMatMGUT_two_scale_ewsb_solver.cpp \
...
LIBMSSMatMGUT_HDR += \
		...
		$(DIR)/MSSMatMGUT_two_scale_spectrum_generator.hpp \
