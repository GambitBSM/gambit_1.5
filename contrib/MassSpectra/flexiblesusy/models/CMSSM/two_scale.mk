...
CMSSM_INCLUDE_MK += $(DIR)/two_scale.mk

LIBCMSSM_SRC += \
		$(DIR)/CMSSM_two_scale_convergence_tester.cpp \
		$(DIR)/CMSSM_two_scale_ewsb_solver.cpp \
...
LIBCMSSM_HDR += \
		...
		$(DIR)/CMSSM_two_scale_spectrum_generator.hpp \
