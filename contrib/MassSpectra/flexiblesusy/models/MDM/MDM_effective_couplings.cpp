...
// File generated at Wed 4 Apr 2018 09:58:32
...
std::complex<double> MDM_effective_couplings::CpbarFdFdAhPL(int gI1, int gI2) const
{
...
std::complex<double> MDM_effective_couplings::CpbarFeFeAhPL(int gI1, int gI2) const
{
...
std::complex<double> MDM_effective_couplings::CpbarFuFuAhPL(int gI1, int gI2) const
{
...
double MDM_effective_couplings::CphhconjVWpVWp() const
{
...
std::complex<double> MDM_effective_couplings::CpbarFdFdhhPL(int gI1, int gI2) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> MDM_effective_couplings::CpbarFeFehhPL(int gI1, int gI2) const
{
   const auto Ye = MODELPARAMETER(Ye);
...
std::complex<double> MDM_effective_couplings::CpbarFuFuhhPL(int gI1, int gI2) const
{
   const auto Yu = MODELPARAMETER(Yu);
