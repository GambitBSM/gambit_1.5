...
#ifndef MDM_WEINBERG_ANGLE_H
#define MDM_WEINBERG_ANGLE_H
...
public:
   ...
   MDM_weinberg_angle(const MDM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MDM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MDM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
