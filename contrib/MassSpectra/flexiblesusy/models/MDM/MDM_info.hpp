...
namespace MDM_info {
   enum Particles : int { VG, Hp, Fv, Fc, Fg, Fn, Ah, hh, Fd, Fu, Fe, VWp, VP,
      VZ, NUMBER_OF_PARTICLES };

   enum Masses : int { MVG, MHp, MFv_1, MFv_2, MFv_3, MFc, MFg, MFn, MAh, Mhh,
      MFd_1, MFd_2, MFd_3, MFu_1, MFu_2, MFu_3, MFe_1, MFe_2, MFe_3, MVWp, MVP,
      MVZ, NUMBER_OF_MASSES };

   enum Parameters : int { g1, g2, g3, LamH, Yu0_0, Yu0_1, Yu0_2, Yu1_0, Yu1_1,
   ...
   enum Input_parameters : int { HiggsIN, YcIN, Qin, QEWSB,
   ...
   class MDM_particle_names : public Names {
   public:
      virtual ~MDM_particle_names() = default;
   ...
   class MDM_parameter_names : public Names {
   public:
      virtual ~MDM_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MDM_particle_names  particle_names_getter{};
   const MDM_parameter_names parameter_names_getter{};
