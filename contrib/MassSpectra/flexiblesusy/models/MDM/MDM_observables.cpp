...
const int MDM_observables::NUMBER_OF_OBSERVABLES;
...
{
   Eigen::ArrayXd vec(MDM_observables::NUMBER_OF_OBSERVABLES);
...
{
   std::vector<std::string> names(MDM_observables::NUMBER_OF_OBSERVABLES);
...
{
   assert(vec.rows() == MDM_observables::NUMBER_OF_OBSERVABLES);
                                              ...
                                              const Physical_input& physical_input)
{
   ...
   MDM_effective_couplings effective_couplings(model, qedqcd, physical_input);
   effective_couplings.calculate_effective_couplings();

   observables.AMU = MDM_a_muon::calculate_a_muon(MODEL);
