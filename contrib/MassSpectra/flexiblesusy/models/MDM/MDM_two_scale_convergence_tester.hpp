...
public:
   using Scale_getter = Convergence_tester_DRbar<MDM<Two_scale>>::Scale_getter;

   MDM_convergence_tester(MDM<Two_scale>*, double, const Scale_getter& sg = Scale_getter());
   virtual ~MDM_convergence_tester() = default;
