...
public:
   ...
   MDM_mass_eigenstates(const MDM_mass_eigenstates&) = default;
   MDM_mass_eigenstates(MDM_mass_eigenstates&&) = default;
   virtual ~MDM_mass_eigenstates() = default;
   MDM_mass_eigenstates& operator=(const MDM_mass_eigenstates&) = default;
   MDM_mass_eigenstates& operator=(MDM_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<MDM_ewsb_solver_interface>&);
   ...
   double CpbarFgFgVPPL() const;
   double CpbarFgFgVPPR() const;
   ...
   double CpbarFgFgVZPL() const;
   double CpbarFgFgVZPR() const;
   ...
   double CpFnFcconjVWpPL() const;
   double CpFnFcconjVWpPR() const;
   double CpbarFcFgconjVWpPL() const;
   double CpbarFcFgconjVWpPR() const;
   ...
   double CpbarFcFnVWpPR() const;
   double CpbarFcFnVWpPL() const;
   double CpbarFgFcVWpPR() const;
   double CpbarFgFcVWpPL() const;
   ...
   std::complex<double> self_energy_Fg_1loop_1(double p ) const;
   std::complex<double> self_energy_Fg_1loop_PR(double p ) const;
   std::complex<double> self_energy_Fg_1loop_PL(double p ) const;
   std::complex<double> self_energy_Fn_1loop_1(double p ) const;
   std::complex<double> self_energy_Fn_1loop_PR(double p ) const;
   std::complex<double> self_energy_Fn_1loop_PL(double p ) const;
...
private:
   ...
   Problems problems{MDM_info::model_name,
                     &MDM_info::particle_names_getter,
                     &MDM_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<MDM_ewsb_solver_interface> ewsb_solver{};
   ...
   // phases
   std::complex<double> PhaseFc{1.,0.};
   std::complex<double> PhaseFn{1.,0.};
   std::complex<double> PhaseFg{1.,0.};
