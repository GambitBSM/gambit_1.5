...
// File generated at Wed 4 Apr 2018 09:58:07

#ifndef MDM_susy_parameters_H
#define MDM_susy_parameters_H
...
public:
   ...
   MDM_susy_parameters(double scale_, int loops_, int thresholds_, const MDM_input_parameters& input_, double g1_, double g2_, double g3_, double LamH_, const Eigen::Matrix<
   double,3,3>& Yu_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<
   double,3,3>& Ye_
);
   MDM_susy_parameters(const MDM_susy_parameters&) = default;
   MDM_susy_parameters(MDM_susy_parameters&&) = default;
   virtual ~MDM_susy_parameters() = default;
   MDM_susy_parameters& operator=(const MDM_susy_parameters&) = default;
   MDM_susy_parameters& operator=(MDM_susy_parameters&&) = default;
   ...
   MDM_susy_parameters calc_beta(int) const;
   virtual void clear();
