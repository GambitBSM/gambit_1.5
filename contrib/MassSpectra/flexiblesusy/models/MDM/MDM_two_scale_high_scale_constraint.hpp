...
template<>
class MDM_high_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MDM_high_scale_constraint() = default;
   MDM_high_scale_constraint(MDM<Two_scale>*);
   virtual ~MDM_high_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MDM high-scale constraint"; }
