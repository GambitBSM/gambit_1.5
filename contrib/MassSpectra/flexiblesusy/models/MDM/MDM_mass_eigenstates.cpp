...
// File generated at Wed 4 Apr 2018 09:58:25
 ...
 * parameters.
 *
 * This file was generated at Wed 4 Apr 2018 09:58:25 with FlexibleSUSY
...
#include "MDM_two_scale_ewsb_solver.hpp"
#endif
...
CLASSNAME::MDM_mass_eigenstates(const MDM_input_parameters& input_)
   ...
   , ewsb_solver(new MDM_ewsb_solver<Two_scale>())
#endif
{
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<MDM_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("MDM_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("MDM_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("MDM_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving MDM EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::calculate_pole_masses()
{
   ...
   if (calculate_bsm_pole_masses) {
      ...
      tp.run_task([this] () { calculate_MFg_pole(); });
      tp.run_task([this] () { calculate_MFn_pole(); });
   }
...
{
   if (PHYSICAL(Mhh) < 0.) problems.flag_pole_tachyon(MDM_info::hh);
...
void CLASSNAME::calculate_MHp()
{
   ...
   if (MHp < 0.) {
      problems.flag_running_tachyon(MDM_info::Hp);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh < 0.) {
      problems.flag_running_tachyon(MDM_info::Ah);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh < 0.) {
      problems.flag_running_tachyon(MDM_info::hh);
   }
...
void CLASSNAME::calculate_MVWp()
{
   ...
   if (MVWp < 0.) {
      problems.flag_running_tachyon(MDM_info::VWp);
   }
...
{
   double result = Re(-(mu2*v) + LamH*Cube(v));
...
double CLASSNAME::CpbarFgFgVPPL() const
{
   const double result = -2*g2*Sin(ThetaW());

   return result;
}

double CLASSNAME::CpbarFgFgVPPR() const
{
   const double result = -2*g2*Sin(ThetaW());
...
double CLASSNAME::CpbarFgFgVZPL() const
{
   const double result = -2*g2*Cos(ThetaW());

   return result;
}

double CLASSNAME::CpbarFgFgVZPR() const
{
   const double result = -2*g2*Cos(ThetaW());
...
double CLASSNAME::CpFnFcconjVWpPL() const
{
   const double result = 1.7320508075688772*g2;

   return result;
}

double CLASSNAME::CpFnFcconjVWpPR() const
{
   const double result = 1.7320508075688772*g2;
...
double CLASSNAME::CpbarFcFgconjVWpPL() const
{
   const double result = 1.4142135623730951*g2;

   return result;
}

double CLASSNAME::CpbarFcFgconjVWpPR() const
{
   const double result = 1.4142135623730951*g2;
...
double CLASSNAME::CpbarFcFnVWpPR() const
{
   const double result = 1.7320508075688772*g2;
...
double CLASSNAME::CpbarFcFnVWpPL() const
{
   const double result = 1.7320508075688772*g2;
...
double CLASSNAME::CpbarFgFcVWpPR() const
{
   const double result = 1.4142135623730951*g2;
...
double CLASSNAME::CpbarFgFcVWpPL() const
{
   const double result = 1.4142135623730951*g2;
...
std::complex<double> CLASSNAME::self_energy_VP_1loop(double p ) const
{
   ...
   result += (AbsSqr(CpbarFcFcVPPL()) + AbsSqr(CpbarFcFcVPPR()))*H0(Sqr(p),Sqr(
      MFc),Sqr(MFc));
   result += (AbsSqr(CpbarFgFgVPPL()) + AbsSqr(CpbarFgFgVPPR()))*H0(Sqr(p),Sqr(
      MFg),Sqr(MFg));
   ...
   result += 4*B0(Sqr(p),Sqr(MFc),Sqr(MFc))*Re(Conj(CpbarFcFcVPPL())*
      CpbarFcFcVPPR())*Sqr(MFc);
   result += 4*B0(Sqr(p),Sqr(MFg),Sqr(MFg))*Re(Conj(CpbarFgFgVPPL())*
      CpbarFgFgVPPR())*Sqr(MFg);
...
std::complex<double> CLASSNAME::self_energy_VZ_1loop(double p ) const
{
   ...
   result += (AbsSqr(CpbarFcFcVZPL()) + AbsSqr(CpbarFcFcVZPR()))*H0(Sqr(p),Sqr(
      MFc),Sqr(MFc));
   result += (AbsSqr(CpbarFgFgVZPL()) + AbsSqr(CpbarFgFgVZPR()))*H0(Sqr(p),Sqr(
      MFg),Sqr(MFg));
   result += 2*CpconjVWpVWpVZVZ1()*Sqr(MVWp);
   result += -0.6666666666666666*AbsSqr(CpconjVWpVWpVZ())*(3*A0(Sqr(MVWp)) + 15
      *B00(Sqr(p),Sqr(MVWp),Sqr(MVWp)) - 6*Sqr(MVWp) + Sqr(p) + 3*B0(Sqr(p),Sqr(
      MVWp),Sqr(MVWp))*(Sqr(MVWp) + 2*Sqr(p)));
   result += 4*B0(Sqr(p),Sqr(MFc),Sqr(MFc))*Re(Conj(CpbarFcFcVZPL())*
      CpbarFcFcVZPR())*Sqr(MFc);
   result += 4*B0(Sqr(p),Sqr(MFg),Sqr(MFg))*Re(Conj(CpbarFgFgVZPL())*
      CpbarFgFgVZPR())*Sqr(MFg);
...
std::complex<double> CLASSNAME::self_energy_VWp_1loop(double p ) const
{
   ...
   result += (AbsSqr(CpbarFcFgconjVWpPL()) + AbsSqr(CpbarFcFgconjVWpPR()))*H0(
      Sqr(p),Sqr(MFc),Sqr(MFg));
   result += (AbsSqr(CpFnFcconjVWpPL()) + AbsSqr(CpFnFcconjVWpPR()))*H0(Sqr(p),
      Sqr(MFn),Sqr(MFc));
   ...
   result += 4*MFc*MFg*B0(Sqr(p),Sqr(MFc),Sqr(MFg))*Re(Conj(CpbarFcFgconjVWpPL(
      ))*CpbarFcFgconjVWpPR());
   result += 4*MFc*MFn*B0(Sqr(p),Sqr(MFn),Sqr(MFc))*Re(Conj(CpFnFcconjVWpPL())*
      CpFnFcconjVWpPR());
...
std::complex<double> CLASSNAME::self_energy_Fc_1loop_1(double p ) const
{
   ...
   result += -2*MFc*(-1 + 2*B0(Sqr(p),Sqr(MFc),0))*Conj(CpbarFcFcVPPR())*
      CpbarFcFcVPPL();
   result += -2*MFc*(-1 + 2*B0(Sqr(p),Sqr(MFc),Sqr(MVZ)))*Conj(CpbarFcFcVZPR())
      *CpbarFcFcVZPL();
   result += -2*MFg*(-1 + 2*B0(Sqr(p),Sqr(MFg),Sqr(MVWp)))*Conj(
      CpbarFcFgconjVWpPR())*CpbarFcFgconjVWpPL();
   result += -2*MFn*(-1 + 2*B0(Sqr(p),Sqr(MFn),Sqr(MVWp)))*Conj(CpbarFcFnVWpPR(
      ))*CpbarFcFnVWpPL();
...
std::complex<double> CLASSNAME::self_energy_Fc_1loop_PR(double p ) const
{
   ...
   result += -(AbsSqr(CpbarFcFcVPPL())*(0.5 + B1(Sqr(p),Sqr(MFc),0)));
   result += -(AbsSqr(CpbarFcFcVZPL())*(0.5 + B1(Sqr(p),Sqr(MFc),Sqr(MVZ))));
   result += -(AbsSqr(CpbarFcFgconjVWpPL())*(0.5 + B1(Sqr(p),Sqr(MFg),Sqr(MVWp)
      )));
   result += -(AbsSqr(CpbarFcFnVWpPL())*(0.5 + B1(Sqr(p),Sqr(MFn),Sqr(MVWp))));
...
std::complex<double> CLASSNAME::self_energy_Fc_1loop_PL(double p ) const
{
   ...
   result += -(AbsSqr(CpbarFcFcVPPR())*(0.5 + B1(Sqr(p),Sqr(MFc),0)));
   result += -(AbsSqr(CpbarFcFcVZPR())*(0.5 + B1(Sqr(p),Sqr(MFc),Sqr(MVZ))));
   result += -(AbsSqr(CpbarFcFgconjVWpPR())*(0.5 + B1(Sqr(p),Sqr(MFg),Sqr(MVWp)
      )));
   result += -(AbsSqr(CpbarFcFnVWpPR())*(0.5 + B1(Sqr(p),Sqr(MFn),Sqr(MVWp))));

   return result * oneOver16PiSqr;

}

std::complex<double> CLASSNAME::self_energy_Fg_1loop_1(double p ) const
{
   std::complex<double> result;

   result += -2*MFc*(-1 + 2*B0(Sqr(p),Sqr(MFc),Sqr(MVWp)))*Conj(CpbarFgFcVWpPR(
      ))*CpbarFgFcVWpPL();
   result += -2*MFg*(-1 + 2*B0(Sqr(p),Sqr(MFg),0))*Conj(CpbarFgFgVPPR())*
      CpbarFgFgVPPL();
   result += -2*MFg*(-1 + 2*B0(Sqr(p),Sqr(MFg),Sqr(MVZ)))*Conj(CpbarFgFgVZPR())
      *CpbarFgFgVZPL();
...
std::complex<double> CLASSNAME::self_energy_Fg_1loop_PR(double p ) const
{
   std::complex<double> result;

   result += -(AbsSqr(CpbarFgFcVWpPL())*(0.5 + B1(Sqr(p),Sqr(MFc),Sqr(MVWp))));
   result += -(AbsSqr(CpbarFgFgVPPL())*(0.5 + B1(Sqr(p),Sqr(MFg),0)));
   result += -(AbsSqr(CpbarFgFgVZPL())*(0.5 + B1(Sqr(p),Sqr(MFg),Sqr(MVZ))));

   return result * oneOver16PiSqr;

}

std::complex<double> CLASSNAME::self_energy_Fg_1loop_PL(double p ) const
{
   std::complex<double> result;

   result += -(AbsSqr(CpbarFgFcVWpPR())*(0.5 + B1(Sqr(p),Sqr(MFc),Sqr(MVWp))));
   result += -(AbsSqr(CpbarFgFgVPPR())*(0.5 + B1(Sqr(p),Sqr(MFg),0)));
   result += -(AbsSqr(CpbarFgFgVZPR())*(0.5 + B1(Sqr(p),Sqr(MFg),Sqr(MVZ))));

   return result * oneOver16PiSqr;

}

std::complex<double> CLASSNAME::self_energy_Fn_1loop_1(double p ) const
{
   std::complex<double> result;

   result += -2*MFc*(-1 + 2*B0(Sqr(p),Sqr(MFc),Sqr(MVWp)))*Conj(CpbarFcFnVWpPL(
      ))*CpbarFcFnVWpPR();
   result += -2*MFc*(-1 + 2*B0(Sqr(p),Sqr(MFc),Sqr(MVWp)))*Conj(CpFnFcconjVWpPR
      ())*CpFnFcconjVWpPL();
...
std::complex<double> CLASSNAME::self_energy_Fn_1loop_PR(double p ) const
{
   std::complex<double> result;

   result += -(AbsSqr(CpbarFcFnVWpPR())*(0.5 + B1(Sqr(p),Sqr(MFc),Sqr(MVWp))));
   result += -(AbsSqr(CpFnFcconjVWpPL())*(0.5 + B1(Sqr(p),Sqr(MFc),Sqr(MVWp))))
      ;
...
std::complex<double> CLASSNAME::self_energy_Fn_1loop_PL(double p ) const
{
   std::complex<double> result;

   result += -(AbsSqr(CpbarFcFnVWpPL())*(0.5 + B1(Sqr(p),Sqr(MFc),Sqr(MVWp))));
   result += -(AbsSqr(CpFnFcconjVWpPR())*(0.5 + B1(Sqr(p),Sqr(MFc),Sqr(MVWp))))
      ;
...
void CLASSNAME::calculate_MFg_pole()
{
   ...
   const double p = MFg;
   const double self_energy_1  = Re(self_energy_Fg_1loop_1(p));
   const double self_energy_PL = Re(self_energy_Fg_1loop_PL(p));
   const double self_energy_PR = Re(self_energy_Fg_1loop_PR(p));
   const auto M_loop = M_tree - self_energy_1 - M_tree * (self_energy_PL
      + self_energy_PR);
...
void CLASSNAME::calculate_MFn_pole()
{
   ...
   const double p = MFn;
   const double self_energy_1  = Re(self_energy_Fn_1loop_1(p));
   const double self_energy_PL = Re(self_energy_Fn_1loop_PL(p));
   const double self_energy_PR = Re(self_energy_Fn_1loop_PR(p));
   const auto M_loop = M_tree - self_energy_1 - M_tree * (self_energy_PL
      + self_energy_PR);
...
{
   if (!force_output && problems.is_running_tachyon(MDM_info::hh))
      return;
...
{
   if (!force_output && problems.is_running_tachyon(MDM_info::VZ))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(MDM_info::VZ);
   ...
   for (int i1 = 0; i1 < 3; ++i1) {
      for (int i2 = 0; i2 < 3; ++i2) {
         const double p = AbsSqrt(MFd_reordered(i1) * MFd_reordered
            (i2));
         self_energy_1(i1,i2)  = Re(self_energy_Fd_1loop_1(p,i1,i2)
            );
         self_energy_PL(i1,i2) = Re(self_energy_Fd_1loop_PL(p,i1,i2
            ));
         self_energy_PR(i1,i2) = Re(self_energy_Fd_1loop_PR(p,i1,i2
            ));
      }
   }
   ...
   for (int i1 = 0; i1 < 3; ++i1) {
      for (int i2 = 0; i2 < 3; ++i2) {
         const double p = AbsSqrt(MFe_reordered(i1) * MFe_reordered
            (i2));
         self_energy_1(i1,i2)  = Re(self_energy_Fe_1loop_1(p,i1,i2)
            );
         self_energy_PL(i1,i2) = Re(self_energy_Fe_1loop_PL(p,i1,i2
            ));
         self_energy_PR(i1,i2) = Re(self_energy_Fe_1loop_PR(p,i1,i2
            ));
      }
   }
...
{
   if (!force_output && problems.is_running_tachyon(MDM_info::VWp))
      return;
   ...
   if (mass_sqr < 0.)
      problems.flag_pole_tachyon(MDM_info::VWp);
