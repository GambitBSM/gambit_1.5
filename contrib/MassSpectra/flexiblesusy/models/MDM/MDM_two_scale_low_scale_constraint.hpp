...
template<>
class MDM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MDM_low_scale_constraint() = default;
   MDM_low_scale_constraint(MDM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MDM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MDM low-scale constraint"; }
