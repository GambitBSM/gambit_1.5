...
#ifndef MDM_TWO_SCALE_SPECTRUM_GENERATOR_H
#define MDM_TWO_SCALE_SPECTRUM_GENERATOR_H
...
template <>
class MDM_spectrum_generator<Two_scale>
   : public MDM_spectrum_generator_interface<Two_scale> {
public:
   MDM_spectrum_generator() = default;
   virtual ~MDM_spectrum_generator() = default;
...
protected:
   virtual void run_except(const softsusy::QedQcd&, const MDM_input_parameters&) override;
