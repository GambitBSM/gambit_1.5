...
template <class T> class MDM_standard_model_matching_up;
template <class T> class MDM_standard_model_matching_down;
...
template<>
class MDM_standard_model_matching_up<Two_scale> : public Single_scale_matching
{
public:
   using Scale_getter = std::function<double()>;

   MDM_standard_model_matching_up() = default;

   MDM_standard_model_matching_up(standard_model::StandardModel<Two_scale>*,
                                          MDM<Two_scale>*,
                                          const Scale_getter&,
                                          int, int);

   virtual ~MDM_standard_model_matching_up() = default;
...
template<>
class MDM_standard_model_matching_down<Two_scale> : public Single_scale_matching
{
public:
   using Scale_getter = std::function<double()>;

   MDM_standard_model_matching_down() = default;

   MDM_standard_model_matching_down(standard_model::StandardModel<Two_scale>*,
                                            MDM<Two_scale>*,
                                            const Scale_getter&,
                                            int, int);

   virtual ~MDM_standard_model_matching_down() = default;
