...
// File generated at Tue 13 Mar 2018 12:30:36
...
#define CLASSNAME MDM_standard_model_matching_up<Two_scale>

CLASSNAME::MDM_standard_model_matching_up(
...
void CLASSNAME::match()
{
   ...
   if (model->get_thresholds() && loop_order)
      MDM_standard_model_matching::match_low_to_high_scale_model(*model, *eft, loop_order, higgs_idx);
   else
...
#define CLASSNAME MDM_standard_model_matching_down<Two_scale>

CLASSNAME::MDM_standard_model_matching_down(
   standard_model::StandardModel<Two_scale>* low_,
   MDM<Two_scale>* high_,
   const Scale_getter& scale_getter_,
   int loop_order_,
...
void CLASSNAME::match()
{
   ...
   if (model->get_thresholds() && loop_order)
      MDM_standard_model_matching::match_high_to_low_scale_model(*eft, *model, loop_order, higgs_idx);
   else
