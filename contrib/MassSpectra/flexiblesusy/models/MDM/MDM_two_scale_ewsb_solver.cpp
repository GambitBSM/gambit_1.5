...
/**
 * @file MDM_two_scale_ewsb_solver.cpp
 *
...
int CLASSNAME::solve_iteratively_with(
   MDM_mass_eigenstates& model_to_solve, EWSB_solver* solver, const EWSB_vector_t& x_init)
{
 ...
 * @param solver solver
 */
void CLASSNAME::set_ewsb_solution(MDM_mass_eigenstates& model, const EWSB_solver* solver)
{
...
void CLASSNAME::set_best_ewsb_solution(MDM_mass_eigenstates& model, It first, It last)
{
...
int CLASSNAME::solve_iteratively_at(MDM_mass_eigenstates& model_to_solve, int l)
{
...
int CLASSNAME::solve(MDM_mass_eigenstates& model_to_solve)
{
   if (loop_order == 0) {
...
int CLASSNAME::solve_tree_level(MDM_mass_eigenstates& model)
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::initial_guess(const MDM_mass_eigenstates& model) const
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::tadpole_equations(const MDM_mass_eigenstates& model) const
{
 ...
 */
CLASSNAME::EWSB_vector_t CLASSNAME::ewsb_step(const MDM_mass_eigenstates& model) const
{
   ...
   LamH = Re((mu2*v + tadpole[0])/Cube(v));
