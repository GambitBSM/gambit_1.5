...
class MDM_slha : public Model {
public:
   explicit MDM_slha(const MDM_input_parameters& input_ = MDM_input_parameters());
   explicit MDM_slha(const Model&, bool do_convert_masses_to_slha = true);
   MDM_slha(const MDM_slha&) = default;
   MDM_slha(MDM_slha&&) = default;
   virtual ~MDM_slha() = default;
   MDM_slha& operator=(const MDM_slha&) = default;
   MDM_slha& operator=(MDM_slha&&) = default;
...
template <class Model>
MDM_slha<Model>::MDM_slha(const MDM_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
MDM_slha<Model>::MDM_slha(const Model& model_,
...
template <class Model>
void MDM_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void MDM_slha<Model>::convert_to_slha()
{
...
template <class Model>
void MDM_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void MDM_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void MDM_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void MDM_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void MDM_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const MDM_physical& MDM_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
MDM_physical& MDM_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void MDM_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void MDM_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const MDM_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
