...
void MDM_susy_scale_constraint<Two_scale>::set_model(Model* model_)
{
...
void MDM_susy_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("MDM_susy_scale_constraint<Two_scale>: "
