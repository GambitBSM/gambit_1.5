...
// File generated at Wed 4 Apr 2018 09:58:09
 ...
 */
Eigen::Matrix<double,3,3> MDM_susy_parameters::calc_beta_Yd_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MDM_susy_parameters::calc_beta_Yd_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Yd = (twoLoop*(-0.0016666666666666668*Yd*(127*Quad(g1) + 5*Sqr(g1
      ...
      - 248*Sqr(g3)) + 75*(6*Quad(g2) - 3*Sqr(g2)*(5*(3*traceYdAdjYd +
 ...
 */
Eigen::Matrix<double,3,3> MDM_susy_parameters::calc_beta_Yd_3_loop(const Susy_traces& susy_traces) const
{
