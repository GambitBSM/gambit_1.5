...
std::complex<double> HSSUSY_effective_couplings::CpFdhhbarFdPL(int gt1, int gt3) const
{
...
std::complex<double> HSSUSY_effective_couplings::CpFuhhbarFuPL(int gt1, int gt3) const
{
...
std::complex<double> HSSUSY_effective_couplings::CpFehhbarFePL(int gt1, int gt3) const
{
...
std::complex<double> HSSUSY_effective_couplings::CpAhFdbarFdPL(int gt2, int gt3) const
{
   const auto Yd = MODELPARAMETER(Yd);
...
std::complex<double> HSSUSY_effective_couplings::CpAhFubarFuPL(int gt2, int gt3) const
{
   const auto Yu = MODELPARAMETER(Yu);
...
std::complex<double> HSSUSY_effective_couplings::CpAhFebarFePL(int gt2, int gt3) const
{
   const auto Ye = MODELPARAMETER(Ye);
