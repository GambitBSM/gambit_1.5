...
#ifndef MSSMatMSUSYEFTHiggs_mAmu_soft_parameters_H
#define MSSMatMSUSYEFTHiggs_mAmu_soft_parameters_H
...
class MSSMatMSUSYEFTHiggs_mAmu_soft_parameters : public MSSMatMSUSYEFTHiggs_mAmu_susy_parameters {
public:
   explicit MSSMatMSUSYEFTHiggs_mAmu_soft_parameters(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input_ = MSSMatMSUSYEFTHiggs_mAmu_input_parameters());
   MSSMatMSUSYEFTHiggs_mAmu_soft_parameters(const MSSMatMSUSYEFTHiggs_mAmu_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>&
   ...
   MSSMatMSUSYEFTHiggs_mAmu_soft_parameters(const MSSMatMSUSYEFTHiggs_mAmu_soft_parameters&) = default;
   MSSMatMSUSYEFTHiggs_mAmu_soft_parameters(MSSMatMSUSYEFTHiggs_mAmu_soft_parameters&&) = default;
   virtual ~MSSMatMSUSYEFTHiggs_mAmu_soft_parameters() = default;
   MSSMatMSUSYEFTHiggs_mAmu_soft_parameters& operator=(const MSSMatMSUSYEFTHiggs_mAmu_soft_parameters&) = default;
   MSSMatMSUSYEFTHiggs_mAmu_soft_parameters& operator=(MSSMatMSUSYEFTHiggs_mAmu_soft_parameters&&) = default;
   ...
   MSSMatMSUSYEFTHiggs_mAmu_soft_parameters calc_beta() const;
   MSSMatMSUSYEFTHiggs_mAmu_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const MSSMatMSUSYEFTHiggs_mAmu_soft_parameters&);
