...
class MSSMatMSUSYEFTHiggs_mAmu_effective_couplings {
public:
   MSSMatMSUSYEFTHiggs_mAmu_effective_couplings(const MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates&,
   ...
   void set_model(const MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates& model_);
