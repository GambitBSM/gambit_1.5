...
MSSMatMSUSYEFTHiggs_mAmu_convergence_tester<Two_scale>::MSSMatMSUSYEFTHiggs_mAmu_convergence_tester(
   MSSMatMSUSYEFTHiggs_mAmu<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<MSSMatMSUSYEFTHiggs_mAmu<Two_scale> >(model, accuracy_goal, sg)
{
}

double MSSMatMSUSYEFTHiggs_mAmu_convergence_tester<Two_scale>::max_rel_diff() const
{
   const MSSMatMSUSYEFTHiggs_mAmu<Two_scale>& ol = get_last_iteration_model();
   const MSSMatMSUSYEFTHiggs_mAmu<Two_scale>& ne = get_current_iteration_model();
