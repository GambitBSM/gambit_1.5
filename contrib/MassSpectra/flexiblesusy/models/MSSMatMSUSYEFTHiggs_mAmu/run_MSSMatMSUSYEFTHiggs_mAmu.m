Get["models/MSSMatMSUSYEFTHiggs_mAmu/MSSMatMSUSYEFTHiggs_mAmu_librarylink.m"];

handle = FSMSSMatMSUSYEFTHiggs_mAmuOpenHandle[
    fsSettings -> {
...
spectrum    = FSMSSMatMSUSYEFTHiggs_mAmuCalculateSpectrum[handle];
observables = FSMSSMatMSUSYEFTHiggs_mAmuCalculateObservables[handle];
FSMSSMatMSUSYEFTHiggs_mAmuCloseHandle[handle];
