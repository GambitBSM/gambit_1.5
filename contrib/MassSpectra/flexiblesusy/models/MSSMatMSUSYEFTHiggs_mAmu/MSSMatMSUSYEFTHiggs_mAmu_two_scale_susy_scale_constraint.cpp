...
MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint(
...
void MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::apply()
{
   check_model_ptr();
...
double MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

const MSSMatMSUSYEFTHiggs_mAmu_input_parameters& MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::get_input_parameters() const
{
   check_model_ptr();
...
MSSMatMSUSYEFTHiggs_mAmu<Two_scale>* MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::get_model() const
{
   return model;
}

void MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<MSSMatMSUSYEFTHiggs_mAmu<Two_scale>*>(model_);
}

void MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}

void MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
...
void MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::initialize()
{
   check_model_ptr();
...
void MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::update_scale()
{
   check_model_ptr();
...
void MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("MSSMatMSUSYEFTHiggs_mAmu_susy_scale_constraint<Two_scale>: "
