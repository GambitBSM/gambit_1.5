...
#ifndef MSSMatMSUSYEFTHiggs_mAmu_SPECTRUM_GENERATOR_INTERFACE_H
#define MSSMatMSUSYEFTHiggs_mAmu_SPECTRUM_GENERATOR_INTERFACE_H
...
template <class T>
class MSSMatMSUSYEFTHiggs_mAmu_spectrum_generator_interface {
public:
   virtual ~MSSMatMSUSYEFTHiggs_mAmu_spectrum_generator_interface() = default;

   std::tuple<MSSMatMSUSYEFTHiggs_mAmu<T>, standard_model::StandardModel<T>> get_models() const
   { return std::make_tuple(model, eft); }
   std::tuple<MSSMatMSUSYEFTHiggs_mAmu_slha<MSSMatMSUSYEFTHiggs_mAmu<T>>, standard_model::StandardModel<T>> get_models_slha() const
   { return std::make_tuple(MSSMatMSUSYEFTHiggs_mAmu_slha<MSSMatMSUSYEFTHiggs_mAmu<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.), eft); }

   MSSMatMSUSYEFTHiggs_mAmu<T> get_model() const
   { return model; }
   MSSMatMSUSYEFTHiggs_mAmu_slha<MSSMatMSUSYEFTHiggs_mAmu<T>> get_model_slha() const
   { return MSSMatMSUSYEFTHiggs_mAmu_slha<MSSMatMSUSYEFTHiggs_mAmu<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.); }
   ...
   void run(const softsusy::QedQcd&, const MSSMatMSUSYEFTHiggs_mAmu_input_parameters&);
   void write_running_couplings(const std::string& filename, double, double) const;
   void write_spectrum(const std::string& filename = "MSSMatMSUSYEFTHiggs_mAmu_spectrum.dat") const;

protected:
   MSSMatMSUSYEFTHiggs_mAmu<T> model;
   ...
   void translate_exception_to_problem(MSSMatMSUSYEFTHiggs_mAmu<T>& model);
   virtual void run_except(const softsusy::QedQcd&, const MSSMatMSUSYEFTHiggs_mAmu_input_parameters&) = 0;
};
 ...
 */
template <class T>
void MSSMatMSUSYEFTHiggs_mAmu_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void MSSMatMSUSYEFTHiggs_mAmu_spectrum_generator_interface<T>::run(
   const softsusy::QedQcd& qedqcd_, const MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input)
{
 ...
 */
template <class T>
void MSSMatMSUSYEFTHiggs_mAmu_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates tmp_model(model);
   try {
   ...
   MSSMatMSUSYEFTHiggs_mAmu_parameter_getter parameter_getter;
   Coupling_monitor<MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates, MSSMatMSUSYEFTHiggs_mAmu_parameter_getter>
 ...
 */
template <class T>
void MSSMatMSUSYEFTHiggs_mAmu_spectrum_generator_interface<T>::write_spectrum(
   const std::string& filename) const
{
   MSSMatMSUSYEFTHiggs_mAmu_spectrum_plotter plotter(model);
 ...
 */
template <class T>
void MSSMatMSUSYEFTHiggs_mAmu_spectrum_generator_interface<T>::translate_exception_to_problem(MSSMatMSUSYEFTHiggs_mAmu<T>& model)
{
   try {
      throw;
