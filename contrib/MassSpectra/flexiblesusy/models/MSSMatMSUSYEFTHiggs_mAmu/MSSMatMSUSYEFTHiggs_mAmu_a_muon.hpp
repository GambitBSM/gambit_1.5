...
#define MSSMatMSUSYEFTHiggs_mAmu_A_MUON_H

namespace flexiblesusy {
class MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates;

namespace MSSMatMSUSYEFTHiggs_mAmu_a_muon {
/**
* @fn calculate_a_muon
* @brief Calculates \f$a_\mu = (g-2)_\mu/2\f$ of the muon.
*/
double calculate_a_muon(const MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates& model);

/**
* @fn calculate_a_muon_uncertainty
* @brief Calculates \f$\Delta a_\mu\f$ of the muon.
*/
double calculate_a_muon_uncertainty(const MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates& model);
} // namespace MSSMatMSUSYEFTHiggs_mAmu_a_muon
} // namespace flexiblesusy
