...
{
   std::cout <<
      "Usage: run_cmd_line_MSSMatMSUSYEFTHiggs_mAmu.x [options]\n"
      "Options:\n"
      "  --M1Input=<value>\n"
      "  --M2Input=<value>\n"
      "  --M3Input=<value>\n"
...
int run_solver(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill_slhaea(
...
int run(int solver_type, const MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input)
{
   int exit_code = 0;
