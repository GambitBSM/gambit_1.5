...
#ifndef MSSMatMSUSYEFTHiggs_mAmu_WEINBERG_ANGLE_H
#define MSSMatMSUSYEFTHiggs_mAmu_WEINBERG_ANGLE_H
...
/**
 * @class MSSMatMSUSYEFTHiggs_mAmu_weinberg_angle
...
public:
   ...
   MSSMatMSUSYEFTHiggs_mAmu_weinberg_angle(const MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
