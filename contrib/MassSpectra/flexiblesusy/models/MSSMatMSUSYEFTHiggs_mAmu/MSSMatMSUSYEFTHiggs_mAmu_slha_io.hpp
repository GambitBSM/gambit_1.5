...
#ifndef MSSMatMSUSYEFTHiggs_mAmu_SLHA_IO_H
#define MSSMatMSUSYEFTHiggs_mAmu_SLHA_IO_H
...
struct MSSMatMSUSYEFTHiggs_mAmu_scales {
   double HighScale{0.}, SUSYScale{0.}, LowScale{0.};
   double pole_mass_scale{0.};
};

class MSSMatMSUSYEFTHiggs_mAmu_slha_io {
public:
   MSSMatMSUSYEFTHiggs_mAmu_slha_io();

   void clear();

   void fill(softsusy::QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(MSSMatMSUSYEFTHiggs_mAmu_input_parameters&) const;
   void fill(MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates&) const;
   template <class Model> void fill(MSSMatMSUSYEFTHiggs_mAmu_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const MSSMatMSUSYEFTHiggs_mAmu_slha<Model>&, const MSSMatMSUSYEFTHiggs_mAmu_scales&, const MSSMatMSUSYEFTHiggs_mAmu_observables&);
   void set_input(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters&);
   ...
   template <class Model> void set_spectrum(const MSSMatMSUSYEFTHiggs_mAmu_slha<Model>&);
   template <class T> void set_spectrum(const MSSMatMSUSYEFTHiggs_mAmu<T>&);
   ...
   static void fill_minpar_tuple(MSSMatMSUSYEFTHiggs_mAmu_input_parameters&, int, double);
   static void fill_extpar_tuple(MSSMatMSUSYEFTHiggs_mAmu_input_parameters&, int, double);
   static void fill_imminpar_tuple(MSSMatMSUSYEFTHiggs_mAmu_input_parameters&, int, double);
   static void fill_imextpar_tuple(MSSMatMSUSYEFTHiggs_mAmu_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const MSSMatMSUSYEFTHiggs_mAmu_slha<Model>&, const softsusy::QedQcd&, const MSSMatMSUSYEFTHiggs_mAmu_scales&, const MSSMatMSUSYEFTHiggs_mAmu_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const MSSMatMSUSYEFTHiggs_mAmu_slha<Model>&, const softsusy::QedQcd&, const MSSMatMSUSYEFTHiggs_mAmu_scales&, const MSSMatMSUSYEFTHiggs_mAmu_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters&);
   void set_imminpar(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters&);
   void set_imextpar(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters&);
   void set_minpar(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters&);
   void set_mass(const MSSMatMSUSYEFTHiggs_mAmu_physical&, bool);
   void set_mixing_matrices(const MSSMatMSUSYEFTHiggs_mAmu_physical&, bool);
   template <class Model> void set_model_parameters(const MSSMatMSUSYEFTHiggs_mAmu_slha<Model>&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates&) const;
   void fill_physical(MSSMatMSUSYEFTHiggs_mAmu_physical&) const;
};
 ...
 */
template <class Model>
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill(MSSMatMSUSYEFTHiggs_mAmu_slha<Model>& model) const
{
   fill(static_cast<MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates&>(model));
   fill_physical(model.get_physical_slha());
}

template <class Model>
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const MSSMatMSUSYEFTHiggs_mAmu_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const MSSMatMSUSYEFTHiggs_mAmu_scales& scales,
   const MSSMatMSUSYEFTHiggs_mAmu_observables& observables)
{
   MSSMatMSUSYEFTHiggs_mAmu_slha_io slha_io;
   const MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill_slhaea(
   const MSSMatMSUSYEFTHiggs_mAmu_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const MSSMatMSUSYEFTHiggs_mAmu_scales& scales, const MSSMatMSUSYEFTHiggs_mAmu_observables& observables)
{
   SLHAea::Coll slhaea;
   MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_model_parameters(const MSSMatMSUSYEFTHiggs_mAmu_slha<Model>& model)
{
   {
 ...
 */
template <class Model>
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_extra(
   const MSSMatMSUSYEFTHiggs_mAmu_slha<Model>& model, const MSSMatMSUSYEFTHiggs_mAmu_scales& scales,
   const MSSMatMSUSYEFTHiggs_mAmu_observables& observables)
{
   const MSSMatMSUSYEFTHiggs_mAmu_physical physical(model.get_physical_slha());
 ...
 */
template <class... Ts>
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<MSSMatMSUSYEFTHiggs_mAmu_slha_io> ss(this);
 ...
 */
template <class T>
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_spectrum(const MSSMatMSUSYEFTHiggs_mAmu<T>& model)
{
   set_spectrum(MSSMatMSUSYEFTHiggs_mAmu_slha<MSSMatMSUSYEFTHiggs_mAmu<T> >(model));
}
 ...
 */
template <class Model>
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_spectrum(const MSSMatMSUSYEFTHiggs_mAmu_slha<Model>& model)
{
   const MSSMatMSUSYEFTHiggs_mAmu_physical physical(model.get_physical_slha());
