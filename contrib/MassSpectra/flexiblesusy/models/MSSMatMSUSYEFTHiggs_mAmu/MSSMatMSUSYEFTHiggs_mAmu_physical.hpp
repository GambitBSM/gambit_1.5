...
#ifndef MSSMatMSUSYEFTHiggs_mAmu_PHYSICAL_H
#define MSSMatMSUSYEFTHiggs_mAmu_PHYSICAL_H
...
struct MSSMatMSUSYEFTHiggs_mAmu_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMatMSUSYEFTHiggs_mAmu_physical&);
