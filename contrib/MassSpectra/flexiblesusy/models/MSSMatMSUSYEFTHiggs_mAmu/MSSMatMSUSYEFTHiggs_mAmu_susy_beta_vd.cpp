 ...
 */
double MSSMatMSUSYEFTHiggs_mAmu_susy_parameters::calc_beta_vd_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MSSMatMSUSYEFTHiggs_mAmu_susy_parameters::calc_beta_vd_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double MSSMatMSUSYEFTHiggs_mAmu_susy_parameters::calc_beta_vd_3_loop(const Susy_traces& susy_traces) const
{
