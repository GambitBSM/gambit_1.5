...
MSSMatMSUSYEFTHiggs_mAmu_slha_io::MSSMatMSUSYEFTHiggs_mAmu_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void MSSMatMSUSYEFTHiggs_mAmu_slha_io::clear()
{
   slha_io.clear();
}

void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_extpar(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_imminpar(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_imextpar(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input)
{
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_minpar(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_input(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, MSSMatMSUSYEFTHiggs_mAmu_info::model_name)
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_mass(const MSSMatMSUSYEFTHiggs_mAmu_physical& physical,
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_mixing_matrices(const MSSMatMSUSYEFTHiggs_mAmu_physical& physical,
...
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_ckm(
...
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::set_pmns(
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double MSSMatMSUSYEFTHiggs_mAmu_slha_io::get_parameter_output_scale() const
{
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill(MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input) const
{
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill_drbar_parameters(MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill(MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   MSSMatMSUSYEFTHiggs_mAmu_physical physical_hk;
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill_minpar_tuple(MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input,
...
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill_extpar_tuple(MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill_imminpar_tuple(MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill_imextpar_tuple(MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void MSSMatMSUSYEFTHiggs_mAmu_slha_io::fill_physical(MSSMatMSUSYEFTHiggs_mAmu_physical& physical) const
{
   {
 ...
 */
double MSSMatMSUSYEFTHiggs_mAmu_slha_io::read_scale() const
{
