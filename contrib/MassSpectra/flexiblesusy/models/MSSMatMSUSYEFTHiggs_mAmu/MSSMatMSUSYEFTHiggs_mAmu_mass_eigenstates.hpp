...
/**
 * @file MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates.hpp
 *
...
#ifndef MSSMatMSUSYEFTHiggs_mAmu_MASS_EIGENSTATES_H
#define MSSMatMSUSYEFTHiggs_mAmu_MASS_EIGENSTATES_H
...
class MSSMatMSUSYEFTHiggs_mAmu_ewsb_solver_interface;
/**
 * @class MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates : public MSSMatMSUSYEFTHiggs_mAmu_soft_parameters {
public:
   explicit MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates(const MSSMatMSUSYEFTHiggs_mAmu_input_parameters& input_ = MSSMatMSUSYEFTHiggs_mAmu_input_parameters());
   MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates(const MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates&) = default;
   MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates(MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates&&) = default;
   virtual ~MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates() = default;
   MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates& operator=(const MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates&) = default;
   MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates& operator=(MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates&&) = default;
   ...
   void set_physical(const MSSMatMSUSYEFTHiggs_mAmu_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const MSSMatMSUSYEFTHiggs_mAmu_physical& get_physical() const;
   MSSMatMSUSYEFTHiggs_mAmu_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<MSSMatMSUSYEFTHiggs_mAmu_ewsb_solver_interface>&);
   ...
   double get_lsp(MSSMatMSUSYEFTHiggs_mAmu_info::Particles&) const;
...
private:
   ...
   MSSMatMSUSYEFTHiggs_mAmu_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{MSSMatMSUSYEFTHiggs_mAmu_info::model_name,
                     &MSSMatMSUSYEFTHiggs_mAmu_info::particle_names_getter,
                     &MSSMatMSUSYEFTHiggs_mAmu_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<MSSMatMSUSYEFTHiggs_mAmu_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const MSSMatMSUSYEFTHiggs_mAmu_mass_eigenstates&);
