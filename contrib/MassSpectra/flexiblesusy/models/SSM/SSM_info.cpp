...
namespace SSM_info {
   ...
   const std::array<std::string, NUMBER_OF_PARAMETERS> parameter_names = {"g1",
      "g2", "g3", "LambdaS", "K2", "Lambdax", "Yu(0,0)", "Yu(0,1)", "Yu(0,2)",
      "Yu(1,0)", "Yu(1,1)", "Yu(1,2)", "Yu(2,0)", "Yu(2,1)", "Yu(2,2)", "Yd(0,0)",
      "Yd(0,1)", "Yd(0,2)", "Yd(1,0)", "Yd(1,1)", "Yd(1,2)", "Yd(2,0)", "Yd(2,1)"
      , "Yd(2,2)", "Ye(0,0)", "Ye(0,1)", "Ye(0,2)", "Ye(1,0)", "Ye(1,1)",
      "Ye(1,2)", "Ye(2,0)", "Ye(2,1)", "Ye(2,2)", "Kappa", "K1", "MS", "mu2", "v",
      "vS"};

   const std::array<std::string, NUMBER_OF_MIXINGS> particle_mixing_names = {
      "ZH(0,0)", "ZH(0,1)", "ZH(1,0)", "ZH(1,1)", "Re(Vd(0,0))", "Im(Vd(0,0))",
   ...
   const std::array<std::string, NUMBER_OF_INPUT_PARAMETERS>
      input_parameter_names = {"Qin", "QEWSB", "Lambdainput", "LambdaSinput",
      "Kappainput", "K1input", "K2input", "vSInput"};

   const std::array<std::string, NUMBER_OF_EXTRA_PARAMETERS>
      extra_parameter_names = {};

   const std::string model_name = "SSM";
