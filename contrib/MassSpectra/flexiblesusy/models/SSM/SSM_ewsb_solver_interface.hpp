...
/**
 * @file SSM_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Thu 10 May 2018 14:43:26 with FlexibleSUSY
 * 2.0.1 (git commit: unknown) and SARAH 4.12.2 .
 */

#ifndef SSM_EWSB_SOLVER_INTERFACE_H
#define SSM_EWSB_SOLVER_INTERFACE_H
...
class SSM_ewsb_solver_interface {
public:
   virtual ~SSM_ewsb_solver_interface() {}
   ...
   virtual int solve(SSM_mass_eigenstates&) = 0;
};
