...
// File generated at Thu 10 May 2018 14:43:32
...
struct SSM_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
SSM_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   SSM_input_parameters& input)
{
...
void scan(int solver_type, SSM_input_parameters& input,
