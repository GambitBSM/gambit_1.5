...
// File generated at Thu 12 Oct 2017 14:07:51
 ...
 */
Eigen::Matrix<double,3,3> SSM_susy_parameters::calc_beta_Ye_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> SSM_susy_parameters::calc_beta_Ye_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Ye = (twoLoop*(0.005*Ye*(1371*Quad(g1) + 5*Sqr(g1)*(25*
      ...
      2*(80*(traceYdAdjYd + traceYuAdjYu)*Sqr(g3) + Sqr(K2) - 3*(9*
      traceYdAdjYdYdAdjYd - 2*traceYdAdjYuYuAdjYd + 3*traceYeAdjYeYeAdjYe + 9*
      traceYuAdjYuYuAdjYu - 2*Sqr(Lambdax))))) + 0.0375*(129*Sqr(g1) + 5*(-4*(9
      *traceYdAdjYd + 3*traceYeAdjYe + 9*traceYuAdjYu + 8*Lambdax) + 45*Sqr(g2)
 ...
 */
Eigen::Matrix<double,3,3> SSM_susy_parameters::calc_beta_Ye_3_loop(const Susy_traces& susy_traces) const
{
