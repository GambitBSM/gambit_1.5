...
#ifndef SSM_WEINBERG_ANGLE_H
#define SSM_WEINBERG_ANGLE_H
...
public:
   ...
   SSM_weinberg_angle(const SSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const SSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const SSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
