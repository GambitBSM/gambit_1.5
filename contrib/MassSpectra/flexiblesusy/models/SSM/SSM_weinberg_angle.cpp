...
#define CLASSNAME SSM_weinberg_angle
...
void CLASSNAME::set_model(const SSM_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * SSM_info::normalization_g1;
   const double g2 = MODEL->get_g2() * SSM_info::normalization_g2;
...
double CLASSNAME::calculate_delta_rho_hat(double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRhoHat2LoopSM = (6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(
         ...
         )/((0.6*Sqr(g1) + Sqr(g2))*Sqr(SINTHETAW)) - 5*Sqr(GFERMI)*Sqr(MT)*Sqr(v)*(
         RHO2(Mhh(0)/MT)*Sqr(Abs((SUM(j2,0,2,Conj(Vu(2,j2))*SUM(j1,0,2,Conj(Uu(2,j1))
         *Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Uu(2,j1))*Vu(2,j2)))*ZH
         (0,0))) - RHO2(Mhh(0)/MT)*Sqr(Abs((SUM(j2,0,2,Conj(Vu(2,j2))*SUM(j1,0,2,Conj
         (Uu(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Uu(2,j1))*Vu(
         2,j2)))*ZH(0,0))) + RHO2(Mhh(1)/MT)*(Sqr(Abs((SUM(j2,0,2,Conj(Vu(2,j2))*SUM(
         j1,0,2,Conj(Uu(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Uu
         (2,j1))*Vu(2,j2)))*ZH(1,0))) - Sqr(Abs((SUM(j2,0,2,Conj(Vu(2,j2))*SUM(j1,0,2
         ,Conj(Uu(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Uu(2,j1)
         )*Vu(2,j2)))*ZH(1,0)))))))/(1 + PIZZTMZ/Sqr(MZ));
   }
...
double CLASSNAME::calculate_delta_r_hat(double rhohat_ratio, double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRHat2LoopSM = 6.015223977354103e-6*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(
         ...
         DELTARHAT1LOOP)*RHOHATRATIO*Sqr(GFERMI)*Sqr(MT)*Sqr(v)*(RHO2(Mhh(0)/MT)*Sqr(
         Abs((SUM(j2,0,2,Conj(Vu(2,j2))*SUM(j1,0,2,Conj(Uu(2,j1))*Yu(j1,j2))) - SUM(
         j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Uu(2,j1))*Vu(2,j2)))*ZH(0,0))) - RHO2(Mhh(
         0)/MT)*Sqr(Abs((SUM(j2,0,2,Conj(Vu(2,j2))*SUM(j1,0,2,Conj(Uu(2,j1))*Yu(j1,j2
         ))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Uu(2,j1))*Vu(2,j2)))*ZH(0,0))) +
         RHO2(Mhh(1)/MT)*(Sqr(Abs((SUM(j2,0,2,Conj(Vu(2,j2))*SUM(j1,0,2,Conj(Uu(2,j1
         ))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Uu(2,j1))*Vu(2,j2)))*
         ZH(1,0))) - Sqr(Abs((SUM(j2,0,2,Conj(Vu(2,j2))*SUM(j1,0,2,Conj(Uu(2,j1))*Yu(
         j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Uu(2,j1))*Vu(2,j2)))*ZH(1,0
         ))))));
   }
