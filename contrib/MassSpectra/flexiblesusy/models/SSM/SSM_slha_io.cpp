...
void SSM_slha_io::clear()
{
   slha_io.clear();
}

void SSM_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void SSM_slha_io::set_extpar(const SSM_input_parameters& input)
{
 ...
 */
void SSM_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void SSM_slha_io::set_mass(const SSM_physical& physical,
 ...
 */
double SSM_slha_io::get_parameter_output_scale() const
{
 ...
 */
void SSM_slha_io::read_from_stream(std::istream& istr)
{
...
void SSM_slha_io::fill_drbar_parameters(SSM_mass_eigenstates& model) const
{
   ...
   model.set_vS(slha_io.read_entry("HMIX", 51));
   model.set_K1(slha_io.read_entry("HMIX", 31));
   model.set_K2(slha_io.read_entry("HMIX", 32));
   model.set_Kappa(slha_io.read_entry("HMIX", 35));
   model.set_LambdaS(slha_io.read_entry("HMIX", 33));
   model.set_MS(slha_io.read_entry("HMIX", 34));
...
void SSM_slha_io::fill_minpar_tuple(SSM_input_parameters& input,
...
void SSM_slha_io::fill_extpar_tuple(SSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
