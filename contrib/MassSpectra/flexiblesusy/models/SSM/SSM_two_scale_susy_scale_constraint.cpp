...
void SSM_susy_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<SSM<Two_scale>*>(model_);
}

void SSM_susy_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& SSM_susy_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}
...
void SSM_susy_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("SSM_susy_scale_constraint<Two_scale>: "
