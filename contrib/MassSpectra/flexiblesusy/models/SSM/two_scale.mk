...
SSM_INCLUDE_MK += $(DIR)/two_scale.mk

LIBSSM_SRC += \
		$(DIR)/SSM_two_scale_convergence_tester.cpp \
		$(DIR)/SSM_two_scale_ewsb_solver.cpp \
...
LIBSSM_HDR += \
		...
		$(DIR)/SSM_two_scale_spectrum_generator.hpp \
