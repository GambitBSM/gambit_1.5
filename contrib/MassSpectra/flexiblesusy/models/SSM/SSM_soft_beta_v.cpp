...
// File generated at Thu 12 Oct 2017 14:07:53
 ...
 */
double SSM_soft_parameters::calc_beta_v_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double SSM_soft_parameters::calc_beta_v_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_v = Re(-0.00125*twoLoop*v*(1221*Quad(g1) + 10*Sqr(g1)*(122*
      ...
      g2) - 8*(80*(traceYdAdjYd + traceYuAdjYu)*Sqr(g3) + Sqr(K2) - 3*(9*
 ...
 */
double SSM_soft_parameters::calc_beta_v_3_loop(const Soft_traces& soft_traces) const
{
