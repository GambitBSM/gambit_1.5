...
#include "SSM_low_scale_constraint.hpp"
...
template<>
class SSM_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   SSM_low_scale_constraint() = default;
   SSM_low_scale_constraint(SSM<Two_scale>*, const softsusy::QedQcd&);
   virtual ~SSM_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "SSM low-scale constraint"; }
