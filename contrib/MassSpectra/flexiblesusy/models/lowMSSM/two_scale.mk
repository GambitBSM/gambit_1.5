...
lowMSSM_INCLUDE_MK += $(DIR)/two_scale.mk

LIBlowMSSM_SRC += \
		$(DIR)/lowMSSM_two_scale_convergence_tester.cpp \
		$(DIR)/lowMSSM_two_scale_ewsb_solver.cpp \
...
LIBlowMSSM_HDR += \
		...
		$(DIR)/lowMSSM_two_scale_spectrum_generator.hpp \
