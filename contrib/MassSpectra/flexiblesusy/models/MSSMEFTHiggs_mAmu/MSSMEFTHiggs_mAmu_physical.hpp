...
#ifndef MSSMEFTHiggs_mAmu_PHYSICAL_H
#define MSSMEFTHiggs_mAmu_PHYSICAL_H
...
struct MSSMEFTHiggs_mAmu_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMEFTHiggs_mAmu_physical&);
