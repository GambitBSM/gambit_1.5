...
MSSMEFTHiggs_mAmu_convergence_tester<Two_scale>::MSSMEFTHiggs_mAmu_convergence_tester(
   MSSMEFTHiggs_mAmu<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<MSSMEFTHiggs_mAmu<Two_scale> >(model, accuracy_goal, sg)
{
}

double MSSMEFTHiggs_mAmu_convergence_tester<Two_scale>::max_rel_diff() const
{
   const MSSMEFTHiggs_mAmu<Two_scale>& ol = get_last_iteration_model();
   const MSSMEFTHiggs_mAmu<Two_scale>& ne = get_current_iteration_model();
