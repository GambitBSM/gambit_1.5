...
// File generated at Thu 10 May 2018 14:39:55
 ...
 */
double MSSMEFTHiggs_mAmu_susy_parameters::calc_beta_vd_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double MSSMEFTHiggs_mAmu_susy_parameters::calc_beta_vd_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
 ...
 */
double MSSMEFTHiggs_mAmu_susy_parameters::calc_beta_vd_3_loop(const Susy_traces& susy_traces) const
{
