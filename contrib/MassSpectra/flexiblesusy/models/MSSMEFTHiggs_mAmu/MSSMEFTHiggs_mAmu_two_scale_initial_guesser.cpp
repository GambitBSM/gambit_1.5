...
MSSMEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::MSSMEFTHiggs_mAmu_standard_model_initial_guesser(
   ...
   const MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>& susy_constraint_
)
   : Initial_guesser()
   , model(model_)
   , eft(eft_)
...
{
   if (!model)
      throw SetupError("MSSMEFTHiggs_mAmu_initial_guesser: Error: pointer to model"
                       " MSSMEFTHiggs_mAmu<Two_scale> must not be zero");
}
 ...
 */
void MSSMEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::guess()
{
 ...
 */
void MSSMEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::guess_eft_parameters()
{
...
void MSSMEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void MSSMEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MSSMEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MSSMEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void MSSMEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::guess_model_parameters()
{
