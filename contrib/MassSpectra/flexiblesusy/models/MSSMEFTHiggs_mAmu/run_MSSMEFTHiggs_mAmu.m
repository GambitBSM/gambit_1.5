Get["models/MSSMEFTHiggs_mAmu/MSSMEFTHiggs_mAmu_librarylink.m"];

handle = FSMSSMEFTHiggs_mAmuOpenHandle[
    fsSettings -> {
...
spectrum    = FSMSSMEFTHiggs_mAmuCalculateSpectrum[handle];
observables = FSMSSMEFTHiggs_mAmuCalculateObservables[handle];
FSMSSMEFTHiggs_mAmuCloseHandle[handle];
