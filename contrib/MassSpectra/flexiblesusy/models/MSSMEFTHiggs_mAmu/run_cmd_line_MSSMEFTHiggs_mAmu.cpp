...
{
   std::cout <<
      "Usage: run_cmd_line_MSSMEFTHiggs_mAmu.x [options]\n"
      "Options:\n"
      "  --MSUSY=<value>\n"
      "  --M1Input=<value>\n"
      "  --M2Input=<value>\n"
...
int run_solver(const MSSMEFTHiggs_mAmu_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(MSSMEFTHiggs_mAmu_slha_io::fill_slhaea(
...
int run(int solver_type, const MSSMEFTHiggs_mAmu_input_parameters& input)
{
   int exit_code = 0;
