...
// File generated at Tue 9 Jan 2018 19:59:54
 ...
 */
Eigen::Matrix<double,3,3> MSSMEFTHiggs_mAmu_soft_parameters::calc_beta_ml2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMEFTHiggs_mAmu_soft_parameters::calc_beta_ml2_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMEFTHiggs_mAmu_soft_parameters::calc_beta_ml2_3_loop(const Soft_traces& soft_traces) const
{
