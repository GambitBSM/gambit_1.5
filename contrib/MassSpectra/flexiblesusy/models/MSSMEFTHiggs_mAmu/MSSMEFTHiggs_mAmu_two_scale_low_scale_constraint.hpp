...
#include "MSSMEFTHiggs_mAmu_low_scale_constraint.hpp"
...
template<>
class MSSMEFTHiggs_mAmu_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MSSMEFTHiggs_mAmu_low_scale_constraint() = default;
   MSSMEFTHiggs_mAmu_low_scale_constraint(MSSMEFTHiggs_mAmu<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSMEFTHiggs_mAmu_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MSSMEFTHiggs_mAmu low-scale constraint"; }
