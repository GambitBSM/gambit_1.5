...
const int MSSMEFTHiggs_mAmu_soft_parameters::numberOfParameters;

MSSMEFTHiggs_mAmu_soft_parameters::MSSMEFTHiggs_mAmu_soft_parameters(const MSSMEFTHiggs_mAmu_input_parameters& input_)
   : MSSMEFTHiggs_mAmu_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSMEFTHiggs_mAmu_soft_parameters::MSSMEFTHiggs_mAmu_soft_parameters(
   const MSSMEFTHiggs_mAmu_susy_parameters& susy_model
   ...
   : MSSMEFTHiggs_mAmu_susy_parameters(susy_model)
...
Eigen::ArrayXd MSSMEFTHiggs_mAmu_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMEFTHiggs_mAmu_soft_parameters MSSMEFTHiggs_mAmu_soft_parameters::calc_beta(int loops) const
{
   ...
   const MSSMEFTHiggs_mAmu_susy_parameters susy_betas(MSSMEFTHiggs_mAmu_susy_parameters::calc_beta(loops));

   return MSSMEFTHiggs_mAmu_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

MSSMEFTHiggs_mAmu_soft_parameters MSSMEFTHiggs_mAmu_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MSSMEFTHiggs_mAmu_soft_parameters::clear()
{
   MSSMEFTHiggs_mAmu_susy_parameters::clear();
...
Eigen::ArrayXd MSSMEFTHiggs_mAmu_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MSSMEFTHiggs_mAmu_susy_parameters::get());
...
void MSSMEFTHiggs_mAmu_soft_parameters::print(std::ostream& ostr) const
{
   MSSMEFTHiggs_mAmu_susy_parameters::print(ostr);
...
void MSSMEFTHiggs_mAmu_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MSSMEFTHiggs_mAmu_susy_parameters::set(pars);
...
MSSMEFTHiggs_mAmu_soft_parameters::Soft_traces MSSMEFTHiggs_mAmu_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSMEFTHiggs_mAmu_soft_parameters& soft_pars)
{
