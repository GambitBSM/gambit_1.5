...
MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::MSSMEFTHiggs_mAmu_susy_scale_constraint(
...
void MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::apply()
{
   check_model_ptr();
...
double MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::get_scale() const
{
   return scale;
}

double MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

const MSSMEFTHiggs_mAmu_input_parameters& MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::get_input_parameters() const
{
   check_model_ptr();
...
MSSMEFTHiggs_mAmu<Two_scale>* MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::get_model() const
{
   return model;
}

void MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<MSSMEFTHiggs_mAmu<Two_scale>*>(model_);
}

void MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}

void MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
...
void MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::initialize()
{
   check_model_ptr();
...
void MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::update_scale()
{
   check_model_ptr();
...
void MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>: "
