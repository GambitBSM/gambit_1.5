...
#ifndef MSSMEFTHiggs_mAmu_SLHA_IO_H
#define MSSMEFTHiggs_mAmu_SLHA_IO_H
...
struct MSSMEFTHiggs_mAmu_scales {
   double HighScale{0.}, SUSYScale{0.}, LowScale{0.};
   double pole_mass_scale{0.};
};

class MSSMEFTHiggs_mAmu_slha_io {
public:
   MSSMEFTHiggs_mAmu_slha_io();

   void clear();

   void fill(softsusy::QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(MSSMEFTHiggs_mAmu_input_parameters&) const;
   void fill(MSSMEFTHiggs_mAmu_mass_eigenstates&) const;
   template <class Model> void fill(MSSMEFTHiggs_mAmu_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const MSSMEFTHiggs_mAmu_slha<Model>&, const MSSMEFTHiggs_mAmu_scales&, const MSSMEFTHiggs_mAmu_observables&);
   void set_input(const MSSMEFTHiggs_mAmu_input_parameters&);
   ...
   template <class Model> void set_spectrum(const MSSMEFTHiggs_mAmu_slha<Model>&);
   template <class T> void set_spectrum(const MSSMEFTHiggs_mAmu<T>&);
   ...
   static void fill_minpar_tuple(MSSMEFTHiggs_mAmu_input_parameters&, int, double);
   static void fill_extpar_tuple(MSSMEFTHiggs_mAmu_input_parameters&, int, double);
   static void fill_imminpar_tuple(MSSMEFTHiggs_mAmu_input_parameters&, int, double);
   static void fill_imextpar_tuple(MSSMEFTHiggs_mAmu_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const MSSMEFTHiggs_mAmu_slha<Model>&, const softsusy::QedQcd&, const MSSMEFTHiggs_mAmu_scales&, const MSSMEFTHiggs_mAmu_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const MSSMEFTHiggs_mAmu_slha<Model>&, const softsusy::QedQcd&, const MSSMEFTHiggs_mAmu_scales&, const MSSMEFTHiggs_mAmu_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const MSSMEFTHiggs_mAmu_input_parameters&);
   void set_imminpar(const MSSMEFTHiggs_mAmu_input_parameters&);
   void set_imextpar(const MSSMEFTHiggs_mAmu_input_parameters&);
   void set_minpar(const MSSMEFTHiggs_mAmu_input_parameters&);
   void set_mass(const MSSMEFTHiggs_mAmu_physical&, bool);
   void set_mixing_matrices(const MSSMEFTHiggs_mAmu_physical&, bool);
   template <class Model> void set_model_parameters(const MSSMEFTHiggs_mAmu_slha<Model>&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(MSSMEFTHiggs_mAmu_mass_eigenstates&) const;
   void fill_physical(MSSMEFTHiggs_mAmu_physical&) const;
};
 ...
 */
template <class Model>
void MSSMEFTHiggs_mAmu_slha_io::fill(MSSMEFTHiggs_mAmu_slha<Model>& model) const
{
   fill(static_cast<MSSMEFTHiggs_mAmu_mass_eigenstates&>(model));
   fill_physical(model.get_physical_slha());
}

template <class Model>
void MSSMEFTHiggs_mAmu_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const MSSMEFTHiggs_mAmu_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const MSSMEFTHiggs_mAmu_scales& scales,
   const MSSMEFTHiggs_mAmu_observables& observables)
{
   MSSMEFTHiggs_mAmu_slha_io slha_io;
   const MSSMEFTHiggs_mAmu_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll MSSMEFTHiggs_mAmu_slha_io::fill_slhaea(
   const MSSMEFTHiggs_mAmu_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const MSSMEFTHiggs_mAmu_scales& scales, const MSSMEFTHiggs_mAmu_observables& observables)
{
   SLHAea::Coll slhaea;
   MSSMEFTHiggs_mAmu_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void MSSMEFTHiggs_mAmu_slha_io::set_model_parameters(const MSSMEFTHiggs_mAmu_slha<Model>& model)
{
   {
 ...
 */
template <class Model>
void MSSMEFTHiggs_mAmu_slha_io::set_extra(
   const MSSMEFTHiggs_mAmu_slha<Model>& model, const MSSMEFTHiggs_mAmu_scales& scales,
   const MSSMEFTHiggs_mAmu_observables& observables)
{
   const MSSMEFTHiggs_mAmu_physical physical(model.get_physical_slha());
 ...
 */
template <class... Ts>
void MSSMEFTHiggs_mAmu_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<MSSMEFTHiggs_mAmu_slha_io> ss(this);
 ...
 */
template <class T>
void MSSMEFTHiggs_mAmu_slha_io::set_spectrum(const MSSMEFTHiggs_mAmu<T>& model)
{
   set_spectrum(MSSMEFTHiggs_mAmu_slha<MSSMEFTHiggs_mAmu<T> >(model));
}
 ...
 */
template <class Model>
void MSSMEFTHiggs_mAmu_slha_io::set_spectrum(const MSSMEFTHiggs_mAmu_slha<Model>& model)
{
   const MSSMEFTHiggs_mAmu_physical physical(model.get_physical_slha());
