...
#ifndef MSSMEFTHiggs_mAmu_WEINBERG_ANGLE_H
#define MSSMEFTHiggs_mAmu_WEINBERG_ANGLE_H
...
/**
 * @class MSSMEFTHiggs_mAmu_weinberg_angle
...
public:
   ...
   MSSMEFTHiggs_mAmu_weinberg_angle(const MSSMEFTHiggs_mAmu_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMEFTHiggs_mAmu_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMEFTHiggs_mAmu_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
