...
/**
 * @file MSSMEFTHiggs_mAmu_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Thu 10 May 2018 14:40:28 with FlexibleSUSY
 * 2.0.1 (git commit: unknown) and SARAH 4.12.2 .
 */

#ifndef MSSMEFTHiggs_mAmu_EWSB_SOLVER_INTERFACE_H
#define MSSMEFTHiggs_mAmu_EWSB_SOLVER_INTERFACE_H
...
class MSSMEFTHiggs_mAmu_ewsb_solver_interface {
public:
   virtual ~MSSMEFTHiggs_mAmu_ewsb_solver_interface() {}
   ...
   virtual int solve(MSSMEFTHiggs_mAmu_mass_eigenstates&) = 0;
};
