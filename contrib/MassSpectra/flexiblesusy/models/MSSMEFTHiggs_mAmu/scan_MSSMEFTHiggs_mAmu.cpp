...
{
   std::cout <<
      "Usage: scan_MSSMEFTHiggs_mAmu.x [options]\n"
      "Options:\n"
      "  --MSUSY=<value>\n"
      "  --M1Input=<value>\n"
      "  --M2Input=<value>\n"
...
struct MSSMEFTHiggs_mAmu_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
MSSMEFTHiggs_mAmu_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   MSSMEFTHiggs_mAmu_input_parameters& input)
{
   ...
   MSSMEFTHiggs_mAmu_scan_result result;
...
void scan(int solver_type, MSSMEFTHiggs_mAmu_input_parameters& input,
