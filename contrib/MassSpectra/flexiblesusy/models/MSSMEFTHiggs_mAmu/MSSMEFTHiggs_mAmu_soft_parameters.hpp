...
class MSSMEFTHiggs_mAmu_soft_parameters : public MSSMEFTHiggs_mAmu_susy_parameters {
public:
   explicit MSSMEFTHiggs_mAmu_soft_parameters(const MSSMEFTHiggs_mAmu_input_parameters& input_ = MSSMEFTHiggs_mAmu_input_parameters());
   MSSMEFTHiggs_mAmu_soft_parameters(const MSSMEFTHiggs_mAmu_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>&
   ...
   MSSMEFTHiggs_mAmu_soft_parameters(const MSSMEFTHiggs_mAmu_soft_parameters&) = default;
   MSSMEFTHiggs_mAmu_soft_parameters(MSSMEFTHiggs_mAmu_soft_parameters&&) = default;
   virtual ~MSSMEFTHiggs_mAmu_soft_parameters() = default;
   MSSMEFTHiggs_mAmu_soft_parameters& operator=(const MSSMEFTHiggs_mAmu_soft_parameters&) = default;
   MSSMEFTHiggs_mAmu_soft_parameters& operator=(MSSMEFTHiggs_mAmu_soft_parameters&&) = default;
   ...
   MSSMEFTHiggs_mAmu_soft_parameters calc_beta() const;
   MSSMEFTHiggs_mAmu_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const MSSMEFTHiggs_mAmu_soft_parameters&);
