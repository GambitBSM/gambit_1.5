...
Print["MSSMEFTHiggs_mAmu"];
Print["http://flexiblesusy.hepforge.org"];
Print["================================"];

libMSSMEFTHiggs_mAmu = FileNameJoin[{Directory[], "models", "MSSMEFTHiggs_mAmu", "MSSMEFTHiggs_mAmu_librarylink.so"}];

FSMSSMEFTHiggs_mAmuGetSettings = LibraryFunctionLoad[libMSSMEFTHiggs_mAmu, "FSMSSMEFTHiggs_mAmuGetSettings", LinkObject, LinkObject];
FSMSSMEFTHiggs_mAmuGetSMInputParameters = LibraryFunctionLoad[libMSSMEFTHiggs_mAmu, "FSMSSMEFTHiggs_mAmuGetSMInputParameters", LinkObject, LinkObject];
FSMSSMEFTHiggs_mAmuGetInputParameters = LibraryFunctionLoad[libMSSMEFTHiggs_mAmu, "FSMSSMEFTHiggs_mAmuGetInputParameters", LinkObject, LinkObject];
FSMSSMEFTHiggs_mAmuGetProblems = LibraryFunctionLoad[libMSSMEFTHiggs_mAmu, "FSMSSMEFTHiggs_mAmuGetProblems", LinkObject, LinkObject];
FSMSSMEFTHiggs_mAmuGetWarnings = LibraryFunctionLoad[libMSSMEFTHiggs_mAmu, "FSMSSMEFTHiggs_mAmuGetWarnings", LinkObject, LinkObject];
FSMSSMEFTHiggs_mAmuToSLHA = LibraryFunctionLoad[libMSSMEFTHiggs_mAmu, "FSMSSMEFTHiggs_mAmuToSLHA", LinkObject, LinkObject];

FSMSSMEFTHiggs_mAmuOpenHandleLib = LibraryFunctionLoad[libMSSMEFTHiggs_mAmu, "FSMSSMEFTHiggs_mAmuOpenHandle", {{Real,1}}, Integer];
FSMSSMEFTHiggs_mAmuCloseHandle = LibraryFunctionLoad[libMSSMEFTHiggs_mAmu, "FSMSSMEFTHiggs_mAmuCloseHandle", {Integer}, Void];

FSMSSMEFTHiggs_mAmuSetLib = LibraryFunctionLoad[libMSSMEFTHiggs_mAmu, "FSMSSMEFTHiggs_mAmuSet", {Integer, {Real,1}}, Void];

FSMSSMEFTHiggs_mAmuCalculateSpectrum = LibraryFunctionLoad[libMSSMEFTHiggs_mAmu, "FSMSSMEFTHiggs_mAmuCalculateSpectrum", LinkObject, LinkObject];
FSMSSMEFTHiggs_mAmuCalculateObservables = LibraryFunctionLoad[libMSSMEFTHiggs_mAmu, "FSMSSMEFTHiggs_mAmuCalculateObservables", LinkObject, LinkObject];

FSMSSMEFTHiggs_mAmuCalculateSpectrum::error = "`1`";
FSMSSMEFTHiggs_mAmuCalculateSpectrum::warning = "`1`";

FSMSSMEFTHiggs_mAmuCalculateObservables::error = "`1`";
FSMSSMEFTHiggs_mAmuCalculateObservables::warning = "`1`";

FSMSSMEFTHiggs_mAmu::info = "`1`";
FSMSSMEFTHiggs_mAmu::nonum = "Error: `1` is not a numeric input value!";
FSMSSMEFTHiggs_mAmuMessage[s_] := Message[FSMSSMEFTHiggs_mAmu::info, s];

FSMSSMEFTHiggs_mAmuCheckIsNumeric[a_?NumericQ] := a;
FSMSSMEFTHiggs_mAmuCheckIsNumeric[a_] := (Message[FSMSSMEFTHiggs_mAmu::nonum, a]; Abort[]);
...
fsMSSMEFTHiggs_mAmuDefaultInputParameters = {
   MSUSY -> 0,
   M1Input -> 0,
   M2Input -> 0,
   M3Input -> 0,
...
Options[FSMSSMEFTHiggs_mAmuOpenHandle] = {
    Sequence @@ fsDefaultSettings,
    Sequence @@ fsDefaultSMParameters,
    Sequence @@ fsMSSMEFTHiggs_mAmuDefaultInputParameters
};

FSMSSMEFTHiggs_mAmuOpenHandle[a___, (fsSettings | fsSMParameters | fsModelParameters) -> s_List, r___] :=
    FSMSSMEFTHiggs_mAmuOpenHandle[a, Sequence @@ s, r];

FSMSSMEFTHiggs_mAmuOpenHandle[OptionsPattern[]] :=
    FSMSSMEFTHiggs_mAmuOpenHandleLib[
        FSMSSMEFTHiggs_mAmuCheckIsNumeric /@ {
            ...
            (* MSSMEFTHiggs_mAmu input parameters *)
            ,
            OptionValue[MSUSY],
            OptionValue[M1Input],
            OptionValue[M2Input],
...
Options[FSMSSMEFTHiggs_mAmuSet] = Options[FSMSSMEFTHiggs_mAmuOpenHandle];

FSMSSMEFTHiggs_mAmuSet[handle_Integer, a___, (fsSettings | fsSMParameters | fsModelParameters) -> s_List, r___] :=
    FSMSSMEFTHiggs_mAmuSet[handle, a, Sequence @@ s, r];

FSMSSMEFTHiggs_mAmuSet[handle_Integer, p:OptionsPattern[]] :=
    FSMSSMEFTHiggs_mAmuSetLib[
        handle,
        ReleaseHold[Hold[FSMSSMEFTHiggs_mAmuCheckIsNumeric /@ {
            (* spectrum generator settings *)
            OptionValue[precisionGoal],
            OptionValue[maxIterations],
            OptionValue[solver],
        ...
        { p } /.
        FSMSSMEFTHiggs_mAmuGetSettings[handle] /.
        FSMSSMEFTHiggs_mAmuGetSMInputParameters[handle] /.
        FSMSSMEFTHiggs_mAmuGetInputParameters[handle]]];
