...
#ifndef MSSMEFTHiggs_mAmu_STANDARD_MODEL_TWO_SCALE_INITIAL_GUESSER_H
#define MSSMEFTHiggs_mAmu_STANDARD_MODEL_TWO_SCALE_INITIAL_GUESSER_H

#include "MSSMEFTHiggs_mAmu_initial_guesser.hpp"
...
template <class T>
class MSSMEFTHiggs_mAmu_standard_model_initial_guesser;

/**
 * @class MSSMEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>
 * @brief initial guesser for the MSSMEFTHiggs_mAmu tower
 */

template<>
class MSSMEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale> : public Initial_guesser {
public:
   MSSMEFTHiggs_mAmu_standard_model_initial_guesser(MSSMEFTHiggs_mAmu<Two_scale>*,
                               standard_model::StandardModel<Two_scale>*,
                               const softsusy::QedQcd&,
                               const standard_model::Standard_model_low_scale_constraint<Two_scale>&,
                               const MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale>&);
   virtual ~MSSMEFTHiggs_mAmu_standard_model_initial_guesser();
   virtual void guess(); ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   MSSMEFTHiggs_mAmu<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   MSSMEFTHiggs_mAmu_susy_scale_constraint<Two_scale> susy_constraint{};
