...
/**
 * @file MSSMEFTHiggs_mAmu_mass_eigenstates.hpp
 *
...
#ifndef MSSMEFTHiggs_mAmu_MASS_EIGENSTATES_H
#define MSSMEFTHiggs_mAmu_MASS_EIGENSTATES_H
...
class MSSMEFTHiggs_mAmu_ewsb_solver_interface;
/**
 * @class MSSMEFTHiggs_mAmu_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class MSSMEFTHiggs_mAmu_mass_eigenstates : public MSSMEFTHiggs_mAmu_soft_parameters {
public:
   explicit MSSMEFTHiggs_mAmu_mass_eigenstates(const MSSMEFTHiggs_mAmu_input_parameters& input_ = MSSMEFTHiggs_mAmu_input_parameters());
   MSSMEFTHiggs_mAmu_mass_eigenstates(const MSSMEFTHiggs_mAmu_mass_eigenstates&) = default;
   MSSMEFTHiggs_mAmu_mass_eigenstates(MSSMEFTHiggs_mAmu_mass_eigenstates&&) = default;
   virtual ~MSSMEFTHiggs_mAmu_mass_eigenstates() = default;
   MSSMEFTHiggs_mAmu_mass_eigenstates& operator=(const MSSMEFTHiggs_mAmu_mass_eigenstates&) = default;
   MSSMEFTHiggs_mAmu_mass_eigenstates& operator=(MSSMEFTHiggs_mAmu_mass_eigenstates&&) = default;
   ...
   void set_physical(const MSSMEFTHiggs_mAmu_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const MSSMEFTHiggs_mAmu_physical& get_physical() const;
   MSSMEFTHiggs_mAmu_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<MSSMEFTHiggs_mAmu_ewsb_solver_interface>&);
   ...
   double get_lsp(MSSMEFTHiggs_mAmu_info::Particles&) const;
...
private:
   ...
   MSSMEFTHiggs_mAmu_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{MSSMEFTHiggs_mAmu_info::model_name,
                     &MSSMEFTHiggs_mAmu_info::particle_names_getter,
                     &MSSMEFTHiggs_mAmu_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<MSSMEFTHiggs_mAmu_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const MSSMEFTHiggs_mAmu_mass_eigenstates&);
