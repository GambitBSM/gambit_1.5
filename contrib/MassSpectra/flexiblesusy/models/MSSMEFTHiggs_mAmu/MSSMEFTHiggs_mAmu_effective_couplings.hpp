...
#ifndef MSSMEFTHiggs_mAmu_EFFECTIVE_COUPLINGS_H
#define MSSMEFTHiggs_mAmu_EFFECTIVE_COUPLINGS_H
...
class MSSMEFTHiggs_mAmu_effective_couplings {
public:
   MSSMEFTHiggs_mAmu_effective_couplings(const MSSMEFTHiggs_mAmu_mass_eigenstates&,
   ...
   void set_model(const MSSMEFTHiggs_mAmu_mass_eigenstates& model_);
