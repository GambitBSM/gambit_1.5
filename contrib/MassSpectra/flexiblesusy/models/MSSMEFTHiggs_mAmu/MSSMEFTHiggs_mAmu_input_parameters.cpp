...
// File generated at Tue 9 Jan 2018 19:59:59
...
Eigen::ArrayXd MSSMEFTHiggs_mAmu_input_parameters::get() const
{
...
void MSSMEFTHiggs_mAmu_input_parameters::set(const Eigen::ArrayXd& pars)
{
   MSUSY = pars(0);
   M1Input = pars(1);
   M2Input = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const MSSMEFTHiggs_mAmu_input_parameters& input)
{
