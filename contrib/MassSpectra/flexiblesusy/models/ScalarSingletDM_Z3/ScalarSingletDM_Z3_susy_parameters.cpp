...
#define CLASSNAME ScalarSingletDM_Z3_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces
#define TRACE_STRUCT_TYPE Susy_traces
#define CALCULATE_TRACES(l) calc_susy_traces(l);

const int ScalarSingletDM_Z3_susy_parameters::numberOfParameters;

ScalarSingletDM_Z3_susy_parameters::ScalarSingletDM_Z3_susy_parameters(const ScalarSingletDM_Z3_input_parameters& input_)
   : input(input_)
{
   set_number_of_parameters(numberOfParameters);
}

ScalarSingletDM_Z3_susy_parameters::ScalarSingletDM_Z3_susy_parameters(
   double scale_, int loops_, int thresholds_,
   const ScalarSingletDM_Z3_input_parameters& input_
...
Eigen::ArrayXd ScalarSingletDM_Z3_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

ScalarSingletDM_Z3_susy_parameters ScalarSingletDM_Z3_susy_parameters::calc_beta(int loops) const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   return ScalarSingletDM_Z3_susy_parameters(get_scale(), loops, get_thresholds(), input,
                    beta_g1, beta_g2, beta_g3, beta_LamS, beta_LamSH, beta_LamH, beta_Yu, beta_Yd, beta_Ye);
}

ScalarSingletDM_Z3_susy_parameters ScalarSingletDM_Z3_susy_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void ScalarSingletDM_Z3_susy_parameters::clear()
{
   reset();
   g1 = 0.;
   g2 = 0.;
...
Eigen::ArrayXd ScalarSingletDM_Z3_susy_parameters::get() const
{
...
void ScalarSingletDM_Z3_susy_parameters::print(std::ostream& ostr) const
{
...
void ScalarSingletDM_Z3_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   g1 = pars(0);
   g2 = pars(1);
   g3 = pars(2);
...
const ScalarSingletDM_Z3_input_parameters& ScalarSingletDM_Z3_susy_parameters::get_input() const
{
   return input;
}

ScalarSingletDM_Z3_input_parameters& ScalarSingletDM_Z3_susy_parameters::get_input()
{
   return input;
}

void ScalarSingletDM_Z3_susy_parameters::set_input_parameters(const ScalarSingletDM_Z3_input_parameters& input_)
{
   input = input_;
}

ScalarSingletDM_Z3_susy_parameters::Susy_traces ScalarSingletDM_Z3_susy_parameters::calc_susy_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const ScalarSingletDM_Z3_susy_parameters& susy_pars)
{
