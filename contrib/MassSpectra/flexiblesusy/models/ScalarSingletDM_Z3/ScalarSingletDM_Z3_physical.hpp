...
#ifndef ScalarSingletDM_Z3_PHYSICAL_H
#define ScalarSingletDM_Z3_PHYSICAL_H
...
struct ScalarSingletDM_Z3_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const ScalarSingletDM_Z3_physical&);
