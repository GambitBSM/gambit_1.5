...
Eigen::ArrayXd ScalarSingletDM_Z3_input_parameters::get() const
{
...
void ScalarSingletDM_Z3_input_parameters::set(const Eigen::ArrayXd& pars)
{
   HiggsIN = pars(0);
   LamSHInput = pars(1);
   LamSInput = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const ScalarSingletDM_Z3_input_parameters& input)
{
