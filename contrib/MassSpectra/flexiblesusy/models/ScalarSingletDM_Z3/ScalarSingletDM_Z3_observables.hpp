...
#ifndef ScalarSingletDM_Z3_OBSERVABLES_H
#define ScalarSingletDM_Z3_OBSERVABLES_H
...
struct ScalarSingletDM_Z3_observables {
   ...
   ScalarSingletDM_Z3_observables();
...
ScalarSingletDM_Z3_observables calculate_observables(
   const ScalarSingletDM_Z3_mass_eigenstates&, const softsusy::QedQcd&,
