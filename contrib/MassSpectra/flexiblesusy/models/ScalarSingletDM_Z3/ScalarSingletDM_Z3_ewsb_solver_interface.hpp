...
/**
 * @file ScalarSingletDM_Z3_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Sat 26 May 2018 14:35:45 with FlexibleSUSY
 * 2.0.1 (git commit: unknown) and SARAH 4.12.2 .
 */

#ifndef ScalarSingletDM_Z3_EWSB_SOLVER_INTERFACE_H
#define ScalarSingletDM_Z3_EWSB_SOLVER_INTERFACE_H
...
class ScalarSingletDM_Z3_ewsb_solver_interface {
public:
   virtual ~ScalarSingletDM_Z3_ewsb_solver_interface() {}
   ...
   virtual int solve(ScalarSingletDM_Z3_mass_eigenstates&) = 0;
};
