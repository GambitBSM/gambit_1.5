...
#ifndef ScalarSingletDM_Z3_INFO_H
#define ScalarSingletDM_Z3_INFO_H
...
namespace ScalarSingletDM_Z3_info {
   ...
   class ScalarSingletDM_Z3_particle_names : public Names {
   public:
      virtual ~ScalarSingletDM_Z3_particle_names() = default;
   ...
   class ScalarSingletDM_Z3_parameter_names : public Names {
   public:
      virtual ~ScalarSingletDM_Z3_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const ScalarSingletDM_Z3_particle_names  particle_names_getter{};
   const ScalarSingletDM_Z3_parameter_names parameter_names_getter{};
