 ...
 */
Eigen::Matrix<double,3,3> ScalarSingletDM_Z3_susy_parameters::calc_beta_Ye_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> ScalarSingletDM_Z3_susy_parameters::calc_beta_Ye_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Ye = (twoLoop*(0.005*Ye*(1371*Quad(g1) + 5*Sqr(g1)*(25*
      ...
      80*traceYuAdjYu*Sqr(g3) + 6*Sqr(LamH) + 2*Sqr(LamSH)))) + 0.0375*(-20*(8*
 ...
 */
Eigen::Matrix<double,3,3> ScalarSingletDM_Z3_susy_parameters::calc_beta_Ye_3_loop(const Susy_traces& susy_traces) const
{
