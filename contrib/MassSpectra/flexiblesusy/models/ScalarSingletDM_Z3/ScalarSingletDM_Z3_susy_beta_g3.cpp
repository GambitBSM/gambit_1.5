 ...
 */
double ScalarSingletDM_Z3_susy_parameters::calc_beta_g3_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletDM_Z3_susy_parameters::calc_beta_g3_2_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double ScalarSingletDM_Z3_susy_parameters::calc_beta_g3_3_loop(const Susy_traces& susy_traces) const
{
