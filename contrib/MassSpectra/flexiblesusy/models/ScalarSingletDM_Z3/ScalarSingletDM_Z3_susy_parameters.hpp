...
#ifndef ScalarSingletDM_Z3_susy_parameters_H
#define ScalarSingletDM_Z3_susy_parameters_H
...
class ScalarSingletDM_Z3_susy_parameters : public Beta_function {
public:
   explicit ScalarSingletDM_Z3_susy_parameters(const ScalarSingletDM_Z3_input_parameters& input_ = ScalarSingletDM_Z3_input_parameters());
   ScalarSingletDM_Z3_susy_parameters(double scale_, int loops_, int thresholds_, const ScalarSingletDM_Z3_input_parameters& input_, double g1_, double g2_, double g3_, double LamS_, double LamSH_, double
   LamH_, const Eigen::Matrix<double,3,3>& Yu_, const Eigen::Matrix<double,3,3>
   & Yd_, const Eigen::Matrix<double,3,3>& Ye_
);
   ScalarSingletDM_Z3_susy_parameters(const ScalarSingletDM_Z3_susy_parameters&) = default;
   ScalarSingletDM_Z3_susy_parameters(ScalarSingletDM_Z3_susy_parameters&&) = default;
   virtual ~ScalarSingletDM_Z3_susy_parameters() = default;
   ScalarSingletDM_Z3_susy_parameters& operator=(const ScalarSingletDM_Z3_susy_parameters&) = default;
   ScalarSingletDM_Z3_susy_parameters& operator=(ScalarSingletDM_Z3_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const ScalarSingletDM_Z3_input_parameters& get_input() const;
   ScalarSingletDM_Z3_input_parameters& get_input();
   void set_input_parameters(const ScalarSingletDM_Z3_input_parameters&);

   ScalarSingletDM_Z3_susy_parameters calc_beta() const;
   ScalarSingletDM_Z3_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const ScalarSingletDM_Z3_susy_parameters&);
