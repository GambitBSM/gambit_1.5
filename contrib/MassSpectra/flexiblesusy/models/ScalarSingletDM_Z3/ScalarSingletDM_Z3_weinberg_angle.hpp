...
#ifndef ScalarSingletDM_Z3_WEINBERG_ANGLE_H
#define ScalarSingletDM_Z3_WEINBERG_ANGLE_H
...
/**
 * @class ScalarSingletDM_Z3_weinberg_angle
...
public:
   ...
   ScalarSingletDM_Z3_weinberg_angle(const ScalarSingletDM_Z3_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const ScalarSingletDM_Z3_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const ScalarSingletDM_Z3_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
