...
#ifndef ScalarSingletDM_Z3_EFFECTIVE_COUPLINGS_H
#define ScalarSingletDM_Z3_EFFECTIVE_COUPLINGS_H
...
class ScalarSingletDM_Z3_effective_couplings {
public:
   ScalarSingletDM_Z3_effective_couplings(const ScalarSingletDM_Z3_mass_eigenstates&,
   ...
   void set_model(const ScalarSingletDM_Z3_mass_eigenstates& model_);
