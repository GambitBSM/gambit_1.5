...
/**
 * @file MSSMatMSUSYEFTHiggs_mass_eigenstates.hpp
 *
...
#ifndef MSSMatMSUSYEFTHiggs_MASS_EIGENSTATES_H
#define MSSMatMSUSYEFTHiggs_MASS_EIGENSTATES_H
...
class MSSMatMSUSYEFTHiggs_ewsb_solver_interface;
/**
 * @class MSSMatMSUSYEFTHiggs_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class MSSMatMSUSYEFTHiggs_mass_eigenstates : public MSSMatMSUSYEFTHiggs_soft_parameters {
public:
   explicit MSSMatMSUSYEFTHiggs_mass_eigenstates(const MSSMatMSUSYEFTHiggs_input_parameters& input_ = MSSMatMSUSYEFTHiggs_input_parameters());
   MSSMatMSUSYEFTHiggs_mass_eigenstates(const MSSMatMSUSYEFTHiggs_mass_eigenstates&) = default;
   MSSMatMSUSYEFTHiggs_mass_eigenstates(MSSMatMSUSYEFTHiggs_mass_eigenstates&&) = default;
   virtual ~MSSMatMSUSYEFTHiggs_mass_eigenstates() = default;
   MSSMatMSUSYEFTHiggs_mass_eigenstates& operator=(const MSSMatMSUSYEFTHiggs_mass_eigenstates&) = default;
   MSSMatMSUSYEFTHiggs_mass_eigenstates& operator=(MSSMatMSUSYEFTHiggs_mass_eigenstates&&) = default;
   ...
   void set_physical(const MSSMatMSUSYEFTHiggs_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const MSSMatMSUSYEFTHiggs_physical& get_physical() const;
   MSSMatMSUSYEFTHiggs_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<MSSMatMSUSYEFTHiggs_ewsb_solver_interface>&);
   ...
   double get_lsp(MSSMatMSUSYEFTHiggs_info::Particles&) const;
...
private:
   ...
   MSSMatMSUSYEFTHiggs_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{MSSMatMSUSYEFTHiggs_info::model_name,
                     &MSSMatMSUSYEFTHiggs_info::particle_names_getter,
                     &MSSMatMSUSYEFTHiggs_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<MSSMatMSUSYEFTHiggs_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const MSSMatMSUSYEFTHiggs_mass_eigenstates&);
