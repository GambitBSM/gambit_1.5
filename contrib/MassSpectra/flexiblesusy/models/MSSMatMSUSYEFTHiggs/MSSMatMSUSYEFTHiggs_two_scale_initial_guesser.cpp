...
MSSMatMSUSYEFTHiggs_standard_model_initial_guesser<Two_scale>::MSSMatMSUSYEFTHiggs_standard_model_initial_guesser(
   ...
   const MSSMatMSUSYEFTHiggs_susy_scale_constraint<Two_scale>& susy_constraint_
)
   : Initial_guesser()
   , model(model_)
   , eft(eft_)
...
{
   if (!model)
      throw SetupError("MSSMatMSUSYEFTHiggs_initial_guesser: Error: pointer to model"
                       " MSSMatMSUSYEFTHiggs<Two_scale> must not be zero");
}
 ...
 */
void MSSMatMSUSYEFTHiggs_standard_model_initial_guesser<Two_scale>::guess()
{
 ...
 */
void MSSMatMSUSYEFTHiggs_standard_model_initial_guesser<Two_scale>::guess_eft_parameters()
{
...
void MSSMatMSUSYEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void MSSMatMSUSYEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MSSMatMSUSYEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MSSMatMSUSYEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void MSSMatMSUSYEFTHiggs_standard_model_initial_guesser<Two_scale>::guess_model_parameters()
{
