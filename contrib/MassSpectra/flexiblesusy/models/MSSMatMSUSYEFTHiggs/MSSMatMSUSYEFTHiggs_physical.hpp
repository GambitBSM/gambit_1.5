...
#ifndef MSSMatMSUSYEFTHiggs_PHYSICAL_H
#define MSSMatMSUSYEFTHiggs_PHYSICAL_H
...
struct MSSMatMSUSYEFTHiggs_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMatMSUSYEFTHiggs_physical&);
