...
#ifndef MSSMatMSUSYEFTHiggs_soft_parameters_H
#define MSSMatMSUSYEFTHiggs_soft_parameters_H
...
class MSSMatMSUSYEFTHiggs_soft_parameters : public MSSMatMSUSYEFTHiggs_susy_parameters {
public:
   explicit MSSMatMSUSYEFTHiggs_soft_parameters(const MSSMatMSUSYEFTHiggs_input_parameters& input_ = MSSMatMSUSYEFTHiggs_input_parameters());
   MSSMatMSUSYEFTHiggs_soft_parameters(const MSSMatMSUSYEFTHiggs_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>&
   ...
   MSSMatMSUSYEFTHiggs_soft_parameters(const MSSMatMSUSYEFTHiggs_soft_parameters&) = default;
   MSSMatMSUSYEFTHiggs_soft_parameters(MSSMatMSUSYEFTHiggs_soft_parameters&&) = default;
   virtual ~MSSMatMSUSYEFTHiggs_soft_parameters() = default;
   MSSMatMSUSYEFTHiggs_soft_parameters& operator=(const MSSMatMSUSYEFTHiggs_soft_parameters&) = default;
   MSSMatMSUSYEFTHiggs_soft_parameters& operator=(MSSMatMSUSYEFTHiggs_soft_parameters&&) = default;
   ...
   MSSMatMSUSYEFTHiggs_soft_parameters calc_beta() const;
   MSSMatMSUSYEFTHiggs_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const MSSMatMSUSYEFTHiggs_soft_parameters&);
