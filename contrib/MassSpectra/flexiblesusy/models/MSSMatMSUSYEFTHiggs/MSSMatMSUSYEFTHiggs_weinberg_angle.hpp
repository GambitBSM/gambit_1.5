...
#ifndef MSSMatMSUSYEFTHiggs_WEINBERG_ANGLE_H
#define MSSMatMSUSYEFTHiggs_WEINBERG_ANGLE_H
...
/**
 * @class MSSMatMSUSYEFTHiggs_weinberg_angle
...
public:
   ...
   MSSMatMSUSYEFTHiggs_weinberg_angle(const MSSMatMSUSYEFTHiggs_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMatMSUSYEFTHiggs_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMatMSUSYEFTHiggs_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
