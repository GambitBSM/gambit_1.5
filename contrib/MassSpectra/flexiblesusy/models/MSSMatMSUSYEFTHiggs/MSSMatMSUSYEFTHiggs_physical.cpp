...
void MSSMatMSUSYEFTHiggs_physical::clear()
{
   MVG = 0.;
   MGlu = 0.;
 ...
 * to be complex.
 */
void MSSMatMSUSYEFTHiggs_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void MSSMatMSUSYEFTHiggs_physical::convert_to_slha()
{
   SLHA_io::convert_symmetric_fermion_mixings_to_slha(LOCALPHYSICAL(MChi), LOCALPHYSICAL(ZN));

}

Eigen::ArrayXd MSSMatMSUSYEFTHiggs_physical::get() const
{
...
void MSSMatMSUSYEFTHiggs_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd MSSMatMSUSYEFTHiggs_physical::get_masses() const
{
...
void MSSMatMSUSYEFTHiggs_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MGlu = pars(1);
   MFv(0) = pars(2);
...
void MSSMatMSUSYEFTHiggs_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const MSSMatMSUSYEFTHiggs_physical& phys_pars)
{
