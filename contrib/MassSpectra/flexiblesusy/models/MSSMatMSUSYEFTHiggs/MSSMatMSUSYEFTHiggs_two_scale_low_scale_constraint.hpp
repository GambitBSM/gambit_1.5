...
#ifndef MSSMatMSUSYEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MSSMatMSUSYEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MSSMatMSUSYEFTHiggs_low_scale_constraint.hpp"
...
template<>
class MSSMatMSUSYEFTHiggs_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MSSMatMSUSYEFTHiggs_low_scale_constraint() = default;
   MSSMatMSUSYEFTHiggs_low_scale_constraint(MSSMatMSUSYEFTHiggs<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSMatMSUSYEFTHiggs_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MSSMatMSUSYEFTHiggs low-scale constraint"; }
