...
#ifndef MSSMatMSUSYEFTHiggs_STANDARD_MODEL_TWO_SCALE_INITIAL_GUESSER_H
#define MSSMatMSUSYEFTHiggs_STANDARD_MODEL_TWO_SCALE_INITIAL_GUESSER_H

#include "MSSMatMSUSYEFTHiggs_initial_guesser.hpp"
...
template <class T>
class MSSMatMSUSYEFTHiggs_standard_model_initial_guesser;

/**
 * @class MSSMatMSUSYEFTHiggs_standard_model_initial_guesser<Two_scale>
 * @brief initial guesser for the MSSMatMSUSYEFTHiggs tower
 */

template<>
class MSSMatMSUSYEFTHiggs_standard_model_initial_guesser<Two_scale> : public Initial_guesser {
public:
   MSSMatMSUSYEFTHiggs_standard_model_initial_guesser(MSSMatMSUSYEFTHiggs<Two_scale>*,
                               standard_model::StandardModel<Two_scale>*,
                               const softsusy::QedQcd&,
                               const standard_model::Standard_model_low_scale_constraint<Two_scale>&,
                               const MSSMatMSUSYEFTHiggs_susy_scale_constraint<Two_scale>&);
   virtual ~MSSMatMSUSYEFTHiggs_standard_model_initial_guesser();
   virtual void guess(); ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   MSSMatMSUSYEFTHiggs<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   MSSMatMSUSYEFTHiggs_susy_scale_constraint<Two_scale> susy_constraint{};
