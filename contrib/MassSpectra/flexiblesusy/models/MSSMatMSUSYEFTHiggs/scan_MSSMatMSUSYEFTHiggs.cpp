...
{
   std::cout <<
      "Usage: scan_MSSMatMSUSYEFTHiggs.x [options]\n"
      "Options:\n"
      "  --SignMu=<value>\n"
      "  --M1Input=<value>\n"
      "  --M2Input=<value>\n"
...
struct MSSMatMSUSYEFTHiggs_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
MSSMatMSUSYEFTHiggs_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   MSSMatMSUSYEFTHiggs_input_parameters& input)
{
   ...
   MSSMatMSUSYEFTHiggs_scan_result result;
...
void scan(int solver_type, MSSMatMSUSYEFTHiggs_input_parameters& input,
