...
#ifndef MSSMatMSUSYEFTHiggs_susy_parameters_H
#define MSSMatMSUSYEFTHiggs_susy_parameters_H
...
class MSSMatMSUSYEFTHiggs_susy_parameters : public Beta_function {
public:
   explicit MSSMatMSUSYEFTHiggs_susy_parameters(const MSSMatMSUSYEFTHiggs_input_parameters& input_ = MSSMatMSUSYEFTHiggs_input_parameters());
   MSSMatMSUSYEFTHiggs_susy_parameters(double scale_, int loops_, int thresholds_, const MSSMatMSUSYEFTHiggs_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   , const Eigen::Matrix<double,3,3>& Yu_, double Mu_, double g1_, double g2_,
   double g3_, double vd_, double vu_
);
   MSSMatMSUSYEFTHiggs_susy_parameters(const MSSMatMSUSYEFTHiggs_susy_parameters&) = default;
   MSSMatMSUSYEFTHiggs_susy_parameters(MSSMatMSUSYEFTHiggs_susy_parameters&&) = default;
   virtual ~MSSMatMSUSYEFTHiggs_susy_parameters() = default;
   MSSMatMSUSYEFTHiggs_susy_parameters& operator=(const MSSMatMSUSYEFTHiggs_susy_parameters&) = default;
   MSSMatMSUSYEFTHiggs_susy_parameters& operator=(MSSMatMSUSYEFTHiggs_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const MSSMatMSUSYEFTHiggs_input_parameters& get_input() const;
   MSSMatMSUSYEFTHiggs_input_parameters& get_input();
   void set_input_parameters(const MSSMatMSUSYEFTHiggs_input_parameters&);

   MSSMatMSUSYEFTHiggs_susy_parameters calc_beta() const;
   MSSMatMSUSYEFTHiggs_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMatMSUSYEFTHiggs_susy_parameters&);
