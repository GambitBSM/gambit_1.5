...
{
   std::cout <<
      "Usage: run_cmd_line_MSSMatMSUSYEFTHiggs.x [options]\n"
      "Options:\n"
      "  --SignMu=<value>\n"
      "  --M1Input=<value>\n"
      "  --M2Input=<value>\n"
...
int run_solver(const MSSMatMSUSYEFTHiggs_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(MSSMatMSUSYEFTHiggs_slha_io::fill_slhaea(
...
int run(int solver_type, const MSSMatMSUSYEFTHiggs_input_parameters& input)
{
   int exit_code = 0;
