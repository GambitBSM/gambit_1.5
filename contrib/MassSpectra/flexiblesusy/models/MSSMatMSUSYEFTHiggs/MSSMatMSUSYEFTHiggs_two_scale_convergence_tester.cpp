...
MSSMatMSUSYEFTHiggs_convergence_tester<Two_scale>::MSSMatMSUSYEFTHiggs_convergence_tester(
   MSSMatMSUSYEFTHiggs<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<MSSMatMSUSYEFTHiggs<Two_scale> >(model, accuracy_goal, sg)
{
}

double MSSMatMSUSYEFTHiggs_convergence_tester<Two_scale>::max_rel_diff() const
{
   const MSSMatMSUSYEFTHiggs<Two_scale>& ol = get_last_iteration_model();
   const MSSMatMSUSYEFTHiggs<Two_scale>& ne = get_current_iteration_model();
