...
#ifndef MSSMatMSUSYEFTHiggs_INFO_H
#define MSSMatMSUSYEFTHiggs_INFO_H
...
namespace MSSMatMSUSYEFTHiggs_info {
   ...
   enum Input_parameters : int { SignMu, M1Input, M2Input, M3Input, mHd2IN,
      mHu2IN, TanBeta, mq2Input0_0, mq2Input0_1, mq2Input0_2, mq2Input1_0,
   ...
   class MSSMatMSUSYEFTHiggs_particle_names : public Names {
   public:
      virtual ~MSSMatMSUSYEFTHiggs_particle_names() = default;
   ...
   class MSSMatMSUSYEFTHiggs_parameter_names : public Names {
   public:
      virtual ~MSSMatMSUSYEFTHiggs_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSMatMSUSYEFTHiggs_particle_names  particle_names_getter{};
   const MSSMatMSUSYEFTHiggs_parameter_names parameter_names_getter{};
