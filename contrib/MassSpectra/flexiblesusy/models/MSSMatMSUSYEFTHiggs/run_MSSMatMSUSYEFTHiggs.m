Get["models/MSSMatMSUSYEFTHiggs/MSSMatMSUSYEFTHiggs_librarylink.m"];

handle = FSMSSMatMSUSYEFTHiggsOpenHandle[
    fsSettings -> {
...
spectrum    = FSMSSMatMSUSYEFTHiggsCalculateSpectrum[handle];
observables = FSMSSMatMSUSYEFTHiggsCalculateObservables[handle];
FSMSSMatMSUSYEFTHiggsCloseHandle[handle];
