...
#ifndef MSSMatMSUSYEFTHiggs_EFFECTIVE_COUPLINGS_H
#define MSSMatMSUSYEFTHiggs_EFFECTIVE_COUPLINGS_H
...
class MSSMatMSUSYEFTHiggs_effective_couplings {
public:
   MSSMatMSUSYEFTHiggs_effective_couplings(const MSSMatMSUSYEFTHiggs_mass_eigenstates&,
   ...
   void set_model(const MSSMatMSUSYEFTHiggs_mass_eigenstates& model_);
