...
#define CLASSNAME MSSMatMSUSYEFTHiggs_weinberg_angle
 ...
 */
CLASSNAME::MSSMatMSUSYEFTHiggs_weinberg_angle(
...
void CLASSNAME::set_model(const MSSMatMSUSYEFTHiggs_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * MSSMatMSUSYEFTHiggs_info::normalization_g1;
   const double g2 = MODEL->get_g2() * MSSMatMSUSYEFTHiggs_info::normalization_g2;
