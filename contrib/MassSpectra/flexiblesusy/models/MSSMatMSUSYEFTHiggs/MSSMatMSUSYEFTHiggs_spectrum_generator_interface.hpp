...
// File generated at Thu 10 May 2018 14:39:06

#ifndef MSSMatMSUSYEFTHiggs_SPECTRUM_GENERATOR_INTERFACE_H
#define MSSMatMSUSYEFTHiggs_SPECTRUM_GENERATOR_INTERFACE_H
...
template <class T>
class MSSMatMSUSYEFTHiggs_spectrum_generator_interface {
public:
   virtual ~MSSMatMSUSYEFTHiggs_spectrum_generator_interface() = default;

   std::tuple<MSSMatMSUSYEFTHiggs<T>, standard_model::StandardModel<T>> get_models() const
   { return std::make_tuple(model, eft); }
   std::tuple<MSSMatMSUSYEFTHiggs_slha<MSSMatMSUSYEFTHiggs<T>>, standard_model::StandardModel<T>> get_models_slha() const
   { return std::make_tuple(MSSMatMSUSYEFTHiggs_slha<MSSMatMSUSYEFTHiggs<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.), eft); }

   MSSMatMSUSYEFTHiggs<T> get_model() const
   { return model; }
   MSSMatMSUSYEFTHiggs_slha<MSSMatMSUSYEFTHiggs<T>> get_model_slha() const
   { return MSSMatMSUSYEFTHiggs_slha<MSSMatMSUSYEFTHiggs<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.); }
   ...
   void run(const softsusy::QedQcd&, const MSSMatMSUSYEFTHiggs_input_parameters&);
   void write_running_couplings(const std::string& filename, double, double) const;
   void write_spectrum(const std::string& filename = "MSSMatMSUSYEFTHiggs_spectrum.dat") const;

protected:
   MSSMatMSUSYEFTHiggs<T> model;
   ...
   void translate_exception_to_problem(MSSMatMSUSYEFTHiggs<T>& model);
   virtual void run_except(const softsusy::QedQcd&, const MSSMatMSUSYEFTHiggs_input_parameters&) = 0;
};
 ...
 */
template <class T>
void MSSMatMSUSYEFTHiggs_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void MSSMatMSUSYEFTHiggs_spectrum_generator_interface<T>::run(
   const softsusy::QedQcd& qedqcd_, const MSSMatMSUSYEFTHiggs_input_parameters& input)
{
 ...
 */
template <class T>
void MSSMatMSUSYEFTHiggs_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   MSSMatMSUSYEFTHiggs_mass_eigenstates tmp_model(model);
   try {
   ...
   MSSMatMSUSYEFTHiggs_parameter_getter parameter_getter;
   Coupling_monitor<MSSMatMSUSYEFTHiggs_mass_eigenstates, MSSMatMSUSYEFTHiggs_parameter_getter>
 ...
 */
template <class T>
void MSSMatMSUSYEFTHiggs_spectrum_generator_interface<T>::write_spectrum(
   const std::string& filename) const
{
   MSSMatMSUSYEFTHiggs_spectrum_plotter plotter(model);
 ...
 */
template <class T>
void MSSMatMSUSYEFTHiggs_spectrum_generator_interface<T>::translate_exception_to_problem(MSSMatMSUSYEFTHiggs<T>& model)
{
   try {
      throw;
