...
// File generated at Thu 10 May 2018 14:38:33

#include "MSSMatMSUSYEFTHiggs_soft_parameters.hpp"
#include "config.h"
...
const int MSSMatMSUSYEFTHiggs_soft_parameters::numberOfParameters;

MSSMatMSUSYEFTHiggs_soft_parameters::MSSMatMSUSYEFTHiggs_soft_parameters(const MSSMatMSUSYEFTHiggs_input_parameters& input_)
   : MSSMatMSUSYEFTHiggs_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSMatMSUSYEFTHiggs_soft_parameters::MSSMatMSUSYEFTHiggs_soft_parameters(
   const MSSMatMSUSYEFTHiggs_susy_parameters& susy_model
   ...
   : MSSMatMSUSYEFTHiggs_susy_parameters(susy_model)
...
Eigen::ArrayXd MSSMatMSUSYEFTHiggs_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMatMSUSYEFTHiggs_soft_parameters MSSMatMSUSYEFTHiggs_soft_parameters::calc_beta(int loops) const
{
   ...
   const MSSMatMSUSYEFTHiggs_susy_parameters susy_betas(MSSMatMSUSYEFTHiggs_susy_parameters::calc_beta(loops));

   return MSSMatMSUSYEFTHiggs_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

MSSMatMSUSYEFTHiggs_soft_parameters MSSMatMSUSYEFTHiggs_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MSSMatMSUSYEFTHiggs_soft_parameters::clear()
{
   MSSMatMSUSYEFTHiggs_susy_parameters::clear();
...
Eigen::ArrayXd MSSMatMSUSYEFTHiggs_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MSSMatMSUSYEFTHiggs_susy_parameters::get());
...
void MSSMatMSUSYEFTHiggs_soft_parameters::print(std::ostream& ostr) const
{
   MSSMatMSUSYEFTHiggs_susy_parameters::print(ostr);
...
void MSSMatMSUSYEFTHiggs_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MSSMatMSUSYEFTHiggs_susy_parameters::set(pars);
...
MSSMatMSUSYEFTHiggs_soft_parameters::Soft_traces MSSMatMSUSYEFTHiggs_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSMatMSUSYEFTHiggs_soft_parameters& soft_pars)
{
