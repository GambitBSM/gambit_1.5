...
/**
 * @file ScalarSingletDM_Z2_a_muon.hpp
 *
 * This file was generated at Sat 26 May 2018 14:35:27 with FlexibleSUSY
 * 2.0.1 and SARAH 4.12.2 .
 */

#ifndef ScalarSingletDM_Z2_A_MUON_H
#define ScalarSingletDM_Z2_A_MUON_H

namespace flexiblesusy {
class ScalarSingletDM_Z2_mass_eigenstates;

namespace ScalarSingletDM_Z2_a_muon {
/**
* @fn calculate_a_muon
* @brief Calculates \f$a_\mu = (g-2)_\mu/2\f$ of the muon.
*/
double calculate_a_muon(const ScalarSingletDM_Z2_mass_eigenstates& model);

/**
* @fn calculate_a_muon_uncertainty
* @brief Calculates \f$\Delta a_\mu\f$ of the muon.
*/
double calculate_a_muon_uncertainty(const ScalarSingletDM_Z2_mass_eigenstates& model);
} // namespace ScalarSingletDM_Z2_a_muon
} // namespace flexiblesusy
