...
#ifndef ScalarSingletDM_Z2_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define ScalarSingletDM_Z2_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "ScalarSingletDM_Z2_low_scale_constraint.hpp"
...
template<>
class ScalarSingletDM_Z2_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   ScalarSingletDM_Z2_low_scale_constraint() = default;
   ScalarSingletDM_Z2_low_scale_constraint(ScalarSingletDM_Z2<Two_scale>*, const softsusy::QedQcd&);
   virtual ~ScalarSingletDM_Z2_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "ScalarSingletDM_Z2 low-scale constraint"; }
