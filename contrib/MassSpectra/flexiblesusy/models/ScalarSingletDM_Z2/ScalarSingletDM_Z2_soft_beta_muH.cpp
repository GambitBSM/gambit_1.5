...
// File generated at Sat 26 May 2018 14:35:18
 ...
 */
double ScalarSingletDM_Z2_soft_parameters::calc_beta_muH_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double ScalarSingletDM_Z2_soft_parameters::calc_beta_muH_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double ScalarSingletDM_Z2_soft_parameters::calc_beta_muH_3_loop(const Soft_traces& soft_traces) const
{
