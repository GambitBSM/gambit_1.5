...
#ifndef ScalarSingletDM_Z2_OBSERVABLES_H
#define ScalarSingletDM_Z2_OBSERVABLES_H
...
struct ScalarSingletDM_Z2_observables {
   ...
   ScalarSingletDM_Z2_observables();
...
ScalarSingletDM_Z2_observables calculate_observables(
   const ScalarSingletDM_Z2_mass_eigenstates&, const softsusy::QedQcd&,
