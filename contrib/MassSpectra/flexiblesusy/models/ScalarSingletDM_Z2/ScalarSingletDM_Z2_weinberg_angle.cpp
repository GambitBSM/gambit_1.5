...
#define CLASSNAME ScalarSingletDM_Z2_weinberg_angle
 ...
 */
CLASSNAME::ScalarSingletDM_Z2_weinberg_angle(
...
void CLASSNAME::set_model(const ScalarSingletDM_Z2_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * ScalarSingletDM_Z2_info::normalization_g1;
   const double g2 = MODEL->get_g2() * ScalarSingletDM_Z2_info::normalization_g2;
