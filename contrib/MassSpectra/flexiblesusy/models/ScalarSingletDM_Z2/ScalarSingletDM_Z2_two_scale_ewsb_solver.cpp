...
/**
 * @file ScalarSingletDM_Z2_two_scale_ewsb_solver.cpp
 *
...
#define CLASSNAME ScalarSingletDM_Z2_ewsb_solver<Two_scale>

/**
 * This method solves the EWSB conditions iteratively, trying several
 * root finding methods until a solution is found.
 */
int CLASSNAME::solve_iteratively(ScalarSingletDM_Z2_mass_eigenstates& model_to_solve)
{
...
int CLASSNAME::solve_iteratively_with(
   ScalarSingletDM_Z2_mass_eigenstates& model_to_solve, EWSB_solver* solver, const EWSB_vector_t& x_init)
{
 ...
 * @param solver solver
 */
void CLASSNAME::set_ewsb_solution(ScalarSingletDM_Z2_mass_eigenstates& model, const EWSB_solver* solver)
{
...
void CLASSNAME::set_best_ewsb_solution(ScalarSingletDM_Z2_mass_eigenstates& model, It first, It last)
{
...
int CLASSNAME::solve_iteratively_at(ScalarSingletDM_Z2_mass_eigenstates& model_to_solve, int l)
{
...
int CLASSNAME::solve(ScalarSingletDM_Z2_mass_eigenstates& model_to_solve)
{
   if (loop_order == 0) {
...
int CLASSNAME::solve_tree_level(ScalarSingletDM_Z2_mass_eigenstates& model)
{
   int error = EWSB_solver::SUCCESS;

   const auto muH = MODELPARAMETER(muH);
...
CLASSNAME::EWSB_vector_t CLASSNAME::initial_guess(const ScalarSingletDM_Z2_mass_eigenstates& model) const
{
...
CLASSNAME::EWSB_vector_t CLASSNAME::tadpole_equations(const ScalarSingletDM_Z2_mass_eigenstates& model) const
{
 ...
 */
CLASSNAME::EWSB_vector_t CLASSNAME::ewsb_step(const ScalarSingletDM_Z2_mass_eigenstates& model) const
{
   ...
   LamH = Re((-2*(muH*v - tadpole[0]))/Cube(v));
