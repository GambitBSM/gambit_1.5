 ...
 */
double ScalarSingletDM_Z2_soft_parameters::calc_beta_muS_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double ScalarSingletDM_Z2_soft_parameters::calc_beta_muS_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double ScalarSingletDM_Z2_soft_parameters::calc_beta_muS_3_loop(const Soft_traces& soft_traces) const
{
