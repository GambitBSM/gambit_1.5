...
#ifndef ScalarSingletDM_Z2_SPECTRUM_GENERATOR_INTERFACE_H
#define ScalarSingletDM_Z2_SPECTRUM_GENERATOR_INTERFACE_H

#include "ScalarSingletDM_Z2_mass_eigenstates.hpp"
#include "ScalarSingletDM_Z2_model.hpp"
...
template <class T>
class ScalarSingletDM_Z2_spectrum_generator_interface {
public:
   virtual ~ScalarSingletDM_Z2_spectrum_generator_interface() = default;

   std::tuple<ScalarSingletDM_Z2<T>, standard_model::StandardModel<T>> get_models() const
   { return std::make_tuple(model, eft); }
   std::tuple<ScalarSingletDM_Z2_slha<ScalarSingletDM_Z2<T>>, standard_model::StandardModel<T>> get_models_slha() const
   { return std::make_tuple(ScalarSingletDM_Z2_slha<ScalarSingletDM_Z2<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.), eft); }

   ScalarSingletDM_Z2<T> get_model() const
   { return model; }
   ScalarSingletDM_Z2_slha<ScalarSingletDM_Z2<T>> get_model_slha() const
   { return ScalarSingletDM_Z2_slha<ScalarSingletDM_Z2<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.); }
   ...
   void run(const softsusy::QedQcd&, const ScalarSingletDM_Z2_input_parameters&);
   void write_running_couplings(const std::string& filename, double, double) const;
   void write_spectrum(const std::string& filename = "ScalarSingletDM_Z2_spectrum.dat") const;

protected:
   ScalarSingletDM_Z2<T> model;
   ...
   void translate_exception_to_problem(ScalarSingletDM_Z2<T>& model);
   virtual void run_except(const softsusy::QedQcd&, const ScalarSingletDM_Z2_input_parameters&) = 0;
};
 ...
 */
template <class T>
void ScalarSingletDM_Z2_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void ScalarSingletDM_Z2_spectrum_generator_interface<T>::run(
   const softsusy::QedQcd& qedqcd_, const ScalarSingletDM_Z2_input_parameters& input)
{
 ...
 */
template <class T>
void ScalarSingletDM_Z2_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   ScalarSingletDM_Z2_mass_eigenstates tmp_model(model);
   try {
   ...
   ScalarSingletDM_Z2_parameter_getter parameter_getter;
   Coupling_monitor<ScalarSingletDM_Z2_mass_eigenstates, ScalarSingletDM_Z2_parameter_getter>
 ...
 */
template <class T>
void ScalarSingletDM_Z2_spectrum_generator_interface<T>::write_spectrum(
   const std::string& filename) const
{
   ScalarSingletDM_Z2_spectrum_plotter plotter(model);
 ...
 */
template <class T>
void ScalarSingletDM_Z2_spectrum_generator_interface<T>::translate_exception_to_problem(ScalarSingletDM_Z2<T>& model)
{
   try {
      throw;
