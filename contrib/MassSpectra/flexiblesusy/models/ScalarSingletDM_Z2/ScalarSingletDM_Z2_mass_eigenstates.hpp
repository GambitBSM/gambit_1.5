...
/**
 * @file ScalarSingletDM_Z2_mass_eigenstates.hpp
 *
...
#ifndef ScalarSingletDM_Z2_MASS_EIGENSTATES_H
#define ScalarSingletDM_Z2_MASS_EIGENSTATES_H
...
class ScalarSingletDM_Z2_ewsb_solver_interface;
/**
 * @class ScalarSingletDM_Z2_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class ScalarSingletDM_Z2_mass_eigenstates : public ScalarSingletDM_Z2_soft_parameters {
public:
   explicit ScalarSingletDM_Z2_mass_eigenstates(const ScalarSingletDM_Z2_input_parameters& input_ = ScalarSingletDM_Z2_input_parameters());
   ScalarSingletDM_Z2_mass_eigenstates(const ScalarSingletDM_Z2_mass_eigenstates&) = default;
   ScalarSingletDM_Z2_mass_eigenstates(ScalarSingletDM_Z2_mass_eigenstates&&) = default;
   virtual ~ScalarSingletDM_Z2_mass_eigenstates() = default;
   ScalarSingletDM_Z2_mass_eigenstates& operator=(const ScalarSingletDM_Z2_mass_eigenstates&) = default;
   ScalarSingletDM_Z2_mass_eigenstates& operator=(ScalarSingletDM_Z2_mass_eigenstates&&) = default;
   ...
   void set_physical(const ScalarSingletDM_Z2_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const ScalarSingletDM_Z2_physical& get_physical() const;
   ScalarSingletDM_Z2_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<ScalarSingletDM_Z2_ewsb_solver_interface>&);
...
private:
   ...
   ScalarSingletDM_Z2_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{ScalarSingletDM_Z2_info::model_name,
                     &ScalarSingletDM_Z2_info::particle_names_getter,
                     &ScalarSingletDM_Z2_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<ScalarSingletDM_Z2_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const ScalarSingletDM_Z2_mass_eigenstates&);
