...
#ifndef ScalarSingletDM_Z2_INFO_H
#define ScalarSingletDM_Z2_INFO_H
...
namespace ScalarSingletDM_Z2_info {
   ...
   enum Parameters : int { g1, g2, g3, LamS, LamSH, LamH, Yu0_0, Yu0_1, Yu0_2,
      ...
      , Ye2_1, Ye2_2, muS, muH, v, NUMBER_OF_PARAMETERS };
   ...
   class ScalarSingletDM_Z2_particle_names : public Names {
   public:
      virtual ~ScalarSingletDM_Z2_particle_names() = default;
   ...
   class ScalarSingletDM_Z2_parameter_names : public Names {
   public:
      virtual ~ScalarSingletDM_Z2_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const ScalarSingletDM_Z2_particle_names  particle_names_getter{};
   const ScalarSingletDM_Z2_parameter_names parameter_names_getter{};
