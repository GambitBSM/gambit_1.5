...
ScalarSingletDM_Z2_slha_io::ScalarSingletDM_Z2_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void ScalarSingletDM_Z2_slha_io::clear()
{
   slha_io.clear();
}

void ScalarSingletDM_Z2_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void ScalarSingletDM_Z2_slha_io::set_extpar(const ScalarSingletDM_Z2_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void ScalarSingletDM_Z2_slha_io::set_imminpar(const ScalarSingletDM_Z2_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void ScalarSingletDM_Z2_slha_io::set_imextpar(const ScalarSingletDM_Z2_input_parameters& input)
{
 ...
 */
void ScalarSingletDM_Z2_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void ScalarSingletDM_Z2_slha_io::set_minpar(const ScalarSingletDM_Z2_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void ScalarSingletDM_Z2_slha_io::set_input(const ScalarSingletDM_Z2_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void ScalarSingletDM_Z2_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void ScalarSingletDM_Z2_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void ScalarSingletDM_Z2_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void ScalarSingletDM_Z2_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void ScalarSingletDM_Z2_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void ScalarSingletDM_Z2_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, ScalarSingletDM_Z2_info::model_name)
 ...
 */
void ScalarSingletDM_Z2_slha_io::set_mass(const ScalarSingletDM_Z2_physical& physical,
 ...
 */
void ScalarSingletDM_Z2_slha_io::set_mixing_matrices(const ScalarSingletDM_Z2_physical& physical,
...
void ScalarSingletDM_Z2_slha_io::set_ckm(
...
void ScalarSingletDM_Z2_slha_io::set_pmns(
 ...
 */
void ScalarSingletDM_Z2_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double ScalarSingletDM_Z2_slha_io::get_parameter_output_scale() const
{
 ...
 */
void ScalarSingletDM_Z2_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void ScalarSingletDM_Z2_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void ScalarSingletDM_Z2_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void ScalarSingletDM_Z2_slha_io::fill(ScalarSingletDM_Z2_input_parameters& input) const
{
 ...
 */
void ScalarSingletDM_Z2_slha_io::fill_drbar_parameters(ScalarSingletDM_Z2_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void ScalarSingletDM_Z2_slha_io::fill(ScalarSingletDM_Z2_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   ScalarSingletDM_Z2_physical physical_hk;
 ...
 */
void ScalarSingletDM_Z2_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void ScalarSingletDM_Z2_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void ScalarSingletDM_Z2_slha_io::fill_minpar_tuple(ScalarSingletDM_Z2_input_parameters& input,
...
void ScalarSingletDM_Z2_slha_io::fill_extpar_tuple(ScalarSingletDM_Z2_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void ScalarSingletDM_Z2_slha_io::fill_imminpar_tuple(ScalarSingletDM_Z2_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void ScalarSingletDM_Z2_slha_io::fill_imextpar_tuple(ScalarSingletDM_Z2_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void ScalarSingletDM_Z2_slha_io::fill_physical(ScalarSingletDM_Z2_physical& physical) const
{
   {
 ...
 */
double ScalarSingletDM_Z2_slha_io::read_scale() const
{
