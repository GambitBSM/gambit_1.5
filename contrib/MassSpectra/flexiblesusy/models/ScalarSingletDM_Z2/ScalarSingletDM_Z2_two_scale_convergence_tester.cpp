...
ScalarSingletDM_Z2_convergence_tester<Two_scale>::ScalarSingletDM_Z2_convergence_tester(
   ScalarSingletDM_Z2<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<ScalarSingletDM_Z2<Two_scale> >(model, accuracy_goal, sg)
{
}

double ScalarSingletDM_Z2_convergence_tester<Two_scale>::max_rel_diff() const
{
   const ScalarSingletDM_Z2<Two_scale>& ol = get_last_iteration_model();
   const ScalarSingletDM_Z2<Two_scale>& ne = get_current_iteration_model();
