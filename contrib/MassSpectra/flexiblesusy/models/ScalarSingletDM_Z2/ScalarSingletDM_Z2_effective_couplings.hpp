...
#ifndef ScalarSingletDM_Z2_EFFECTIVE_COUPLINGS_H
#define ScalarSingletDM_Z2_EFFECTIVE_COUPLINGS_H
...
class ScalarSingletDM_Z2_effective_couplings {
public:
   ScalarSingletDM_Z2_effective_couplings(const ScalarSingletDM_Z2_mass_eigenstates&,
   ...
   void set_model(const ScalarSingletDM_Z2_mass_eigenstates& model_);
