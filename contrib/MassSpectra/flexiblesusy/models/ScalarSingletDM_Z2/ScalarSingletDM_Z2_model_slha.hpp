...
/**
 * @class ScalarSingletDM_Z2_slha<T>
...
class ScalarSingletDM_Z2_slha : public Model {
public:
   explicit ScalarSingletDM_Z2_slha(const ScalarSingletDM_Z2_input_parameters& input_ = ScalarSingletDM_Z2_input_parameters());
   explicit ScalarSingletDM_Z2_slha(const Model&, bool do_convert_masses_to_slha = true);
   ScalarSingletDM_Z2_slha(const ScalarSingletDM_Z2_slha&) = default;
   ScalarSingletDM_Z2_slha(ScalarSingletDM_Z2_slha&&) = default;
   virtual ~ScalarSingletDM_Z2_slha() = default;
   ScalarSingletDM_Z2_slha& operator=(const ScalarSingletDM_Z2_slha&) = default;
   ScalarSingletDM_Z2_slha& operator=(ScalarSingletDM_Z2_slha&&) = default;
   ...
   const ScalarSingletDM_Z2_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   ScalarSingletDM_Z2_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   ScalarSingletDM_Z2_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
ScalarSingletDM_Z2_slha<Model>::ScalarSingletDM_Z2_slha(const ScalarSingletDM_Z2_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
ScalarSingletDM_Z2_slha<Model>::ScalarSingletDM_Z2_slha(const Model& model_,
...
template <class Model>
void ScalarSingletDM_Z2_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void ScalarSingletDM_Z2_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void ScalarSingletDM_Z2_slha<Model>::convert_to_slha()
{
...
template <class Model>
void ScalarSingletDM_Z2_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void ScalarSingletDM_Z2_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void ScalarSingletDM_Z2_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void ScalarSingletDM_Z2_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void ScalarSingletDM_Z2_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const ScalarSingletDM_Z2_physical& ScalarSingletDM_Z2_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
ScalarSingletDM_Z2_physical& ScalarSingletDM_Z2_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void ScalarSingletDM_Z2_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void ScalarSingletDM_Z2_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const ScalarSingletDM_Z2_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
