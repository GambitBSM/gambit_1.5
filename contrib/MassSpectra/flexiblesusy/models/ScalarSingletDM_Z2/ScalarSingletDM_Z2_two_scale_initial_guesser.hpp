...
#ifndef ScalarSingletDM_Z2_STANDARD_MODEL_TWO_SCALE_INITIAL_GUESSER_H
#define ScalarSingletDM_Z2_STANDARD_MODEL_TWO_SCALE_INITIAL_GUESSER_H

#include "ScalarSingletDM_Z2_initial_guesser.hpp"
...
template <class T>
class ScalarSingletDM_Z2_standard_model_initial_guesser;

/**
 * @class ScalarSingletDM_Z2_standard_model_initial_guesser<Two_scale>
 * @brief initial guesser for the ScalarSingletDM_Z2 tower
 */

template<>
class ScalarSingletDM_Z2_standard_model_initial_guesser<Two_scale> : public Initial_guesser {
public:
   ScalarSingletDM_Z2_standard_model_initial_guesser(ScalarSingletDM_Z2<Two_scale>*,
                               standard_model::StandardModel<Two_scale>*,
                               const softsusy::QedQcd&,
                               const standard_model::Standard_model_low_scale_constraint<Two_scale>&,
                               const ScalarSingletDM_Z2_susy_scale_constraint<Two_scale>&,
                               const ScalarSingletDM_Z2_high_scale_constraint<Two_scale>&);
   virtual ~ScalarSingletDM_Z2_standard_model_initial_guesser();
   virtual void guess(); ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   ScalarSingletDM_Z2<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   ScalarSingletDM_Z2_susy_scale_constraint<Two_scale> susy_constraint{};
   ScalarSingletDM_Z2_high_scale_constraint<Two_scale> high_constraint{};
