...
#ifndef ScalarSingletDM_Z2_WEINBERG_ANGLE_H
#define ScalarSingletDM_Z2_WEINBERG_ANGLE_H
...
/**
 * @class ScalarSingletDM_Z2_weinberg_angle
...
public:
   ...
   ScalarSingletDM_Z2_weinberg_angle(const ScalarSingletDM_Z2_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const ScalarSingletDM_Z2_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const ScalarSingletDM_Z2_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
