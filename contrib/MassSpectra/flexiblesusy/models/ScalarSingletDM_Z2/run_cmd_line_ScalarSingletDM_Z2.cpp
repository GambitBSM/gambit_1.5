...
{
   std::cout <<
      "Usage: run_cmd_line_ScalarSingletDM_Z2.x [options]\n"
      "Options:\n"
      "  --HiggsIN=<value>\n"
      "  --LamSHInput=<value>\n"
      "  --LamSInput=<value>\n"
...
int run_solver(const ScalarSingletDM_Z2_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(ScalarSingletDM_Z2_slha_io::fill_slhaea(
...
int run(int solver_type, const ScalarSingletDM_Z2_input_parameters& input)
{
   int exit_code = 0;
