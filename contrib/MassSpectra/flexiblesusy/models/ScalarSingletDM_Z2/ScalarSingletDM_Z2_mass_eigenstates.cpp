...
/**
 * @file ScalarSingletDM_Z2_mass_eigenstates.cpp
 * @brief implementation of the ScalarSingletDM_Z2 model class
 *
 * Contains the definition of the ScalarSingletDM_Z2 model class methods
...
#include "ScalarSingletDM_Z2_two_scale_ewsb_solver.hpp"
#endif
...
#define CLASSNAME ScalarSingletDM_Z2_mass_eigenstates
...
CLASSNAME::ScalarSingletDM_Z2_mass_eigenstates(const ScalarSingletDM_Z2_input_parameters& input_)
   : ScalarSingletDM_Z2_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new ScalarSingletDM_Z2_ewsb_solver<Two_scale>())
#endif
{
}
...
const ScalarSingletDM_Z2_physical& CLASSNAME::get_physical() const
{
   return physical;
}

ScalarSingletDM_Z2_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const ScalarSingletDM_Z2_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<ScalarSingletDM_Z2_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("ScalarSingletDM_Z2_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("ScalarSingletDM_Z2_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("ScalarSingletDM_Z2_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving ScalarSingletDM_Z2 EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "ScalarSingletDM_Z2\n"
           "========================================\n";
   ScalarSingletDM_Z2_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(Mss) < 0.) problems.flag_pole_tachyon(ScalarSingletDM_Z2_info::ss);
   if (PHYSICAL(Mhh) < 0.) problems.flag_pole_tachyon(ScalarSingletDM_Z2_info::hh);
...
{
   ScalarSingletDM_Z2_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   ScalarSingletDM_Z2_soft_parameters::run_to(scale, eps);
}
...
void CLASSNAME::calculate_MHp()
{
   ...
   if (MHp < 0.) {
      problems.flag_running_tachyon(ScalarSingletDM_Z2_info::Hp);
   }
...
void CLASSNAME::calculate_Mss()
{
   ...
   if (Mss < 0.) {
      problems.flag_running_tachyon(ScalarSingletDM_Z2_info::ss);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh < 0.) {
      problems.flag_running_tachyon(ScalarSingletDM_Z2_info::Ah);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh < 0.) {
      problems.flag_running_tachyon(ScalarSingletDM_Z2_info::hh);
   }
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(ScalarSingletDM_Z2_info::Fd, eigenvalue_error >
      precision * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(ScalarSingletDM_Z2_info::Fu, eigenvalue_error >
      precision * Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(ScalarSingletDM_Z2_info::Fe, eigenvalue_error >
      precision * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MVWp()
{
   ...
   if (MVWp < 0.) {
      problems.flag_running_tachyon(ScalarSingletDM_Z2_info::VWp);
   }
...
void CLASSNAME::calculate_MVG_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::VG);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::VG);
}

void CLASSNAME::calculate_Mss_pole()
{
   if (!force_output && problems.is_running_tachyon(ScalarSingletDM_Z2_info::ss))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::ss);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::ss);
}
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::Fv);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::Fv);
}

void CLASSNAME::calculate_Mhh_pole()
{
   if (!force_output && problems.is_running_tachyon(ScalarSingletDM_Z2_info::hh))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::hh);
}
...
void CLASSNAME::calculate_MVP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::VP);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::VP);
}

void CLASSNAME::calculate_MVZ_pole()
{
   if (!force_output && problems.is_running_tachyon(ScalarSingletDM_Z2_info::VZ))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(ScalarSingletDM_Z2_info::VZ);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::VZ);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::VZ);
}
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_Vd, mix_Ud,
            eigenvalue_error);
         problems.flag_bad_mass(ScalarSingletDM_Z2_info::Fd,
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::Fd);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::Fd);
}
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_Vu, mix_Uu,
            eigenvalue_error);
         problems.flag_bad_mass(ScalarSingletDM_Z2_info::Fu,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_Vu, mix_Uu);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::Fu);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::Fu);
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_Ve, mix_Ue,
            eigenvalue_error);
         problems.flag_bad_mass(ScalarSingletDM_Z2_info::Fe,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_Ve, mix_Ue);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::Fe);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::Fe);
}

void CLASSNAME::calculate_MVWp_pole()
{
   if (!force_output && problems.is_running_tachyon(ScalarSingletDM_Z2_info::VWp))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(ScalarSingletDM_Z2_info::VWp);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::VWp);
   else
      problems.unflag_no_pole_mass_convergence(ScalarSingletDM_Z2_info::VWp);
}
...
std::ostream& operator<<(std::ostream& ostr, const ScalarSingletDM_Z2_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
