...
{
   std::cout <<
      "Usage: scan_ScalarSingletDM_Z2.x [options]\n"
      "Options:\n"
      "  --HiggsIN=<value>\n"
      "  --LamSHInput=<value>\n"
      "  --LamSInput=<value>\n"
...
struct ScalarSingletDM_Z2_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
ScalarSingletDM_Z2_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   ScalarSingletDM_Z2_input_parameters& input)
{
   ...
   ScalarSingletDM_Z2_scan_result result;
...
void scan(int solver_type, ScalarSingletDM_Z2_input_parameters& input,
