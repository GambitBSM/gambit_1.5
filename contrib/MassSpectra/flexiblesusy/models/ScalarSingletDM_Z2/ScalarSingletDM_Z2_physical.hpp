...
#ifndef ScalarSingletDM_Z2_PHYSICAL_H
#define ScalarSingletDM_Z2_PHYSICAL_H
...
struct ScalarSingletDM_Z2_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const ScalarSingletDM_Z2_physical&);
