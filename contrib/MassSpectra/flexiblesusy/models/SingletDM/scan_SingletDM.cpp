...
// File generated at Thu 12 Oct 2017 14:05:50
...
struct SingletDM_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
SingletDM_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   SingletDM_input_parameters& input)
{
...
void scan(int solver_type, SingletDM_input_parameters& input,
