...
template <>
class SingletDM_spectrum_generator<Two_scale>
   : public SingletDM_spectrum_generator_interface<Two_scale> {
public:
   SingletDM_spectrum_generator() = default;
   virtual ~SingletDM_spectrum_generator() = default;
...
protected:
   virtual void run_except(const softsusy::QedQcd&, const SingletDM_input_parameters&) override;
