...
class SingletDM_effective_couplings {
public:
   SingletDM_effective_couplings(const SingletDM_mass_eigenstates&,
   ...
   void set_model(const SingletDM_mass_eigenstates& model_);
