 ...
 */
double SingletDM_susy_parameters::calc_beta_LamSH_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double SingletDM_susy_parameters::calc_beta_LamSH_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_LamSH = Re(0.0025*LamSH*twoLoop*(1671*Quad(g1) + 10*Sqr(g1)*(288*
      ...
      traceYdAdjYd + traceYeAdjYe + 3*traceYuAdjYu))*Sqr(g2) + 8*(72*LamS*LamSH
      ...
      *traceYuAdjYu) + 27*traceYuAdjYuYuAdjYu - 80*traceYdAdjYd*Sqr(g3) - 80*
      traceYuAdjYu*Sqr(g3) + 30*Sqr(LamH) + 60*Sqr(LamS) + 21*Sqr(LamSH)))));
 ...
 */
double SingletDM_susy_parameters::calc_beta_LamSH_3_loop(const Susy_traces& susy_traces) const
{
