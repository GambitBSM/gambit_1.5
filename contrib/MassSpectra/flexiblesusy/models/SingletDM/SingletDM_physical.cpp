 ...
 * to be complex.
 */
void SingletDM_physical::convert_to_hk()
{
 ...
 * be negative.
 */
void SingletDM_physical::convert_to_slha()
{

}

Eigen::ArrayXd SingletDM_physical::get() const
{
...
void SingletDM_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd SingletDM_physical::get_masses() const
{
...
void SingletDM_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MHp = pars(1);
   Mss = pars(2);
...
void SingletDM_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "pole masses:\n"
           "----------------------------------------\n";
...
std::ostream& operator<<(std::ostream& ostr, const SingletDM_physical& phys_pars)
{
