...
// File generated at Tue 26 Sep 2017 22:39:03
...
public:
   ...
   SingletDM_susy_parameters(double scale_, int loops_, int thresholds_, const SingletDM_input_parameters& input_, double g1_, double g2_, double g3_, double LamS_, double LamSH_, double
   LamH_, const Eigen::Matrix<double,3,3>& Yu_, const Eigen::Matrix<double,3,3>
   & Yd_, const Eigen::Matrix<double,3,3>& Ye_
);
   SingletDM_susy_parameters(const SingletDM_susy_parameters&) = default;
   SingletDM_susy_parameters(SingletDM_susy_parameters&&) = default;
   virtual ~SingletDM_susy_parameters() = default;
   SingletDM_susy_parameters& operator=(const SingletDM_susy_parameters&) = default;
   SingletDM_susy_parameters& operator=(SingletDM_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const SingletDM_input_parameters& get_input() const;
   SingletDM_input_parameters& get_input();
   void set_input_parameters(const SingletDM_input_parameters&);

   SingletDM_susy_parameters calc_beta() const;
   SingletDM_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const SingletDM_susy_parameters&);
