...
class SingletDM_slha : public Model {
public:
   explicit SingletDM_slha(const SingletDM_input_parameters& input_ = SingletDM_input_parameters());
   explicit SingletDM_slha(const Model&, bool do_convert_masses_to_slha = true);
   SingletDM_slha(const SingletDM_slha&) = default;
   SingletDM_slha(SingletDM_slha&&) = default;
   virtual ~SingletDM_slha() = default;
   SingletDM_slha& operator=(const SingletDM_slha&) = default;
   SingletDM_slha& operator=(SingletDM_slha&&) = default;
...
template <class Model>
SingletDM_slha<Model>::SingletDM_slha(const SingletDM_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
SingletDM_slha<Model>::SingletDM_slha(const Model& model_,
...
template <class Model>
void SingletDM_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void SingletDM_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void SingletDM_slha<Model>::convert_to_slha()
{
...
template <class Model>
void SingletDM_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void SingletDM_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void SingletDM_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void SingletDM_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void SingletDM_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const SingletDM_physical& SingletDM_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
SingletDM_physical& SingletDM_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void SingletDM_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void SingletDM_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const SingletDM_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
