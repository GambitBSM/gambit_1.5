...
#include "SingletDM_two_scale_ewsb_solver.hpp"
#endif
...
#define CLASSNAME SingletDM_mass_eigenstates
...
CLASSNAME::SingletDM_mass_eigenstates(const SingletDM_input_parameters& input_)
   : SingletDM_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new SingletDM_ewsb_solver<Two_scale>())
#endif
{
}
...
const SingletDM_physical& CLASSNAME::get_physical() const
{
   return physical;
}

SingletDM_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const SingletDM_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<SingletDM_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("SingletDM_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("SingletDM_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("SingletDM_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving SingletDM EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "SingletDM\n"
           "========================================\n";
   SingletDM_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   const auto save_LamH_raii = make_raii_save(LamH);
...
{
   if (PHYSICAL(Mss) < 0.) problems.flag_pole_tachyon(SingletDM_info::ss);
   if (PHYSICAL(Mhh) < 0.) problems.flag_pole_tachyon(SingletDM_info::hh);
...
{
   SingletDM_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   SingletDM_soft_parameters::run_to(scale, eps);
}
...
void CLASSNAME::calculate_MHp()
{
   ...
   if (MHp < 0.) {
      problems.flag_running_tachyon(SingletDM_info::Hp);
   }
...
void CLASSNAME::calculate_Mss()
{
   ...
   if (Mss < 0.) {
      problems.flag_running_tachyon(SingletDM_info::ss);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh < 0.) {
      problems.flag_running_tachyon(SingletDM_info::Ah);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh < 0.) {
      problems.flag_running_tachyon(SingletDM_info::hh);
   }
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(SingletDM_info::Fd, eigenvalue_error >
      precision * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(SingletDM_info::Fu, eigenvalue_error >
      precision * Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(SingletDM_info::Fe, eigenvalue_error >
      precision * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MVWp()
{
   ...
   if (MVWp < 0.) {
      problems.flag_running_tachyon(SingletDM_info::VWp);
   }
...
{
   double result = Re(muH*v + 0.5*LamH*Cube(v));
...
std::complex<double> CLASSNAME::self_energy_Hp_1loop(double p ) const
{
   ...
   result += -0.5*A0(Sqr(Mss))*Cp(Hp,ss,ss,Conj(Hp));
...
std::complex<double> CLASSNAME::self_energy_ss_1loop(double p ) const
{
   ...
   result += -(A0(Sqr(MHp))*Cp(Hp,ss,ss,Conj(Hp)));
...
std::complex<double> CLASSNAME::self_energy_VG_1loop(double p ) const
{
   ...
   result += 3*AbsSqr(Cp(bar(VG),VG,VG))*B00(Sqr(p),Sqr(MVG),Sqr(MVG));
   result += -(AbsSqr(CpVGVGVG())*(15*B00(Sqr(p),0,0) + Sqr(p) + 6*B0(Sqr(p),0,
      0)*Sqr(p)));
   result += 0;
   result += 0.5*SUM(gI1,0,2,SUM(gI2,0,2,(AbsSqr(Cp(bar(Fd(gI1)),Fd(gI2),VG)(PL
      )) + AbsSqr(Cp(bar(Fd(gI1)),Fd(gI2),VG)(PR)))*H0(Sqr(p),Sqr(MFd(gI1)),Sqr(
      MFd(gI2))) + 4*B0(Sqr(p),Sqr(MFd(gI1)),Sqr(MFd(gI2)))*MFd(gI1)*MFd(gI2)*Re(
      Conj(Cp(bar(Fd(gI1)),Fd(gI2),VG)(PL))*Cp(bar(Fd(gI1)),Fd(gI2),VG)(PR))));
   result += 0.5*SUM(gI1,0,2,SUM(gI2,0,2,(AbsSqr(Cp(bar(Fu(gI1)),Fu(gI2),VG)(PL
      )) + AbsSqr(Cp(bar(Fu(gI1)),Fu(gI2),VG)(PR)))*H0(Sqr(p),Sqr(MFu(gI1)),Sqr(
      MFu(gI2))) + 4*B0(Sqr(p),Sqr(MFu(gI1)),Sqr(MFu(gI2)))*MFu(gI1)*MFu(gI2)*Re(
      Conj(Cp(bar(Fu(gI1)),Fu(gI2),VG)(PL))*Cp(bar(Fu(gI1)),Fu(gI2),VG)(PR))));
...
std::complex<double> CLASSNAME::self_energy_VP_1loop(double p ) const
{
   ...
   result += -4*AbsSqr(Cp(Hp,Conj(Hp),VP))*B00(Sqr(p),Sqr(MHp),Sqr(MHp));
   result += 2*AbsSqr(Cp(Hp,Conj(VWp),VP))*B0(Sqr(p),Sqr(MVWp),Sqr(MHp));
   result += 2*AbsSqr(Cp(bar(VWp),VWp,VP))*B00(Sqr(p),Sqr(MVWp),Sqr(MVWp));
   result += A0(Sqr(MHp))*Cp(Hp,Conj(Hp),VP,VP);
   result += -0.6666666666666666*AbsSqr(Cp(Conj(VWp),VP,VWp))*(3*A0(Sqr(MVWp))
      + 15*B00(Sqr(p),Sqr(MVWp),Sqr(MVWp)) - 6*Sqr(MVWp) + Sqr(p) + 3*B0(Sqr(p),
      Sqr(MVWp),Sqr(MVWp))*(Sqr(MVWp) + 2*Sqr(p)));
   result += 3*SUM(gI1,0,2,SUM(gI2,0,2,(AbsSqr(Cp(bar(Fd(gI1)),Fd(gI2),VP)(PL))
      + AbsSqr(Cp(bar(Fd(gI1)),Fd(gI2),VP)(PR)))*H0(Sqr(p),Sqr(MFd(gI1)),Sqr(MFd(
      gI2))) + 4*B0(Sqr(p),Sqr(MFd(gI1)),Sqr(MFd(gI2)))*MFd(gI1)*MFd(gI2)*Re(Conj(
      Cp(bar(Fd(gI1)),Fd(gI2),VP)(PL))*Cp(bar(Fd(gI1)),Fd(gI2),VP)(PR))));
   result += SUM(gI1,0,2,SUM(gI2,0,2,(AbsSqr(Cp(bar(Fe(gI1)),Fe(gI2),VP)(PL)) +
      AbsSqr(Cp(bar(Fe(gI1)),Fe(gI2),VP)(PR)))*H0(Sqr(p),Sqr(MFe(gI1)),Sqr(MFe(
      gI2))) + 4*B0(Sqr(p),Sqr(MFe(gI1)),Sqr(MFe(gI2)))*MFe(gI1)*MFe(gI2)*Re(Conj(
      Cp(bar(Fe(gI1)),Fe(gI2),VP)(PL))*Cp(bar(Fe(gI1)),Fe(gI2),VP)(PR))));
   result += 3*SUM(gI1,0,2,SUM(gI2,0,2,(AbsSqr(Cp(bar(Fu(gI1)),Fu(gI2),VP)(PL))
      + AbsSqr(Cp(bar(Fu(gI1)),Fu(gI2),VP)(PR)))*H0(Sqr(p),Sqr(MFu(gI1)),Sqr(MFu(
      gI2))) + 4*B0(Sqr(p),Sqr(MFu(gI1)),Sqr(MFu(gI2)))*MFu(gI1)*MFu(gI2)*Re(Conj(
      Cp(bar(Fu(gI1)),Fu(gI2),VP)(PL))*Cp(bar(Fu(gI1)),Fu(gI2),VP)(PR))));
   result += 2*Sqr(MVWp)*Cp(Conj(VWp),VP,VP,VWp)(3);
   result += -(A0(Sqr(MVWp))*(Cp(Conj(VWp),VP,VP,VWp)(1) + Cp(Conj(VWp),VP,VP,
      VWp)(2) + 4*Cp(Conj(VWp),VP,VP,VWp)(3)));
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_1(double p , int gO1, int gO2) const
{
   ...
   result += SUM(gI2,0,2,B0(Sqr(p),Sqr(MFe(gI2)),Sqr(MHp))*Conj(Cp(bar(Fv(gO2))
      ,Fe(gI2),Hp)(PL))*MFe(gI2)*Cp(bar(Fv(gO1)),Fe(gI2),Hp)(PR));
   result += -4*SUM(gI2,0,2,(-0.5 + B0(Sqr(p),Sqr(MFe(gI2)),Sqr(MVWp)))*Conj(Cp
      (bar(Fv(gO2)),Fe(gI2),VWp)(PR))*MFe(gI2)*Cp(bar(Fv(gO1)),Fe(gI2),VWp)(PL));
   result += -4*SUM(gI2,0,2,(-0.5 + B0(Sqr(p),Sqr(MFv(gI2)),Sqr(MVZ)))*Conj(Cp(
      bar(Fv(gO2)),Fv(gI2),VZ)(PR))*MFv(gI2)*Cp(bar(Fv(gO1)),Fv(gI2),VZ)(PL));
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_PR(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI2,0,2,B1(Sqr(p),Sqr(MFe(gI2)),Sqr(MHp))*Conj(Cp(bar(Fv(
      gO2)),Fe(gI2),Hp)(PR))*Cp(bar(Fv(gO1)),Fe(gI2),Hp)(PR));
   result += -SUM(gI2,0,2,(0.5 + B1(Sqr(p),Sqr(MFe(gI2)),Sqr(MVWp)))*Conj(Cp(
      bar(Fv(gO2)),Fe(gI2),VWp)(PL))*Cp(bar(Fv(gO1)),Fe(gI2),VWp)(PL));
   result += -SUM(gI2,0,2,(0.5 + B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVZ)))*Conj(Cp(bar
      (Fv(gO2)),Fv(gI2),VZ)(PL))*Cp(bar(Fv(gO1)),Fv(gI2),VZ)(PL));
...
std::complex<double> CLASSNAME::self_energy_Fv_1loop_PL(double p , int gO1, int gO2) const
{
   ...
   result += -0.5*SUM(gI2,0,2,B1(Sqr(p),Sqr(MFe(gI2)),Sqr(MHp))*Conj(Cp(bar(Fv(
      gO2)),Fe(gI2),Hp)(PL))*Cp(bar(Fv(gO1)),Fe(gI2),Hp)(PL));
   result += -SUM(gI2,0,2,(0.5 + B1(Sqr(p),Sqr(MFe(gI2)),Sqr(MVWp)))*Conj(Cp(
      bar(Fv(gO2)),Fe(gI2),VWp)(PR))*Cp(bar(Fv(gO1)),Fe(gI2),VWp)(PR));
   result += -SUM(gI2,0,2,(0.5 + B1(Sqr(p),Sqr(MFv(gI2)),Sqr(MVZ)))*Conj(Cp(bar
      (Fv(gO2)),Fv(gI2),VZ)(PR))*Cp(bar(Fv(gO1)),Fv(gI2),VZ)(PR));
...
void CLASSNAME::calculate_MVG_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDM_info::VG);
   else
      problems.unflag_no_pole_mass_convergence(SingletDM_info::VG);
}

void CLASSNAME::calculate_Mss_pole()
{
   if (!force_output && problems.is_running_tachyon(SingletDM_info::ss))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDM_info::ss);
   else
      problems.unflag_no_pole_mass_convergence(SingletDM_info::ss);
}
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDM_info::Fv);
   else
      problems.unflag_no_pole_mass_convergence(SingletDM_info::Fv);
}

void CLASSNAME::calculate_Mhh_pole()
{
   if (!force_output && problems.is_running_tachyon(SingletDM_info::hh))
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDM_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(SingletDM_info::hh);
}
...
void CLASSNAME::calculate_MVP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDM_info::VP);
   else
      problems.unflag_no_pole_mass_convergence(SingletDM_info::VP);
}

void CLASSNAME::calculate_MVZ_pole()
{
   if (!force_output && problems.is_running_tachyon(SingletDM_info::VZ))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(SingletDM_info::VZ);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDM_info::VZ);
   else
      problems.unflag_no_pole_mass_convergence(SingletDM_info::VZ);
}
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_Vd, mix_Ud,
            eigenvalue_error);
         problems.flag_bad_mass(SingletDM_info::Fd,
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDM_info::Fd);
   else
      problems.unflag_no_pole_mass_convergence(SingletDM_info::Fd);
}
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_Vu, mix_Uu,
            eigenvalue_error);
         problems.flag_bad_mass(SingletDM_info::Fu,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_Vu, mix_Uu);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDM_info::Fu);
   else
      problems.unflag_no_pole_mass_convergence(SingletDM_info::Fu);
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_Ve, mix_Ue,
            eigenvalue_error);
         problems.flag_bad_mass(SingletDM_info::Fe,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_Ve, mix_Ue);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDM_info::Fe);
   else
      problems.unflag_no_pole_mass_convergence(SingletDM_info::Fe);
}

void CLASSNAME::calculate_MVWp_pole()
{
   if (!force_output && problems.is_running_tachyon(SingletDM_info::VWp))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(SingletDM_info::VWp);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDM_info::VWp);
   else
      problems.unflag_no_pole_mass_convergence(SingletDM_info::VWp);
}
...
std::ostream& operator<<(std::ostream& ostr, const SingletDM_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
