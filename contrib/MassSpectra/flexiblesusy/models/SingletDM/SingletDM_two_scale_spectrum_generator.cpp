...
double SingletDM_spectrum_generator<Two_scale>::get_pole_mass_scale() const
{
                                ...
                                const SingletDM_input_parameters& input)
{
   ...
   SingletDM_low_scale_constraint<Two_scale>  low_scale_constraint(&model, qedqcd);

   high_scale_constraint.initialize();
   susy_scale_constraint.initialize();
   low_scale_constraint .initialize();

   SingletDM_convergence_tester<Two_scale> convergence_tester(
   ...
   SingletDM_initial_guesser<Two_scale> initial_guesser(&model, qedqcd,
...
void SingletDM_spectrum_generator<Two_scale>::calculate_spectrum()
{
