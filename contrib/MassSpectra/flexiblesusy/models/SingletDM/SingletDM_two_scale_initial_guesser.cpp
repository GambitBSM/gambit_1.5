...
SingletDM_standard_model_initial_guesser<Two_scale>::SingletDM_standard_model_initial_guesser(
...
{
   if (!model)
      throw SetupError("SingletDM_initial_guesser: Error: pointer to model"
 ...
 */
void SingletDM_standard_model_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void SingletDM_standard_model_initial_guesser<Two_scale>::guess_eft_parameters()
{
...
void SingletDM_standard_model_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void SingletDM_standard_model_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void SingletDM_standard_model_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void SingletDM_standard_model_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void SingletDM_standard_model_initial_guesser<Two_scale>::guess_model_parameters()
{
