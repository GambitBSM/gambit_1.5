...
standard_model::Standard_model SingletDM_effective_couplings::initialise_SM() const
{
...
void SingletDM_effective_couplings::run_SM_strong_coupling_to(standard_model::Standard_model sm, double m)
{
   sm.run_to(m);
