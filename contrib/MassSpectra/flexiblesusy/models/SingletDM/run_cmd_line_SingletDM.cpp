...
int run_solver(const SingletDM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(SingletDM_slha_io::fill_slhaea(
...
int run(int solver_type, const SingletDM_input_parameters& input)
{
   int exit_code = 0;
