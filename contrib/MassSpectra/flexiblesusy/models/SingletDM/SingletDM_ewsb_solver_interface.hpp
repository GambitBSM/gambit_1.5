...
/**
 * @file SingletDM_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Sun 24 Sep 2017 15:55:48 with FlexibleSUSY
 * 2.0.0-dev (git commit: 4d4c39a2702e9a6604f84813ccb0b85d40987f3b) and SARAH 4.11.0 .
 */

#ifndef SingletDM_EWSB_SOLVER_INTERFACE_H
#define SingletDM_EWSB_SOLVER_INTERFACE_H
...
class SingletDM_ewsb_solver_interface {
public:
   virtual ~SingletDM_ewsb_solver_interface() {}
   ...
   virtual int solve(SingletDM_mass_eigenstates&) = 0;
};
