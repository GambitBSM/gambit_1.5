...
{
   std::cout <<
      "Usage: scan_MSSMatMGUTEFTHiggs.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --SignMu=<value>\n"
      "  --mHd2IN=<value>\n"
...
struct MSSMatMGUTEFTHiggs_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
MSSMatMGUTEFTHiggs_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   MSSMatMGUTEFTHiggs_input_parameters& input)
{
   ...
   MSSMatMGUTEFTHiggs_scan_result result;
...
void scan(int solver_type, MSSMatMGUTEFTHiggs_input_parameters& input,
