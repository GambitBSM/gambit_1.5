...
#ifndef MSSMatMGUTEFTHiggs_PHYSICAL_H
#define MSSMatMGUTEFTHiggs_PHYSICAL_H
...
struct MSSMatMGUTEFTHiggs_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMatMGUTEFTHiggs_physical&);
