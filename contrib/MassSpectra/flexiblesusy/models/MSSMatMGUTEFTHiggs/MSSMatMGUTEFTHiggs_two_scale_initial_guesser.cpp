...
MSSMatMGUTEFTHiggs_standard_model_initial_guesser<Two_scale>::MSSMatMGUTEFTHiggs_standard_model_initial_guesser(
   ...
   const MSSMatMGUTEFTHiggs_susy_scale_constraint<Two_scale>& susy_constraint_,
   const MSSMatMGUTEFTHiggs_high_scale_constraint<Two_scale>& high_constraint_
)
   : Initial_guesser()
   , model(model_)
   , eft(eft_)
...
{
   if (!model)
      throw SetupError("MSSMatMGUTEFTHiggs_initial_guesser: Error: pointer to model"
                       " MSSMatMGUTEFTHiggs<Two_scale> must not be zero");
}
 ...
 */
void MSSMatMGUTEFTHiggs_standard_model_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void MSSMatMGUTEFTHiggs_standard_model_initial_guesser<Two_scale>::guess_eft_parameters()
{
...
void MSSMatMGUTEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void MSSMatMGUTEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MSSMatMGUTEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MSSMatMGUTEFTHiggs_standard_model_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void MSSMatMGUTEFTHiggs_standard_model_initial_guesser<Two_scale>::guess_model_parameters()
{
