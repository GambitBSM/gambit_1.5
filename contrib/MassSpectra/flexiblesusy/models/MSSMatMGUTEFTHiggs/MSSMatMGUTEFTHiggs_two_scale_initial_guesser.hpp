...
#ifndef MSSMatMGUTEFTHiggs_STANDARD_MODEL_TWO_SCALE_INITIAL_GUESSER_H
#define MSSMatMGUTEFTHiggs_STANDARD_MODEL_TWO_SCALE_INITIAL_GUESSER_H

#include "MSSMatMGUTEFTHiggs_initial_guesser.hpp"
...
template <class T>
class MSSMatMGUTEFTHiggs_standard_model_initial_guesser;

/**
 * @class MSSMatMGUTEFTHiggs_standard_model_initial_guesser<Two_scale>
 * @brief initial guesser for the MSSMatMGUTEFTHiggs tower
 */

template<>
class MSSMatMGUTEFTHiggs_standard_model_initial_guesser<Two_scale> : public Initial_guesser {
public:
   MSSMatMGUTEFTHiggs_standard_model_initial_guesser(MSSMatMGUTEFTHiggs<Two_scale>*,
                               standard_model::StandardModel<Two_scale>*,
                               const softsusy::QedQcd&,
                               const standard_model::Standard_model_low_scale_constraint<Two_scale>&,
                               const MSSMatMGUTEFTHiggs_susy_scale_constraint<Two_scale>&,
                               const MSSMatMGUTEFTHiggs_high_scale_constraint<Two_scale>&);
   virtual ~MSSMatMGUTEFTHiggs_standard_model_initial_guesser();
   virtual void guess(); ///< initial guess

   void set_running_precision(double p) { running_precision = p; }

private:
   MSSMatMGUTEFTHiggs<Two_scale>* model{nullptr}; ///< pointer to model class
   ...
   MSSMatMGUTEFTHiggs_susy_scale_constraint<Two_scale> susy_constraint{};
   MSSMatMGUTEFTHiggs_high_scale_constraint<Two_scale> high_constraint{};
