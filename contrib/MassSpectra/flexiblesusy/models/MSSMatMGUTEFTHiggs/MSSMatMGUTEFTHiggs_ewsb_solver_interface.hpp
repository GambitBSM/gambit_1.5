...
/**
 * @file MSSMatMGUTEFTHiggs_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Thu 10 May 2018 14:36:13 with FlexibleSUSY
 * 2.0.1 (git commit: unknown) and SARAH 4.12.2 .
 */

#ifndef MSSMatMGUTEFTHiggs_EWSB_SOLVER_INTERFACE_H
#define MSSMatMGUTEFTHiggs_EWSB_SOLVER_INTERFACE_H
...
class MSSMatMGUTEFTHiggs_ewsb_solver_interface {
public:
   virtual ~MSSMatMGUTEFTHiggs_ewsb_solver_interface() {}
   ...
   virtual int solve(MSSMatMGUTEFTHiggs_mass_eigenstates&) = 0;
};
