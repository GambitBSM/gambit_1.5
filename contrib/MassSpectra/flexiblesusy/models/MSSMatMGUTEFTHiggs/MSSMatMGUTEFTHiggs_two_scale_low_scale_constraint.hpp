...
#ifndef MSSMatMGUTEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MSSMatMGUTEFTHiggs_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MSSMatMGUTEFTHiggs_low_scale_constraint.hpp"
...
template<>
class MSSMatMGUTEFTHiggs_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MSSMatMGUTEFTHiggs_low_scale_constraint() = default;
   MSSMatMGUTEFTHiggs_low_scale_constraint(MSSMatMGUTEFTHiggs<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSMatMGUTEFTHiggs_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MSSMatMGUTEFTHiggs low-scale constraint"; }
