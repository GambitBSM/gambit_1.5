Get["models/MSSMatMGUTEFTHiggs/MSSMatMGUTEFTHiggs_librarylink.m"];

handle = FSMSSMatMGUTEFTHiggsOpenHandle[
    fsSettings -> {
...
spectrum    = FSMSSMatMGUTEFTHiggsCalculateSpectrum[handle];
observables = FSMSSMatMGUTEFTHiggsCalculateObservables[handle];
FSMSSMatMGUTEFTHiggsCloseHandle[handle];
