...
// File generated at Thu 10 May 2018 14:35:42
...
const int MSSMatMGUTEFTHiggs_soft_parameters::numberOfParameters;

MSSMatMGUTEFTHiggs_soft_parameters::MSSMatMGUTEFTHiggs_soft_parameters(const MSSMatMGUTEFTHiggs_input_parameters& input_)
   : MSSMatMGUTEFTHiggs_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSMatMGUTEFTHiggs_soft_parameters::MSSMatMGUTEFTHiggs_soft_parameters(
   const MSSMatMGUTEFTHiggs_susy_parameters& susy_model
   ...
   : MSSMatMGUTEFTHiggs_susy_parameters(susy_model)
...
Eigen::ArrayXd MSSMatMGUTEFTHiggs_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMatMGUTEFTHiggs_soft_parameters MSSMatMGUTEFTHiggs_soft_parameters::calc_beta(int loops) const
{
   ...
   const MSSMatMGUTEFTHiggs_susy_parameters susy_betas(MSSMatMGUTEFTHiggs_susy_parameters::calc_beta(loops));

   return MSSMatMGUTEFTHiggs_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

MSSMatMGUTEFTHiggs_soft_parameters MSSMatMGUTEFTHiggs_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MSSMatMGUTEFTHiggs_soft_parameters::clear()
{
   MSSMatMGUTEFTHiggs_susy_parameters::clear();
...
Eigen::ArrayXd MSSMatMGUTEFTHiggs_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MSSMatMGUTEFTHiggs_susy_parameters::get());
...
void MSSMatMGUTEFTHiggs_soft_parameters::print(std::ostream& ostr) const
{
   MSSMatMGUTEFTHiggs_susy_parameters::print(ostr);
...
void MSSMatMGUTEFTHiggs_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MSSMatMGUTEFTHiggs_susy_parameters::set(pars);
...
MSSMatMGUTEFTHiggs_soft_parameters::Soft_traces MSSMatMGUTEFTHiggs_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSMatMGUTEFTHiggs_soft_parameters& soft_pars)
{
