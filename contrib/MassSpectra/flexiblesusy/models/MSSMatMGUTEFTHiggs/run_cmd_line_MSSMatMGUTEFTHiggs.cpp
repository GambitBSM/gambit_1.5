...
{
   std::cout <<
      "Usage: run_cmd_line_MSSMatMGUTEFTHiggs.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --SignMu=<value>\n"
      "  --mHd2IN=<value>\n"
...
int run_solver(const MSSMatMGUTEFTHiggs_input_parameters& input)
{
   ...
   MSSMatMGUTEFTHiggs_scales scales;
   ...
   // SLHA output
   SLHAea::Coll slhaea(MSSMatMGUTEFTHiggs_slha_io::fill_slhaea(
...
int run(int solver_type, const MSSMatMGUTEFTHiggs_input_parameters& input)
{
   int exit_code = 0;
