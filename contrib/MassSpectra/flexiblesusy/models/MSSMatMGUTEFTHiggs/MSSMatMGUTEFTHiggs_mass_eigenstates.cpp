...
// File generated at Thu 10 May 2018 14:36:10

/**
 * @file MSSMatMGUTEFTHiggs_mass_eigenstates.cpp
 ...
 * parameters.
 *
 * This file was generated at Thu 10 May 2018 14:36:10 with FlexibleSUSY
 * 2.0.1 (git commit: unknown) and SARAH 4.12.2 .
 */

#include "MSSMatMGUTEFTHiggs_mass_eigenstates.hpp"
#include "MSSMatMGUTEFTHiggs_ewsb_solver_interface.hpp"
...
#include "MSSMatMGUTEFTHiggs_two_scale_ewsb_solver.hpp"
#endif
...
#define CLASSNAME MSSMatMGUTEFTHiggs_mass_eigenstates
...
CLASSNAME::MSSMatMGUTEFTHiggs_mass_eigenstates(const MSSMatMGUTEFTHiggs_input_parameters& input_)
   : MSSMatMGUTEFTHiggs_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new MSSMatMGUTEFTHiggs_ewsb_solver<Two_scale>())
#endif
{
}
...
const MSSMatMGUTEFTHiggs_physical& CLASSNAME::get_physical() const
{
   return physical;
}

MSSMatMGUTEFTHiggs_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const MSSMatMGUTEFTHiggs_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<MSSMatMGUTEFTHiggs_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("MSSMatMGUTEFTHiggs_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("MSSMatMGUTEFTHiggs_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("MSSMatMGUTEFTHiggs_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving MSSMatMGUTEFTHiggs EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "MSSMatMGUTEFTHiggs\n"
           "========================================\n";
   MSSMatMGUTEFTHiggs_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(MSd).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMatMGUTEFTHiggs_info::Sd);
   if (PHYSICAL(MSv).tail<3>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMatMGUTEFTHiggs_info::Sv);
   if (PHYSICAL(MSu).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMatMGUTEFTHiggs_info::Su);
   if (PHYSICAL(MSe).tail<6>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMatMGUTEFTHiggs_info::Se);
   if (PHYSICAL(Mhh).tail<2>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMatMGUTEFTHiggs_info::hh);
   if (PHYSICAL(MAh).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMatMGUTEFTHiggs_info::Ah);
   if (PHYSICAL(MHpm).tail<1>().minCoeff() < 0.) problems.flag_pole_tachyon(MSSMatMGUTEFTHiggs_info::Hpm);
...
{
   MSSMatMGUTEFTHiggs_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   MSSMatMGUTEFTHiggs_soft_parameters::run_to(scale, eps);
}
 ...
 * @return mass of LSP
 */
double CLASSNAME::get_lsp(MSSMatMGUTEFTHiggs_info::Particles& particle_type) const
{
   double lsp_mass = std::numeric_limits<double>::max();
   double tmp_mass;
   particle_type = MSSMatMGUTEFTHiggs_info::NUMBER_OF_PARTICLES;

   tmp_mass = Abs(PHYSICAL(MChi(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMatMGUTEFTHiggs_info::Chi;
   }

   tmp_mass = Abs(PHYSICAL(MSv(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMatMGUTEFTHiggs_info::Sv;
   }

   tmp_mass = Abs(PHYSICAL(MSu(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMatMGUTEFTHiggs_info::Su;
   }

   tmp_mass = Abs(PHYSICAL(MSd(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMatMGUTEFTHiggs_info::Sd;
   }

   tmp_mass = Abs(PHYSICAL(MSe(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMatMGUTEFTHiggs_info::Se;
   }

   tmp_mass = Abs(PHYSICAL(MCha(0)));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMatMGUTEFTHiggs_info::Cha;
   }

   tmp_mass = Abs(PHYSICAL(MGlu));
   if (tmp_mass < lsp_mass) {
      lsp_mass = tmp_mass;
      particle_type = MSSMatMGUTEFTHiggs_info::Glu;
   }
...
void CLASSNAME::calculate_MSd()
{
   ...
   problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Sd, eigenvalue_error >
      precision * Abs(MSd(0)));
#else
   ...
   if (MSd.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMatMGUTEFTHiggs_info::Sd);
   }
...
void CLASSNAME::calculate_MSv()
{
   ...
   problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Sv, eigenvalue_error >
      precision * Abs(MSv(0)));
#else
   ...
   if (MSv.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMatMGUTEFTHiggs_info::Sv);
   }
...
void CLASSNAME::calculate_MSu()
{
   ...
   problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Su, eigenvalue_error >
      precision * Abs(MSu(0)));
#else
   ...
   if (MSu.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMatMGUTEFTHiggs_info::Su);
   }
...
void CLASSNAME::calculate_MSe()
{
   ...
   problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Se, eigenvalue_error >
      precision * Abs(MSe(0)));
#else
   ...
   if (MSe.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMatMGUTEFTHiggs_info::Se);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::hh, eigenvalue_error >
      precision * Abs(Mhh(0)));
#else
   ...
   if (Mhh.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMatMGUTEFTHiggs_info::hh);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Ah, eigenvalue_error >
      precision * Abs(MAh(0)));
#else
   ...
   if (MAh.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMatMGUTEFTHiggs_info::Ah);
   }
...
void CLASSNAME::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Hpm, eigenvalue_error
   ...
   if (MHpm.minCoeff() < 0.) {
      problems.flag_running_tachyon(MSSMatMGUTEFTHiggs_info::Hpm);
   }
...
void CLASSNAME::calculate_MChi()
{
   ...
   problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Chi, eigenvalue_error
...
void CLASSNAME::calculate_MCha()
{
   ...
   problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Cha, eigenvalue_error
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Fe, eigenvalue_error >
      precision * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Fd, eigenvalue_error >
      precision * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Fu, eigenvalue_error >
      precision * Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MVWm()
{
   ...
   if (MVWm < 0.) {
      problems.flag_running_tachyon(MSSMatMGUTEFTHiggs_info::VWm);
   }
...
void CLASSNAME::calculate_MVZ_pole()
{
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(MSSMatMGUTEFTHiggs_info::VZ);
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZD;
            ...
            problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Sd,
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         Eigen::Matrix<double,3,3> mix_ZV;
            ...
            problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Sv,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZV);
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZU;
            ...
            problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Su,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZU);
   ...
   do {
      ...
      for (int es = 0; es < 6; ++es) {
         ...
         Eigen::Matrix<double,6,6> mix_ZE;
            ...
            problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Se,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZE);
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZH;
            ...
            problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::hh,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZH);
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZA;
            ...
            problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Ah,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZA);
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         Eigen::Matrix<double,2,2> mix_ZP;
            ...
            problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Hpm,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_hermitian(M_loop, eigen_values,
               mix_ZP);
   ...
   do {
      ...
      for (int es = 0; es < 4; ++es) {
         ...
         decltype(ZN) mix_ZN;
            ...
            problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Chi,
               eigenvalue_error > precision * Abs(eigen_values(0)));
         #else
            fs_diagonalize_symmetric(M_loop, eigen_values,
               mix_ZN);
   ...
   do {
      ...
      for (int es = 0; es < 2; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_UM, mix_UP,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Cha,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_UM, mix_UP);
      #endif
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZEL, mix_ZER,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Fe,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZEL, mix_ZER);
      #endif
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZDL, mix_ZDR,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Fd,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZDL, mix_ZDR);
      #endif
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_ZUL, mix_ZUR,
            eigenvalue_error);
         problems.flag_bad_mass(MSSMatMGUTEFTHiggs_info::Fu,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_ZUL, mix_ZUR);
      #endif
...
void CLASSNAME::calculate_MVWm_pole()
{
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(MSSMatMGUTEFTHiggs_info::VWm);
...
std::ostream& operator<<(std::ostream& ostr, const MSSMatMGUTEFTHiggs_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
