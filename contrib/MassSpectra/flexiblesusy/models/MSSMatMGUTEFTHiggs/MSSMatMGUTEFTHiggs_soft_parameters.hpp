...
#ifndef MSSMatMGUTEFTHiggs_soft_parameters_H
#define MSSMatMGUTEFTHiggs_soft_parameters_H
...
class MSSMatMGUTEFTHiggs_soft_parameters : public MSSMatMGUTEFTHiggs_susy_parameters {
public:
   explicit MSSMatMGUTEFTHiggs_soft_parameters(const MSSMatMGUTEFTHiggs_input_parameters& input_ = MSSMatMGUTEFTHiggs_input_parameters());
   MSSMatMGUTEFTHiggs_soft_parameters(const MSSMatMGUTEFTHiggs_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,3>&
   ...
   MSSMatMGUTEFTHiggs_soft_parameters(const MSSMatMGUTEFTHiggs_soft_parameters&) = default;
   MSSMatMGUTEFTHiggs_soft_parameters(MSSMatMGUTEFTHiggs_soft_parameters&&) = default;
   virtual ~MSSMatMGUTEFTHiggs_soft_parameters() = default;
   MSSMatMGUTEFTHiggs_soft_parameters& operator=(const MSSMatMGUTEFTHiggs_soft_parameters&) = default;
   MSSMatMGUTEFTHiggs_soft_parameters& operator=(MSSMatMGUTEFTHiggs_soft_parameters&&) = default;
   ...
   MSSMatMGUTEFTHiggs_soft_parameters calc_beta() const;
   MSSMatMGUTEFTHiggs_soft_parameters calc_beta(int) const;
...
std::ostream& operator<<(std::ostream&, const MSSMatMGUTEFTHiggs_soft_parameters&);
