...
#ifndef MSSMatMGUTEFTHiggs_INPUT_PARAMETERS_H
#define MSSMatMGUTEFTHiggs_INPUT_PARAMETERS_H
...
std::ostream& operator<<(std::ostream&, const MSSMatMGUTEFTHiggs_input_parameters&);
