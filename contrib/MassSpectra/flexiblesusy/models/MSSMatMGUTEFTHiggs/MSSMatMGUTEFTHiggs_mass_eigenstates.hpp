...
/**
 * @file MSSMatMGUTEFTHiggs_mass_eigenstates.hpp
 *
...
#ifndef MSSMatMGUTEFTHiggs_MASS_EIGENSTATES_H
#define MSSMatMGUTEFTHiggs_MASS_EIGENSTATES_H
...
class MSSMatMGUTEFTHiggs_ewsb_solver_interface;
/**
 * @class MSSMatMGUTEFTHiggs_mass_eigenstates
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
class MSSMatMGUTEFTHiggs_mass_eigenstates : public MSSMatMGUTEFTHiggs_soft_parameters {
public:
   explicit MSSMatMGUTEFTHiggs_mass_eigenstates(const MSSMatMGUTEFTHiggs_input_parameters& input_ = MSSMatMGUTEFTHiggs_input_parameters());
   MSSMatMGUTEFTHiggs_mass_eigenstates(const MSSMatMGUTEFTHiggs_mass_eigenstates&) = default;
   MSSMatMGUTEFTHiggs_mass_eigenstates(MSSMatMGUTEFTHiggs_mass_eigenstates&&) = default;
   virtual ~MSSMatMGUTEFTHiggs_mass_eigenstates() = default;
   MSSMatMGUTEFTHiggs_mass_eigenstates& operator=(const MSSMatMGUTEFTHiggs_mass_eigenstates&) = default;
   MSSMatMGUTEFTHiggs_mass_eigenstates& operator=(MSSMatMGUTEFTHiggs_mass_eigenstates&&) = default;
   ...
   void set_physical(const MSSMatMGUTEFTHiggs_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const MSSMatMGUTEFTHiggs_physical& get_physical() const;
   MSSMatMGUTEFTHiggs_physical& get_physical();
   const Problems& get_problems() const;
   Problems& get_problems();
   void set_ewsb_solver(const std::shared_ptr<MSSMatMGUTEFTHiggs_ewsb_solver_interface>&);
   ...
   double get_lsp(MSSMatMGUTEFTHiggs_info::Particles&) const;
...
private:
   ...
   MSSMatMGUTEFTHiggs_physical physical{}; ///< contains the pole masses and mixings
   Problems problems{MSSMatMGUTEFTHiggs_info::model_name,
                     &MSSMatMGUTEFTHiggs_info::particle_names_getter,
                     &MSSMatMGUTEFTHiggs_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<MSSMatMGUTEFTHiggs_ewsb_solver_interface> ewsb_solver{};
...
std::ostream& operator<<(std::ostream&, const MSSMatMGUTEFTHiggs_mass_eigenstates&);
