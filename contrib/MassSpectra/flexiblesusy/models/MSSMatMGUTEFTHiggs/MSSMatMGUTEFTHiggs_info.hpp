...
#ifndef MSSMatMGUTEFTHiggs_INFO_H
#define MSSMatMGUTEFTHiggs_INFO_H
...
namespace MSSMatMGUTEFTHiggs_info {
   ...
   class MSSMatMGUTEFTHiggs_particle_names : public Names {
   public:
      virtual ~MSSMatMGUTEFTHiggs_particle_names() = default;
   ...
   class MSSMatMGUTEFTHiggs_parameter_names : public Names {
   public:
      virtual ~MSSMatMGUTEFTHiggs_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSMatMGUTEFTHiggs_particle_names  particle_names_getter{};
   const MSSMatMGUTEFTHiggs_parameter_names parameter_names_getter{};
