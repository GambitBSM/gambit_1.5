...
#ifndef MSSMatMGUTEFTHiggs_EFFECTIVE_COUPLINGS_H
#define MSSMatMGUTEFTHiggs_EFFECTIVE_COUPLINGS_H
...
class MSSMatMGUTEFTHiggs_effective_couplings {
public:
   MSSMatMGUTEFTHiggs_effective_couplings(const MSSMatMGUTEFTHiggs_mass_eigenstates&,
   ...
   void set_model(const MSSMatMGUTEFTHiggs_mass_eigenstates& model_);
