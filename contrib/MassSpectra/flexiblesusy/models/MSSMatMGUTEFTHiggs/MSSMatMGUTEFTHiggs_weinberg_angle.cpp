...
// File generated at Thu 10 May 2018 14:36:16
...
#define CLASSNAME MSSMatMGUTEFTHiggs_weinberg_angle
 ...
 */
CLASSNAME::MSSMatMGUTEFTHiggs_weinberg_angle(
...
void CLASSNAME::set_model(const MSSMatMGUTEFTHiggs_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * MSSMatMGUTEFTHiggs_info::normalization_g1;
   const double g2 = MODEL->get_g2() * MSSMatMGUTEFTHiggs_info::normalization_g2;
