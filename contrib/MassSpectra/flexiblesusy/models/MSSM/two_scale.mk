...
MSSM_INCLUDE_MK += $(DIR)/two_scale.mk

LIBMSSM_SRC += \
		$(DIR)/MSSM_two_scale_convergence_tester.cpp \
		$(DIR)/MSSM_two_scale_ewsb_solver.cpp \
...
LIBMSSM_HDR += \
		...
		$(DIR)/MSSM_two_scale_spectrum_generator.hpp \
