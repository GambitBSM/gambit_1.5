 ...
 */
double NSM_soft_parameters::calc_beta_vS_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NSM_soft_parameters::calc_beta_vS_2_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double NSM_soft_parameters::calc_beta_vS_3_loop(const Soft_traces& soft_traces) const
{
