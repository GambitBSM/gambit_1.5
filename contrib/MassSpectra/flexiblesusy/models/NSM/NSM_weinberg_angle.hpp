...
#ifndef NSM_WEINBERG_ANGLE_H
#define NSM_WEINBERG_ANGLE_H
...
public:
   ...
   NSM_weinberg_angle(const NSM_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const NSM_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const NSM_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
