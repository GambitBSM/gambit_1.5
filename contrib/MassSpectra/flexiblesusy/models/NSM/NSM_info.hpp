...
namespace NSM_info {
   enum Particles : int { VG, Hp, Fv, Ah, Fd, Fu, Fe, hh, VWp, VP, VZ,
      NUMBER_OF_PARTICLES };

   enum Masses : int { MVG, MHp, MFv_1, MFv_2, MFv_3, MAh, MFd_1, MFd_2, MFd_3,
      MFu_1, MFu_2, MFu_3, MFe_1, MFe_2, MFe_3, Mhh_1, Mhh_2, MVWp, MVP, MVZ,
      NUMBER_OF_MASSES };

   enum Parameters : int { g1, g2, g3, Lambda2, Lambda3, Lambda1, Yu0_0, Yu0_1,
      Yu0_2, Yu1_0, Yu1_1, Yu1_2, Yu2_0, Yu2_1, Yu2_2, Yd0_0, Yd0_1, Yd0_2, Yd1_0
      , Yd1_1, Yd1_2, Yd2_0, Yd2_1, Yd2_2, Ye0_0, Ye0_1, Ye0_2, Ye1_0, Ye1_1,
      Ye1_2, Ye2_0, Ye2_1, Ye2_2, Lambda5, Lambda4, mS2, mH2, vH, vS,
   ...
   enum Mixings : int { ReVd0_0, ImVd0_0, ReVd0_1, ImVd0_1, ReVd0_2, ImVd0_2,
      ...
      ReUe2_0, ImUe2_0, ReUe2_1, ImUe2_1, ReUe2_2, ImUe2_2, ZH0_0, ZH0_1, ZH1_0,
      ZH1_1, ZZ0_0, ZZ0_1, ZZ1_0, ZZ1_1, NUMBER_OF_MIXINGS };

   enum Input_parameters : int { Lambda1Input, Lambda2Input, Lambda3Input,
      Lambda4Input, Lambda5Input, vSInput, Qin, NUMBER_OF_INPUT_PARAMETERS };
   ...
   class NSM_particle_names : public Names {
   public:
      virtual ~NSM_particle_names() = default;
   ...
   class NSM_parameter_names : public Names {
   public:
      virtual ~NSM_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const NSM_particle_names  particle_names_getter{};
   const NSM_parameter_names parameter_names_getter{};
