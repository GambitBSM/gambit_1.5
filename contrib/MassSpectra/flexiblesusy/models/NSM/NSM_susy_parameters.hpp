...
// File generated at Sun 24 Sep 2017 15:56:05

#ifndef NSM_susy_parameters_H
#define NSM_susy_parameters_H
...
public:
   ...
   NSM_susy_parameters(double scale_, int loops_, int thresholds_, const NSM_input_parameters& input_, double g1_, double g2_, double g3_, double Lambda2_, double Lambda3_,
   double Lambda1_, const Eigen::Matrix<double,3,3>& Yu_, const Eigen::Matrix<
   double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
);
   NSM_susy_parameters(const NSM_susy_parameters&) = default;
   NSM_susy_parameters(NSM_susy_parameters&&) = default;
   virtual ~NSM_susy_parameters() = default;
   NSM_susy_parameters& operator=(const NSM_susy_parameters&) = default;
   NSM_susy_parameters& operator=(NSM_susy_parameters&&) = default;
   ...
   NSM_susy_parameters calc_beta(int) const;
   virtual void clear();
