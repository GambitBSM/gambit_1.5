...
namespace NSM_info {
   ...
   const std::array<std::string, NUMBER_OF_PARTICLES> particle_names = {"VG",
      "Hp", "Fv", "Ah", "Fd", "Fu", "Fe", "hh", "VWp", "VP", "VZ"};
   ...
   const std::array<std::string, NUMBER_OF_PARAMETERS> parameter_names = {"g1",
      "g2", "g3", "Lambda2", "Lambda3", "Lambda1", "Yu(0,0)", "Yu(0,1)",
      ...
      "Ye(1,1)", "Ye(1,2)", "Ye(2,0)", "Ye(2,1)", "Ye(2,2)", "Lambda5", "Lambda4",
      "mS2", "mH2", "vH", "vS"};
   ...
   const std::array<std::string, NUMBER_OF_MIXINGS> particle_mixing_names = {
      ...
      "Im(Ue(2,1))", "Re(Ue(2,2))", "Im(Ue(2,2))", "ZH(0,0)", "ZH(0,1)", "ZH(1,0)"
      , "ZH(1,1)", "ZZ(0,0)", "ZZ(0,1)", "ZZ(1,0)", "ZZ(1,1)"};

   const std::array<std::string, NUMBER_OF_INPUT_PARAMETERS>
      input_parameter_names = {"Lambda1Input", "Lambda2Input", "Lambda3Input",
      "Lambda4Input", "Lambda5Input", "vSInput", "Qin"};

   const std::array<std::string, NUMBER_OF_EXTRA_PARAMETERS>
      extra_parameter_names = {};

   const std::string model_name = "NSM";
