...
private:
   ...
   std::array<std::string, NSM_info::NUMBER_OF_MIXINGS> get_mixing_names() const {
      return NSM_info::particle_mixing_names;
   }
...
public:
   ...
   std::array<std::string, NSM_info::NUMBER_OF_PARAMETERS> get_parameter_names() const {
      return NSM_info::parameter_names;
   }

   /// returns names of particles
   std::array<std::string, NSM_info::NUMBER_OF_PARTICLES> get_particle_names() const {
      return NSM_info::particle_names;
   }
   ...
   std::array<std::string, NSM_info::NUMBER_OF_MIXINGS> get_DRbar_mixing_names() const {
      return get_mixing_names();
   }

   /// returns names of pole mixing matrices
   std::array<std::string, NSM_info::NUMBER_OF_MIXINGS> get_pole_mixing_names() const {
   ...
   std::array<std::string, NSM_info::NUMBER_OF_INPUT_PARAMETERS> get_input_parameter_names() const {
      return NSM_info::input_parameter_names;
   }

   /// returns names of input parameters
   std::array<std::string, NSM_info::NUMBER_OF_EXTRA_PARAMETERS> get_extra_parameter_names() const {
      return NSM_info::extra_parameter_names;
   }

   /// returns number of particle masses
   decltype(NSM_info::NUMBER_OF_MASSES) get_number_of_masses() const {
      return NSM_info::NUMBER_OF_MASSES;
   }
};
...
NSM_mass_eigenstates from_database(
   ...
   NSM_observables* observables = nullptr);
