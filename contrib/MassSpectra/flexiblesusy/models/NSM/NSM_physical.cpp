...
Eigen::ArrayXd NSM_physical::get() const
{
...
void NSM_physical::set(const Eigen::ArrayXd& pars)
{
   set_masses(pars);
...
Eigen::ArrayXd NSM_physical::get_masses() const
{
...
void NSM_physical::set_masses(const Eigen::ArrayXd& pars)
{
   MVG = pars(0);
   MHp = pars(1);
   MFv(0) = pars(2);
