...
/**
 * @file NSM_two_scale_ewsb_solver.hpp
 *
...
#ifndef NSM_TWO_SCALE_EWSB_SOLVER_H
#define NSM_TWO_SCALE_EWSB_SOLVER_H

#include "NSM_ewsb_solver.hpp"
...
template<>
class NSM_ewsb_solver<Two_scale> : public NSM_ewsb_solver_interface {
public:
   NSM_ewsb_solver() = default;
   NSM_ewsb_solver(const NSM_ewsb_solver&) = default;
   NSM_ewsb_solver(NSM_ewsb_solver&&) = default;
   virtual ~NSM_ewsb_solver() {}
   NSM_ewsb_solver& operator=(const NSM_ewsb_solver&) = default;
   NSM_ewsb_solver& operator=(NSM_ewsb_solver&&) = default;
   ...
   virtual int solve(NSM_mass_eigenstates&) override;
private:
   ...
   void set_ewsb_solution(NSM_mass_eigenstates&, const EWSB_solver*);
   template <typename It> void set_best_ewsb_solution(NSM_mass_eigenstates&, It, It);

   int solve_tree_level(NSM_mass_eigenstates&);
   int solve_iteratively(NSM_mass_eigenstates&);
   int solve_iteratively_at(NSM_mass_eigenstates&, int);
   int solve_iteratively_with(NSM_mass_eigenstates&, EWSB_solver*, const EWSB_vector_t&);

   EWSB_vector_t initial_guess(const NSM_mass_eigenstates&) const;
   EWSB_vector_t tadpole_equations(const NSM_mass_eigenstates&) const;
   EWSB_vector_t ewsb_step(const NSM_mass_eigenstates&) const;
};
