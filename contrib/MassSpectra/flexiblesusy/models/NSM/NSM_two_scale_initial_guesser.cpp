...
{
   if (!model)
      throw SetupError("NSM_initial_guesser: Error: pointer to model"
                       " NSM<Two_scale> must not be zero");
}
 ...
 */
void NSM_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void NSM_initial_guesser<Two_scale>::guess_susy_parameters()
{
...
void NSM_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 */
void NSM_initial_guesser<Two_scale>::guess_soft_parameters()
{
