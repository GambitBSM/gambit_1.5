...
#ifndef NSM_MASS_EIGENSTATES_H
#define NSM_MASS_EIGENSTATES_H
...
class NSM_ewsb_solver_interface;
/**
...
public:
   ...
   NSM_mass_eigenstates(const NSM_mass_eigenstates&) = default;
   NSM_mass_eigenstates(NSM_mass_eigenstates&&) = default;
   virtual ~NSM_mass_eigenstates() = default;
   NSM_mass_eigenstates& operator=(const NSM_mass_eigenstates&) = default;
   NSM_mass_eigenstates& operator=(NSM_mass_eigenstates&&) = default;
   ...
   void set_ewsb_solver(const std::shared_ptr<NSM_ewsb_solver_interface>&);
...
private:
   ...
   Problems problems{NSM_info::model_name,
                     &NSM_info::particle_names_getter,
                     &NSM_info::parameter_names_getter}; ///< problems
   Loop_corrections loop_corrections{}; ///< used pole mass corrections
   std::shared_ptr<NSM_ewsb_solver_interface> ewsb_solver{};
