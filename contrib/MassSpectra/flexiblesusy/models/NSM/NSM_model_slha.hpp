...
class NSM_slha : public Model {
public:
   explicit NSM_slha(const NSM_input_parameters& input_ = NSM_input_parameters());
   explicit NSM_slha(const Model&, bool do_convert_masses_to_slha = true);
   NSM_slha(const NSM_slha&) = default;
   NSM_slha(NSM_slha&&) = default;
   virtual ~NSM_slha() = default;
   NSM_slha& operator=(const NSM_slha&) = default;
   NSM_slha& operator=(NSM_slha&&) = default;
   ...
   const NSM_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   NSM_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   NSM_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
NSM_slha<Model>::NSM_slha(const NSM_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
NSM_slha<Model>::NSM_slha(const Model& model_,
...
template <class Model>
void NSM_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void NSM_slha<Model>::convert_to_slha()
{
...
template <class Model>
void NSM_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void NSM_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void NSM_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void NSM_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void NSM_slha<Model>::convert_soft_squared_masses_to_slha()
{

}

template <class Model>
const NSM_physical& NSM_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
NSM_physical& NSM_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void NSM_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void NSM_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const NSM_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
