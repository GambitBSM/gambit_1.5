...
#define CLASSNAME NSM_weinberg_angle
 ...
 */
CLASSNAME::NSM_weinberg_angle(
   const NSM_mass_eigenstates* model_,
...
void CLASSNAME::set_model(const NSM_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * NSM_info::normalization_g1;
   const double g2 = MODEL->get_g2() * NSM_info::normalization_g2;
   ...
   if (number_of_loops > 1) {
      ...
      deltaRhoHat2LoopSM = (0.000010025373295590172*((64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)
         *(-2.24 + 1.262*Log(MT/MZ) - (2.145*Sqr(MT))/Sqr(MW) - (0.85*Sqr(MZ))/Sqr(MT
         )))/((Sqr(g1) + Sqr(g2))*Sqr(SINTHETAW)) - 3*Sqr(GFERMI)*Sqr(MT)*Sqr(vH)*(
         RHO2(Mhh(0)/MT)*Sqr(Abs(Conj(ZH(0,0))*(SUM(j2,0,2,Conj(Vu(2,j2))*SUM(j1,0,2,
         Conj(Uu(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Uu(2,j1))
         *Vu(2,j2))))) - RHO2(Mhh(0)/MT)*Sqr(Abs(Conj(ZH(0,0))*(SUM(j2,0,2,Conj(Vu(2,
         j2))*SUM(j1,0,2,Conj(Uu(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(
         j1,j2))*Uu(2,j1))*Vu(2,j2))))) + RHO2(Mhh(1)/MT)*(Sqr(Abs(Conj(ZH(1,0))*(SUM
         (j2,0,2,Conj(Vu(2,j2))*SUM(j1,0,2,Conj(Uu(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,
         SUM(j1,0,2,Conj(Yu(j1,j2))*Uu(2,j1))*Vu(2,j2))))) - Sqr(Abs(Conj(ZH(1,0))*(
         SUM(j2,0,2,Conj(Vu(2,j2))*SUM(j1,0,2,Conj(Uu(2,j1))*Yu(j1,j2))) + SUM(j2,0,2
         ,SUM(j1,0,2,Conj(Yu(j1,j2))*Uu(2,j1))*Vu(2,j2)))))))))/(1 + PIZZTMZ/Sqr(MZ))
         ;
   }
...
double CLASSNAME::calculate_delta_r_hat(double rhohat_ratio, double sinThetaW) const
{
   ...
   if (number_of_loops > 1) {
      ...
      deltaRHat2LoopSM = 0.000010025373295590172*((-64*ALPHAS*Pi*Sqr(g1)*Sqr(g2)*(
         ...
         DELTARHAT1LOOP)*RHOHATRATIO*Sqr(GFERMI)*Sqr(MT)*Sqr(vH)*(RHO2(Mhh(0)/MT)*Sqr
         (Abs(Conj(ZH(0,0))*(SUM(j2,0,2,Conj(Vu(2,j2))*SUM(j1,0,2,Conj(Uu(2,j1))*Yu(
         j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Uu(2,j1))*Vu(2,j2))))) -
         RHO2(Mhh(0)/MT)*Sqr(Abs(Conj(ZH(0,0))*(SUM(j2,0,2,Conj(Vu(2,j2))*SUM(j1,0,2,
         Conj(Uu(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(j1,j2))*Uu(2,j1))
         *Vu(2,j2))))) + RHO2(Mhh(1)/MT)*(Sqr(Abs(Conj(ZH(1,0))*(SUM(j2,0,2,Conj(Vu(2
         ,j2))*SUM(j1,0,2,Conj(Uu(2,j1))*Yu(j1,j2))) - SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(
         j1,j2))*Uu(2,j1))*Vu(2,j2))))) - Sqr(Abs(Conj(ZH(1,0))*(SUM(j2,0,2,Conj(Vu(2
         ,j2))*SUM(j1,0,2,Conj(Uu(2,j1))*Yu(j1,j2))) + SUM(j2,0,2,SUM(j1,0,2,Conj(Yu(
         j1,j2))*Uu(2,j1))*Vu(2,j2))))))));
   }
