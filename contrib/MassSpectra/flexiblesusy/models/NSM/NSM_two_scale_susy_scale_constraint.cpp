...
void NSM_susy_scale_constraint<Two_scale>::set_model(Model* model_)
{
   model = cast_model<NSM<Two_scale>*>(model_);
}

void NSM_susy_scale_constraint<Two_scale>::set_sm_parameters(
   const softsusy::QedQcd& qedqcd_)
{
   qedqcd = qedqcd_;
}

const softsusy::QedQcd& NSM_susy_scale_constraint<Two_scale>::get_sm_parameters() const
{
   return qedqcd;
}
...
void NSM_susy_scale_constraint<Two_scale>::check_model_ptr() const
{
   if (!model)
      throw SetupError("NSM_susy_scale_constraint<Two_scale>: "
