...
NSM_INCLUDE_MK += $(DIR)/two_scale.mk

LIBNSM_SRC += \
		$(DIR)/NSM_two_scale_convergence_tester.cpp \
		$(DIR)/NSM_two_scale_ewsb_solver.cpp \
...
LIBNSM_HDR += \
		...
		$(DIR)/NSM_two_scale_spectrum_generator.hpp \
