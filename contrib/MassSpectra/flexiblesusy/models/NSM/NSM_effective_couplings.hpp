...
#ifndef NSM_EFFECTIVE_COUPLINGS_H
#define NSM_EFFECTIVE_COUPLINGS_H
...
class NSM_effective_couplings {
public:
   NSM_effective_couplings(const NSM_mass_eigenstates&,
   ...
   void set_model(const NSM_mass_eigenstates& model_);
