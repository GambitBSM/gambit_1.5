...
NSM_convergence_tester<Two_scale>::NSM_convergence_tester(
   NSM<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<NSM<Two_scale> >(model, accuracy_goal, sg)
{
}
...
double NSM_convergence_tester<Two_scale>::max_rel_diff() const
{
   ...
   const NSM<Two_scale>& ne = get_current_iteration_model();
