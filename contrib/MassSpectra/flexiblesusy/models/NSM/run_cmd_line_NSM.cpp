...
{
   std::cout <<
      "Usage: run_cmd_line_NSM.x [options]\n"
      "Options:\n"
      "  --Lambda1Input=<value>\n"
      "  --Lambda2Input=<value>\n"
      "  --Lambda3Input=<value>\n"
...
int run_solver(const NSM_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(NSM_slha_io::fill_slhaea(
...
int run(int solver_type, const NSM_input_parameters& input)
{
   int exit_code = 0;
