...
/**
 * @file NSM_cxx_diagrams.hpp
 *
 * This file was generated at Sun 24 Sep 2017 15:56:28 with FlexibleSUSY
 * 2.0.0-dev and SARAH 4.11.0 .
 */

#ifndef NSM_CXXDIAGRAMS_H
#define NSM_CXXDIAGRAMS_H
...
*/
struct EvaluationContext {
   NSM_mass_eigenstates& model; ///< The model object.
...
Vertex<VP, Hp, conj<Hp>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> result = 0.5*(g1*Cos(ThetaW) + g2*Sin(ThetaW));
...
Vertex<bar<Fe>::type, hh, Fe>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = 0.7071067811865475*Conj(ZH(gt2,0))*SUM(j2,0,2,Conj(Ve(gt3,j2))*SUM(j1,0,2,Conj(Ue(gt1,j1))*Ye(j1,j2)));

   const std::complex<double> right = 0.7071067811865475*Conj(ZH(gt2,0))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Ue(gt3,j1))*Ve(gt1,j2));
...
Vertex<Fe, hh, bar<Fe>::type>::evaluate(const indices_type& indices, const EvaluationContext& context)
{
   ...
   const std::complex<double> left = 0.7071067811865475*Conj(ZH(gt2,0))*SUM(j2,0,2,Conj(Ve(gt1,j2))*SUM(j1,0,2,Conj(Ue(gt3,j1))*Ye(j1,j2)));

   const std::complex<double> right = 0.7071067811865475*Conj(ZH(gt2,0))*SUM(j2,0,2,SUM(j1,0,2,Conj(Ye(j1,j2))*Ue(gt1,j1))*Ve(gt3,j2));
