 ...
 * @param input struct of input parameters
 */
void NSM_slha_io::set_imminpar(const NSM_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void NSM_slha_io::set_imextpar(const NSM_input_parameters& input)
{
 ...
 */
void NSM_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void NSM_slha_io::set_input(const NSM_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void NSM_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void NSM_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void NSM_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void NSM_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
...
{
   slha_io.set_block("ZH", LOCALPHYSICAL(ZH), "ZH");
 ...
 */
void NSM_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void NSM_slha_io::fill_imminpar_tuple(NSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void NSM_slha_io::fill_imextpar_tuple(NSM_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
