...
const int NSM_susy_parameters::numberOfParameters;
...
NSM_susy_parameters NSM_susy_parameters::calc_beta(int loops) const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   return NSM_susy_parameters(get_scale(), loops, get_thresholds(), input,
...
NSM_susy_parameters::Susy_traces NSM_susy_parameters::calc_susy_traces(int loops) const
{
