...
// File generated at Fri 9 Jun 2017 16:14:14

/**
 * @file SingletDMZ3_two_scale_model_slha.cpp
 * @brief SingletDMZ3 model class wrapper for SLHA conversion
 */
...
#define CLASSNAME SingletDMZ3_slha<Two_scale>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::SingletDMZ3_slha(const SingletDMZ3_input_parameters& input_)
   : SingletDMZ3<Two_scale>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::SingletDMZ3_slha(const SingletDMZ3<Two_scale>& model_,
...
CLASSNAME::~SingletDMZ3_slha()
{
}

void CLASSNAME::clear()
{
   SingletDMZ3<Two_scale>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   SingletDMZ3<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
...
const SingletDMZ3_physical& CLASSNAME::get_physical_slha() const
{
   return physical_slha;
}

SingletDMZ3_physical& CLASSNAME::get_physical_slha()
{
   return physical_slha;
}
...
{
   SingletDMZ3<Two_scale>::print(ostr);
