 ...
 */
double SingletDMZ3_susy_parameters::calc_beta_g1_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double SingletDMZ3_susy_parameters::calc_beta_g1_two_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double SingletDMZ3_susy_parameters::calc_beta_g1_three_loop(const Susy_traces& susy_traces) const
{
