 ...
 */
Eigen::Matrix<double,3,3> SingletDMZ3_susy_parameters::calc_beta_Yd_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> SingletDMZ3_susy_parameters::calc_beta_Yd_two_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_Yd = (twoLoop*(-0.0016666666666666668*Yd*(127*Power(g1,4) + 5*Sqr
      ...
      g2) - 248*Sqr(g3)) + 75*(46*Power(g2,4) + 864*Power(g3,4) + 54*
      ...
      - 12*Sqr(LamH) - Sqr(LamSH))) + 0.0125*(187*Sqr(g1) + 675*Sqr(g2) + 20*(
      -3*(8*LamH + 9*traceYdAdjYd + 3*traceYeAdjYe + 9*traceYuAdjYu) + 64*Sqr(
      g3)))*(Yd*Yd.adjoint()*Yd) + 0.0125*(-79*Sqr(g1) + 5*(20*(3*traceYdAdjYd
      + traceYeAdjYe + 3*traceYuAdjYu) + 9*Sqr(g2) - 256*Sqr(g3)))*(Yd*
 ...
 */
Eigen::Matrix<double,3,3> SingletDMZ3_susy_parameters::calc_beta_Yd_three_loop(const Susy_traces& susy_traces) const
{
