...
SingletDMZ3_standard_model_initial_guesser<Two_scale>::SingletDMZ3_standard_model_initial_guesser(
   ...
   const SingletDMZ3_susy_scale_constraint<Two_scale>& susy_constraint_,
   const SingletDMZ3_high_scale_constraint<Two_scale>& high_constraint_
)
   : Initial_guesser()
   , model(model_)
   , eft(eft_)
...
{
   if (!model)
      throw SetupError("SingletDMZ3_initial_guesser: Error: pointer to model"
                       " SingletDMZ3<Two_scale> must not be zero");
}
 ...
 */
void SingletDMZ3_standard_model_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void SingletDMZ3_standard_model_initial_guesser<Two_scale>::guess_eft_parameters()
{
...
void SingletDMZ3_standard_model_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void SingletDMZ3_standard_model_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void SingletDMZ3_standard_model_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void SingletDMZ3_standard_model_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 */
void SingletDMZ3_standard_model_initial_guesser<Two_scale>::guess_model_parameters()
{
