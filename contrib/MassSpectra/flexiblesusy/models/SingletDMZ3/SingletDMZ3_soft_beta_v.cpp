...
// File generated at Sat 5 May 2018 00:23:55
 ...
 */
double SingletDMZ3_soft_parameters::calc_beta_v_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double SingletDMZ3_soft_parameters::calc_beta_v_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
   ...
   beta_v = Re(-0.00125*twoLoop*v*(1221*Quad(g1) + 10*Sqr(g1)*(122*
      ...
      80*traceYuAdjYu*Sqr(g3) + 6*Sqr(LamH) + 2*Sqr(LamSH)))));
 ...
 */
double SingletDMZ3_soft_parameters::calc_beta_v_3_loop(const Soft_traces& soft_traces) const
{
