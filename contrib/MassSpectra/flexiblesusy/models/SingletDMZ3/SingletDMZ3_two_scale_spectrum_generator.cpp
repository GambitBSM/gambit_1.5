 ...
 */
void SingletDMZ3_spectrum_generator<Two_scale>::run_except(const softsusy::QedQcd& qedqcd,
                                const SingletDMZ3_input_parameters& input)
{
   ...
   model.set_ewsb_solver(
      std::make_shared<SingletDMZ3_ewsb_solver<Two_scale> >(ewsb_solver));
 ...
 */
void SingletDMZ3_spectrum_generator<Two_scale>::write_running_couplings(
   const std::string& filename) const
{
   SingletDMZ3_spectrum_generator_interface<Two_scale>::write_running_couplings(
