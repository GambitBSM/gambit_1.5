...
// File generated at Fri 9 Jun 2017 16:14:07
...
SingletDMZ3_susy_parameters::SingletDMZ3_susy_parameters(
...
Eigen::ArrayXd SingletDMZ3_susy_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

SingletDMZ3_susy_parameters SingletDMZ3_susy_parameters::calc_beta() const
{
   double beta_g1 = 0.;
   double beta_g2 = 0.;
   double beta_g3 = 0.;
   ...
   if (get_loops() > 0) {
      ...
      beta_LamS += calc_beta_LamS_one_loop(TRACE_STRUCT);
      beta_LamSH += calc_beta_LamSH_one_loop(TRACE_STRUCT);
...
SingletDMZ3_susy_parameters SingletDMZ3_susy_parameters::calc_beta(unsigned loops) const
{
   SingletDMZ3_susy_parameters p(*this);
   p.set_loops(loops);
...
Eigen::ArrayXd SingletDMZ3_susy_parameters::get() const
{
...
void SingletDMZ3_susy_parameters::print(std::ostream& ostr) const
{
...
void SingletDMZ3_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   g1 = pars(0);
   g2 = pars(1);
   g3 = pars(2);
...
const SingletDMZ3_input_parameters& SingletDMZ3_susy_parameters::get_input() const
{
   return input;
}

SingletDMZ3_input_parameters& SingletDMZ3_susy_parameters::get_input()
{
   return input;
}

void SingletDMZ3_susy_parameters::set_input_parameters(const SingletDMZ3_input_parameters& input_)
{
   input = input_;
}

void SingletDMZ3_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
   if (get_loops() > 0) {
...
std::ostream& operator<<(std::ostream& ostr, const SingletDMZ3_susy_parameters& susy_pars)
{
