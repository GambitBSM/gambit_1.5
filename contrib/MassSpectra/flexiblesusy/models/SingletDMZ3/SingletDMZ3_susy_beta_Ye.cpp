 ...
 */
Eigen::Matrix<double,3,3> SingletDMZ3_susy_parameters::calc_beta_Ye_1_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> SingletDMZ3_susy_parameters::calc_beta_Ye_2_loop(const Susy_traces& susy_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
...
<<<<<<< HEAD
      ...
      80*traceYuAdjYu*Sqr(g3) + 6*Sqr(LamH) + 2*Sqr(LamSH)))) + 0.0375*(129*Sqr
...
=======
      ...
      + 3*traceYuAdjYu)*Sqr(g2) - 160*traceYdAdjYd*Sqr(g3) - 160*traceYuAdjYu*
      Sqr(g3) - 12*Sqr(LamH) - Sqr(LamSH))) + 0.0375*(-20*(8*LamH + 9*
 ...
 */
Eigen::Matrix<double,3,3> SingletDMZ3_susy_parameters::calc_beta_Ye_3_loop(const Susy_traces& susy_traces) const
{
