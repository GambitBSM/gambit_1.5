...
// File generated at Wed 25 Oct 2017 18:10:42
...
SingletDMZ3_convergence_tester<Two_scale>::SingletDMZ3_convergence_tester(
   SingletDMZ3<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<SingletDMZ3<Two_scale> >(model, accuracy_goal, sg)
{
}

double SingletDMZ3_convergence_tester<Two_scale>::max_rel_diff() const
{
   const SingletDMZ3<Two_scale>& ol = get_last_iteration_model();
   const SingletDMZ3<Two_scale>& ne = get_current_iteration_model();
