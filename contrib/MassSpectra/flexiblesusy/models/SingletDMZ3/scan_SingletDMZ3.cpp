...
{
   std::cout <<
      "Usage: scan_SingletDMZ3.x [options]\n"
      "Options:\n"
      "  --HiggsIN=<value>\n"
      "  --LamSHInput=<value>\n"
      "  --LamSInput=<value>\n"
...
struct SingletDMZ3_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
SingletDMZ3_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   SingletDMZ3_input_parameters& input)
{
   ...
   SingletDMZ3_scan_result result;
...
void scan(int solver_type, SingletDMZ3_input_parameters& input,
