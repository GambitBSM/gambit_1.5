...
int run_solver(const SingletDMZ3_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(SingletDMZ3_slha_io::fill_slhaea(
...
int run(int solver_type, const SingletDMZ3_input_parameters& input)
{
   int exit_code = 0;
