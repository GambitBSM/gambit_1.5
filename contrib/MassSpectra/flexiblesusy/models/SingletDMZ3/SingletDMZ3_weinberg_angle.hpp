...
/**
 * @class SingletDMZ3_weinberg_angle
...
public:
   ...
   SingletDMZ3_weinberg_angle(const SingletDMZ3_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const SingletDMZ3_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const SingletDMZ3_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
