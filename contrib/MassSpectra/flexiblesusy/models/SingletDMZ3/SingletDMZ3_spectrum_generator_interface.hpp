 ...
 */
template <class T>
void SingletDMZ3_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   SingletDMZ3_mass_eigenstates tmp_model(model);
   try {
   ...
   SingletDMZ3_parameter_getter parameter_getter;
   Coupling_monitor<SingletDMZ3_mass_eigenstates, SingletDMZ3_parameter_getter>
