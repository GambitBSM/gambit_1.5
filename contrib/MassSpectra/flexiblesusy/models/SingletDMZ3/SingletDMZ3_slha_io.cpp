 ...
 * @param input struct of input parameters
 */
void SingletDMZ3_slha_io::set_imminpar(const SingletDMZ3_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void SingletDMZ3_slha_io::set_imextpar(const SingletDMZ3_input_parameters& input)
{
 ...
 */
void SingletDMZ3_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void SingletDMZ3_slha_io::set_input(const SingletDMZ3_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void SingletDMZ3_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void SingletDMZ3_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void SingletDMZ3_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void SingletDMZ3_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void SingletDMZ3_slha_io::set_spinfo(
 ...
 */
void SingletDMZ3_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
...
void SingletDMZ3_slha_io::fill_imminpar_tuple(SingletDMZ3_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void SingletDMZ3_slha_io::fill_imextpar_tuple(SingletDMZ3_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
