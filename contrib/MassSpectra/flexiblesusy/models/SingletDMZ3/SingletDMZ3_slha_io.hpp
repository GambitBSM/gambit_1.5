...
public:
   ...
   template <class Model> void fill(SingletDMZ3_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const SingletDMZ3_slha<Model>&, const SingletDMZ3_scales&, const SingletDMZ3_observables&);
   void set_input(const SingletDMZ3_input_parameters&);
   ...
   template <class Model> void set_spectrum(const SingletDMZ3_slha<Model>&);
   ...
   static void fill_imminpar_tuple(SingletDMZ3_input_parameters&, int, double);
   static void fill_imextpar_tuple(SingletDMZ3_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const SingletDMZ3_slha<Model>&, const softsusy::QedQcd&, const SingletDMZ3_scales&, const SingletDMZ3_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const SingletDMZ3_slha<Model>&, const softsusy::QedQcd&, const SingletDMZ3_scales&, const SingletDMZ3_observables&);
...
private:
   ...
   void set_imminpar(const SingletDMZ3_input_parameters&);
   void set_imextpar(const SingletDMZ3_input_parameters&);
   ...
   template <class Model> void set_model_parameters(const SingletDMZ3_slha<Model>&);
 ...
 */
template <class Model>
void SingletDMZ3_slha_io::fill(SingletDMZ3_slha<Model>& model) const
{
...
void SingletDMZ3_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const SingletDMZ3_slha<Model>& model,
...
SLHAea::Coll SingletDMZ3_slha_io::fill_slhaea(
   const SingletDMZ3_slha<Model>& model, const softsusy::QedQcd& qedqcd,
 ...
 */
template <class Model>
void SingletDMZ3_slha_io::set_model_parameters(const SingletDMZ3_slha<Model>& model)
{
   {
...
void SingletDMZ3_slha_io::set_extra(
   const SingletDMZ3_slha<Model>& model, const SingletDMZ3_scales& scales,
   const SingletDMZ3_observables& observables)
{
 ...
 */
template <class... Ts>
void SingletDMZ3_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<SingletDMZ3_slha_io> ss(this);
...
{
   set_spectrum(SingletDMZ3_slha<SingletDMZ3<T> >(model));
}
 ...
 */
template <class Model>
void SingletDMZ3_slha_io::set_spectrum(const SingletDMZ3_slha<Model>& model)
{
   const SingletDMZ3_physical physical(model.get_physical_slha());
