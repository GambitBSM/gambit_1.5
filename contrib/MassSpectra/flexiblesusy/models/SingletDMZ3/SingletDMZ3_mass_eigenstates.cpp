...
// File generated at Thu 12 Oct 2017 14:02:52
 ...
 * parameters.
 *
 * This file was generated at Thu 12 Oct 2017 14:02:52 with FlexibleSUSY
...
#define CLASSNAME SingletDMZ3_mass_eigenstates
...
CLASSNAME::SingletDMZ3_mass_eigenstates(const SingletDMZ3_input_parameters& input_)
   : SingletDMZ3_soft_parameters(input_)
#if defined(ENABLE_TWO_SCALE_SOLVER)
   , ewsb_solver(new SingletDMZ3_ewsb_solver<Two_scale>())
#endif
{
}
...
const SingletDMZ3_physical& CLASSNAME::get_physical() const
{
   return physical;
}

SingletDMZ3_physical& CLASSNAME::get_physical()
{
   return physical;
}

void CLASSNAME::set_physical(const SingletDMZ3_physical& physical_)
{
   physical = physical_;
}
...
void CLASSNAME::set_ewsb_solver(const std::shared_ptr<SingletDMZ3_ewsb_solver_interface>& solver)
{
   ewsb_solver = solver;
}
...
{
   if (!ewsb_solver) {
      throw SetupError("SingletDMZ3_mass_eigenstates::solve_ewsb_tree_level: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("SingletDMZ3_mass_eigenstates::solve_ewsb_one_loop: "
                       "no EWSB solver set");
   }
...
{
   if (!ewsb_solver) {
      throw SetupError("SingletDMZ3_mass_eigenstates::solve_ewsb: "
                       "no EWSB solver set");
   }

   VERBOSE_MSG("\t\tSolving SingletDMZ3 EWSB at " << ewsb_loop_order << "-loop order");
...
void CLASSNAME::print(std::ostream& ostr) const
{
   ostr << "========================================\n"
           "SingletDMZ3\n"
           "========================================\n";
   SingletDMZ3_soft_parameters::print(ostr);
   ostr << "----------------------------------------\n"
...
{
   if (PHYSICAL(Mss) < 0.) problems.flag_pole_tachyon(SingletDMZ3_info::ss);
   if (PHYSICAL(Mhh) < 0.) problems.flag_pole_tachyon(SingletDMZ3_info::hh);
...
{
   SingletDMZ3_soft_parameters::clear();
   clear_DRbar_parameters();
   physical.clear();
   problems.clear();
}
...
void CLASSNAME::run_to(double scale, double eps)
{
   if (eps < 0.0)
      eps = precision;
   SingletDMZ3_soft_parameters::run_to(scale, eps);
}
...
void CLASSNAME::calculate_MHp()
{
   ...
   if (MHp < 0.) {
      problems.flag_running_tachyon(SingletDMZ3_info::Hp);
   }
...
void CLASSNAME::calculate_Mss()
{
   ...
   if (Mss < 0.) {
      problems.flag_running_tachyon(SingletDMZ3_info::ss);
   }
...
void CLASSNAME::calculate_MAh()
{
   ...
   if (MAh < 0.) {
      problems.flag_running_tachyon(SingletDMZ3_info::Ah);
   }
...
void CLASSNAME::calculate_Mhh()
{
   ...
   if (Mhh < 0.) {
      problems.flag_running_tachyon(SingletDMZ3_info::hh);
   }
...
void CLASSNAME::calculate_MFd()
{
   ...
   problems.flag_bad_mass(SingletDMZ3_info::Fd, eigenvalue_error >
      precision * Abs(MFd(0)));
#else
...
void CLASSNAME::calculate_MFu()
{
   ...
   problems.flag_bad_mass(SingletDMZ3_info::Fu, eigenvalue_error >
      precision * Abs(MFu(0)));
#else
...
void CLASSNAME::calculate_MFe()
{
   ...
   problems.flag_bad_mass(SingletDMZ3_info::Fe, eigenvalue_error >
      precision * Abs(MFe(0)));
#else
...
void CLASSNAME::calculate_MVWp()
{
   ...
   if (MVWp < 0.) {
      problems.flag_running_tachyon(SingletDMZ3_info::VWp);
   }
...
void CLASSNAME::calculate_MVG_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDMZ3_info::VG);
   else
      problems.unflag_no_pole_mass_convergence(SingletDMZ3_info::VG);
}

void CLASSNAME::calculate_Mss_pole()
{
   if (!force_output && problems.is_running_tachyon(SingletDMZ3_info::ss)
      )
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDMZ3_info::ss);
   else
      problems.unflag_no_pole_mass_convergence(SingletDMZ3_info::ss);
}
...
void CLASSNAME::calculate_MFv_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDMZ3_info::Fv);
   else
      problems.unflag_no_pole_mass_convergence(SingletDMZ3_info::Fv);
}

void CLASSNAME::calculate_Mhh_pole()
{
   if (!force_output && problems.is_running_tachyon(SingletDMZ3_info::hh)
      )
      return;
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDMZ3_info::hh);
   else
      problems.unflag_no_pole_mass_convergence(SingletDMZ3_info::hh);
}
...
void CLASSNAME::calculate_MVP_pole()
{
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDMZ3_info::VP);
   else
      problems.unflag_no_pole_mass_convergence(SingletDMZ3_info::VP);
}

void CLASSNAME::calculate_MVZ_pole()
{
   if (!force_output && problems.is_running_tachyon(SingletDMZ3_info::VZ)
      )
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(SingletDMZ3_info::VZ);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDMZ3_info::VZ);
   else
      problems.unflag_no_pole_mass_convergence(SingletDMZ3_info::VZ);
}
...
void CLASSNAME::calculate_MFd_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_Vd, mix_Ud,
            eigenvalue_error);
         problems.flag_bad_mass(SingletDMZ3_info::Fd,
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDMZ3_info::Fd);
   else
      problems.unflag_no_pole_mass_convergence(SingletDMZ3_info::Fd);
}
...
void CLASSNAME::calculate_MFu_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_Vu, mix_Uu,
            eigenvalue_error);
         problems.flag_bad_mass(SingletDMZ3_info::Fu,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_Vu, mix_Uu);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDMZ3_info::Fu);
   else
      problems.unflag_no_pole_mass_convergence(SingletDMZ3_info::Fu);
}
...
void CLASSNAME::calculate_MFe_pole()
{
   ...
   do {
      ...
      for (int es = 0; es < 3; ++es) {
         ...
         fs_svd(M_loop, eigen_values, mix_Ve, mix_Ue,
            eigenvalue_error);
         problems.flag_bad_mass(SingletDMZ3_info::Fe,
            eigenvalue_error > precision * Abs(eigen_values(0)));
      #else
         fs_svd(M_loop, eigen_values, mix_Ve, mix_Ue);
      #endif
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDMZ3_info::Fe);
   else
      problems.unflag_no_pole_mass_convergence(SingletDMZ3_info::Fe);
}

void CLASSNAME::calculate_MVWp_pole()
{
   if (!force_output && problems.is_running_tachyon(SingletDMZ3_info::VWp
      ))
      return;
   ...
   do {
      ...
      if (mass_sqr < 0.)
         problems.flag_pole_tachyon(SingletDMZ3_info::VWp);
   ...
   if (diff > precision)
      problems.flag_no_pole_mass_convergence(SingletDMZ3_info::VWp);
   else
      problems.unflag_no_pole_mass_convergence(SingletDMZ3_info::VWp);
}
...
std::ostream& operator<<(std::ostream& ostr, const SingletDMZ3_mass_eigenstates& model)
{
   model.print(ostr);
   return ostr;
}
