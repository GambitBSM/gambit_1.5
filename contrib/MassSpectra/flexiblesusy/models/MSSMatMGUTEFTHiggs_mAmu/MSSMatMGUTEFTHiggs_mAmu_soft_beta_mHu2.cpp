 ...
 */
double MSSMatMGUTEFTHiggs_mAmu_soft_parameters::calc_beta_mHu2_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double MSSMatMGUTEFTHiggs_mAmu_soft_parameters::calc_beta_mHu2_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
 ...
 */
double MSSMatMGUTEFTHiggs_mAmu_soft_parameters::calc_beta_mHu2_3_loop(const Soft_traces& soft_traces) const
{
