...
#ifndef MSSMatMGUTEFTHiggs_mAmu_WEINBERG_ANGLE_H
#define MSSMatMGUTEFTHiggs_mAmu_WEINBERG_ANGLE_H
...
/**
 * @class MSSMatMGUTEFTHiggs_mAmu_weinberg_angle
...
public:
   ...
   MSSMatMGUTEFTHiggs_mAmu_weinberg_angle(const MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
