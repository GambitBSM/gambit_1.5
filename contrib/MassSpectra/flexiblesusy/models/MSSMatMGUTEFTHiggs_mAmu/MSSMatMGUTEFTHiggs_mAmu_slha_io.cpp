...
MSSMatMGUTEFTHiggs_mAmu_slha_io::MSSMatMGUTEFTHiggs_mAmu_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void MSSMatMGUTEFTHiggs_mAmu_slha_io::clear()
{
   slha_io.clear();
}

void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_extpar(const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_imminpar(const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_imextpar(const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input)
{
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_minpar(const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_input(const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, MSSMatMGUTEFTHiggs_mAmu_info::model_name)
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_mass(const MSSMatMGUTEFTHiggs_mAmu_physical& physical,
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_mixing_matrices(const MSSMatMGUTEFTHiggs_mAmu_physical& physical,
...
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_ckm(
...
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_pmns(
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double MSSMatMGUTEFTHiggs_mAmu_slha_io::get_parameter_output_scale() const
{
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::fill(MSSMatMGUTEFTHiggs_mAmu_input_parameters& input) const
{
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::fill_drbar_parameters(MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::fill(MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   MSSMatMGUTEFTHiggs_mAmu_physical physical_hk;
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void MSSMatMGUTEFTHiggs_mAmu_slha_io::fill_minpar_tuple(MSSMatMGUTEFTHiggs_mAmu_input_parameters& input,
...
void MSSMatMGUTEFTHiggs_mAmu_slha_io::fill_extpar_tuple(MSSMatMGUTEFTHiggs_mAmu_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMatMGUTEFTHiggs_mAmu_slha_io::fill_imminpar_tuple(MSSMatMGUTEFTHiggs_mAmu_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMatMGUTEFTHiggs_mAmu_slha_io::fill_imextpar_tuple(MSSMatMGUTEFTHiggs_mAmu_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_slha_io::fill_physical(MSSMatMGUTEFTHiggs_mAmu_physical& physical) const
{
   {
 ...
 */
double MSSMatMGUTEFTHiggs_mAmu_slha_io::read_scale() const
{
