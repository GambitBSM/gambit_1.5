...
MSSMatMGUTEFTHiggs_mAmu_convergence_tester<Two_scale>::MSSMatMGUTEFTHiggs_mAmu_convergence_tester(
   MSSMatMGUTEFTHiggs_mAmu<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<MSSMatMGUTEFTHiggs_mAmu<Two_scale> >(model, accuracy_goal, sg)
{
}

double MSSMatMGUTEFTHiggs_mAmu_convergence_tester<Two_scale>::max_rel_diff() const
{
   const MSSMatMGUTEFTHiggs_mAmu<Two_scale>& ol = get_last_iteration_model();
   const MSSMatMGUTEFTHiggs_mAmu<Two_scale>& ne = get_current_iteration_model();
