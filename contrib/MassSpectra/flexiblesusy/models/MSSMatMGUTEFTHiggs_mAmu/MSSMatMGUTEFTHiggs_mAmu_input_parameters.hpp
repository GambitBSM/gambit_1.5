...
#ifndef MSSMatMGUTEFTHiggs_mAmu_INPUT_PARAMETERS_H
#define MSSMatMGUTEFTHiggs_mAmu_INPUT_PARAMETERS_H
...
std::ostream& operator<<(std::ostream&, const MSSMatMGUTEFTHiggs_mAmu_input_parameters&);
