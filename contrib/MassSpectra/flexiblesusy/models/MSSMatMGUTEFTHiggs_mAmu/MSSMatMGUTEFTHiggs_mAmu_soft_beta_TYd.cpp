 ...
 */
Eigen::Matrix<double,3,3> MSSMatMGUTEFTHiggs_mAmu_soft_parameters::calc_beta_TYd_1_loop(const Soft_traces& soft_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> MSSMatMGUTEFTHiggs_mAmu_soft_parameters::calc_beta_TYd_2_loop(const Soft_traces& soft_traces) const
{
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
   const double traceYeAdjYe = TRACE_STRUCT.traceYeAdjYe;
   const double traceAdjYdTYd = TRACE_STRUCT.traceAdjYdTYd;
 ...
 */
Eigen::Matrix<double,3,3> MSSMatMGUTEFTHiggs_mAmu_soft_parameters::calc_beta_TYd_3_loop(const Soft_traces& soft_traces) const
{
