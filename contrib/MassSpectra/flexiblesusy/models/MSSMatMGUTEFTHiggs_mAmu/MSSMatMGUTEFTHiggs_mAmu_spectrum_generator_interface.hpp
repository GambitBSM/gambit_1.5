...
// File generated at Thu 10 May 2018 14:34:51

#ifndef MSSMatMGUTEFTHiggs_mAmu_SPECTRUM_GENERATOR_INTERFACE_H
#define MSSMatMGUTEFTHiggs_mAmu_SPECTRUM_GENERATOR_INTERFACE_H
...
template <class T>
class MSSMatMGUTEFTHiggs_mAmu_spectrum_generator_interface {
public:
   virtual ~MSSMatMGUTEFTHiggs_mAmu_spectrum_generator_interface() = default;

   std::tuple<MSSMatMGUTEFTHiggs_mAmu<T>, standard_model::StandardModel<T>> get_models() const
   { return std::make_tuple(model, eft); }
   std::tuple<MSSMatMGUTEFTHiggs_mAmu_slha<MSSMatMGUTEFTHiggs_mAmu<T>>, standard_model::StandardModel<T>> get_models_slha() const
   { return std::make_tuple(MSSMatMGUTEFTHiggs_mAmu_slha<MSSMatMGUTEFTHiggs_mAmu<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.), eft); }

   MSSMatMGUTEFTHiggs_mAmu<T> get_model() const
   { return model; }
   MSSMatMGUTEFTHiggs_mAmu_slha<MSSMatMGUTEFTHiggs_mAmu<T>> get_model_slha() const
   { return MSSMatMGUTEFTHiggs_mAmu_slha<MSSMatMGUTEFTHiggs_mAmu<T>>(model, settings.get(Spectrum_generator_settings::force_positive_masses) == 0.); }
   ...
   void run(const softsusy::QedQcd&, const MSSMatMGUTEFTHiggs_mAmu_input_parameters&);
   void write_running_couplings(const std::string& filename, double, double) const;
   void write_spectrum(const std::string& filename = "MSSMatMGUTEFTHiggs_mAmu_spectrum.dat") const;

protected:
   MSSMatMGUTEFTHiggs_mAmu<T> model;
   ...
   void translate_exception_to_problem(MSSMatMGUTEFTHiggs_mAmu<T>& model);
   virtual void run_except(const softsusy::QedQcd&, const MSSMatMGUTEFTHiggs_mAmu_input_parameters&) = 0;
};
 ...
 */
template <class T>
void MSSMatMGUTEFTHiggs_mAmu_spectrum_generator_interface<T>::set_settings(
 ...
 */
template <class T>
void MSSMatMGUTEFTHiggs_mAmu_spectrum_generator_interface<T>::run(
   const softsusy::QedQcd& qedqcd_, const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input)
{
 ...
 */
template <class T>
void MSSMatMGUTEFTHiggs_mAmu_spectrum_generator_interface<T>::write_running_couplings(
   const std::string& filename,
   double start, double stop) const
{
   MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates tmp_model(model);
   try {
   ...
   MSSMatMGUTEFTHiggs_mAmu_parameter_getter parameter_getter;
   Coupling_monitor<MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates, MSSMatMGUTEFTHiggs_mAmu_parameter_getter>
 ...
 */
template <class T>
void MSSMatMGUTEFTHiggs_mAmu_spectrum_generator_interface<T>::write_spectrum(
   const std::string& filename) const
{
   MSSMatMGUTEFTHiggs_mAmu_spectrum_plotter plotter(model);
 ...
 */
template <class T>
void MSSMatMGUTEFTHiggs_mAmu_spectrum_generator_interface<T>::translate_exception_to_problem(MSSMatMGUTEFTHiggs_mAmu<T>& model)
{
   try {
      throw;
