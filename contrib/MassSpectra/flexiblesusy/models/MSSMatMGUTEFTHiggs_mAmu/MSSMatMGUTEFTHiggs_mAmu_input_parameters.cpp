...
Eigen::ArrayXd MSSMatMGUTEFTHiggs_mAmu_input_parameters::get() const
{
...
void MSSMatMGUTEFTHiggs_mAmu_input_parameters::set(const Eigen::ArrayXd& pars)
{
   TanBeta = pars(0);
   MuInput = pars(1);
   mA2Input = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input)
{
