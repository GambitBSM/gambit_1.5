...
#ifndef MSSMatMGUTEFTHiggs_mAmu_EFFECTIVE_COUPLINGS_H
#define MSSMatMGUTEFTHiggs_mAmu_EFFECTIVE_COUPLINGS_H
...
class MSSMatMGUTEFTHiggs_mAmu_effective_couplings {
public:
   MSSMatMGUTEFTHiggs_mAmu_effective_couplings(const MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates&,
   ...
   void set_model(const MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates& model_);
