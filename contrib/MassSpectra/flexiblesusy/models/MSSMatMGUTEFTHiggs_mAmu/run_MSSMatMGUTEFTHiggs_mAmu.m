Get["models/MSSMatMGUTEFTHiggs_mAmu/MSSMatMGUTEFTHiggs_mAmu_librarylink.m"];

handle = FSMSSMatMGUTEFTHiggs_mAmuOpenHandle[
    fsSettings -> {
...
spectrum    = FSMSSMatMGUTEFTHiggs_mAmuCalculateSpectrum[handle];
observables = FSMSSMatMGUTEFTHiggs_mAmuCalculateObservables[handle];
FSMSSMatMGUTEFTHiggs_mAmuCloseHandle[handle];
