...
#ifndef MSSMatMGUTEFTHiggs_mAmu_SLHA_IO_H
#define MSSMatMGUTEFTHiggs_mAmu_SLHA_IO_H
...
struct MSSMatMGUTEFTHiggs_mAmu_input_parameters;
class Spectrum_generator_settings;

template <class T>
class MSSMatMGUTEFTHiggs_mAmu;

struct MSSMatMGUTEFTHiggs_mAmu_scales {
   double HighScale{0.}, SUSYScale{0.}, LowScale{0.};
   double pole_mass_scale{0.};
};

class MSSMatMGUTEFTHiggs_mAmu_slha_io {
public:
   MSSMatMGUTEFTHiggs_mAmu_slha_io();

   void clear();

   void fill(softsusy::QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(MSSMatMGUTEFTHiggs_mAmu_input_parameters&) const;
   void fill(MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates&) const;
   template <class Model> void fill(MSSMatMGUTEFTHiggs_mAmu_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const MSSMatMGUTEFTHiggs_mAmu_slha<Model>&, const MSSMatMGUTEFTHiggs_mAmu_scales&, const MSSMatMGUTEFTHiggs_mAmu_observables&);
   void set_input(const MSSMatMGUTEFTHiggs_mAmu_input_parameters&);
   ...
   template <class Model> void set_spectrum(const MSSMatMGUTEFTHiggs_mAmu_slha<Model>&);
   template <class T> void set_spectrum(const MSSMatMGUTEFTHiggs_mAmu<T>&);
   ...
   static void fill_minpar_tuple(MSSMatMGUTEFTHiggs_mAmu_input_parameters&, int, double);
   static void fill_extpar_tuple(MSSMatMGUTEFTHiggs_mAmu_input_parameters&, int, double);
   static void fill_imminpar_tuple(MSSMatMGUTEFTHiggs_mAmu_input_parameters&, int, double);
   static void fill_imextpar_tuple(MSSMatMGUTEFTHiggs_mAmu_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const MSSMatMGUTEFTHiggs_mAmu_slha<Model>&, const softsusy::QedQcd&, const MSSMatMGUTEFTHiggs_mAmu_scales&, const MSSMatMGUTEFTHiggs_mAmu_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const MSSMatMGUTEFTHiggs_mAmu_slha<Model>&, const softsusy::QedQcd&, const MSSMatMGUTEFTHiggs_mAmu_scales&, const MSSMatMGUTEFTHiggs_mAmu_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const MSSMatMGUTEFTHiggs_mAmu_input_parameters&);
   void set_imminpar(const MSSMatMGUTEFTHiggs_mAmu_input_parameters&);
   void set_imextpar(const MSSMatMGUTEFTHiggs_mAmu_input_parameters&);
   void set_minpar(const MSSMatMGUTEFTHiggs_mAmu_input_parameters&);
   void set_mass(const MSSMatMGUTEFTHiggs_mAmu_physical&, bool);
   void set_mixing_matrices(const MSSMatMGUTEFTHiggs_mAmu_physical&, bool);
   template <class Model> void set_model_parameters(const MSSMatMGUTEFTHiggs_mAmu_slha<Model>&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates&) const;
   void fill_physical(MSSMatMGUTEFTHiggs_mAmu_physical&) const;
};
 ...
 */
template <class Model>
void MSSMatMGUTEFTHiggs_mAmu_slha_io::fill(MSSMatMGUTEFTHiggs_mAmu_slha<Model>& model) const
{
   fill(static_cast<MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates&>(model));
   fill_physical(model.get_physical_slha());
}

template <class Model>
void MSSMatMGUTEFTHiggs_mAmu_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const MSSMatMGUTEFTHiggs_mAmu_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const MSSMatMGUTEFTHiggs_mAmu_scales& scales,
   const MSSMatMGUTEFTHiggs_mAmu_observables& observables)
{
   MSSMatMGUTEFTHiggs_mAmu_slha_io slha_io;
   const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll MSSMatMGUTEFTHiggs_mAmu_slha_io::fill_slhaea(
   const MSSMatMGUTEFTHiggs_mAmu_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const MSSMatMGUTEFTHiggs_mAmu_scales& scales, const MSSMatMGUTEFTHiggs_mAmu_observables& observables)
{
   SLHAea::Coll slhaea;
   MSSMatMGUTEFTHiggs_mAmu_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_model_parameters(const MSSMatMGUTEFTHiggs_mAmu_slha<Model>& model)
{
   {
 ...
 */
template <class Model>
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_extra(
   const MSSMatMGUTEFTHiggs_mAmu_slha<Model>& model, const MSSMatMGUTEFTHiggs_mAmu_scales& scales,
   const MSSMatMGUTEFTHiggs_mAmu_observables& observables)
{
   const MSSMatMGUTEFTHiggs_mAmu_physical physical(model.get_physical_slha());
 ...
 */
template <class... Ts>
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<MSSMatMGUTEFTHiggs_mAmu_slha_io> ss(this);
 ...
 */
template <class T>
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_spectrum(const MSSMatMGUTEFTHiggs_mAmu<T>& model)
{
   set_spectrum(MSSMatMGUTEFTHiggs_mAmu_slha<MSSMatMGUTEFTHiggs_mAmu<T> >(model));
}
 ...
 */
template <class Model>
void MSSMatMGUTEFTHiggs_mAmu_slha_io::set_spectrum(const MSSMatMGUTEFTHiggs_mAmu_slha<Model>& model)
{
   const MSSMatMGUTEFTHiggs_mAmu_physical physical(model.get_physical_slha());
