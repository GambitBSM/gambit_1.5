...
MSSMatMGUTEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::MSSMatMGUTEFTHiggs_mAmu_standard_model_initial_guesser(
   ...
   const MSSMatMGUTEFTHiggs_mAmu_susy_scale_constraint<Two_scale>& susy_constraint_,
   const MSSMatMGUTEFTHiggs_mAmu_high_scale_constraint<Two_scale>& high_constraint_
)
   : Initial_guesser()
   , model(model_)
   , eft(eft_)
...
{
   if (!model)
      throw SetupError("MSSMatMGUTEFTHiggs_mAmu_initial_guesser: Error: pointer to model"
                       " MSSMatMGUTEFTHiggs_mAmu<Two_scale> must not be zero");
}
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::guess()
{
 ...
 * \endcode
 */
void MSSMatMGUTEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::guess_eft_parameters()
{
...
void MSSMatMGUTEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
 ...
 * corrections).
 */
void MSSMatMGUTEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::calculate_Yu_DRbar()
{
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::calculate_Yd_DRbar()
{
 ...
 * corrections).
 */
void MSSMatMGUTEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::calculate_Ye_DRbar()
{
 ...
 * \code{.cpp}
   ...
   MODEL->set_BMu(Re(mA2Input/(1/TanBeta + TanBeta)));
 ...
 */
void MSSMatMGUTEFTHiggs_mAmu_standard_model_initial_guesser<Two_scale>::guess_model_parameters()
{
