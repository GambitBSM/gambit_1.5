...
#ifndef MSSMatMGUTEFTHiggs_mAmu_PHYSICAL_H
#define MSSMatMGUTEFTHiggs_mAmu_PHYSICAL_H
...
struct MSSMatMGUTEFTHiggs_mAmu_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMatMGUTEFTHiggs_mAmu_physical&);
