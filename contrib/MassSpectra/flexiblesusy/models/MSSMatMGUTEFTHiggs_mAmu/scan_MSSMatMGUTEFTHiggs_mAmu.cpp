...
{
   std::cout <<
      "Usage: scan_MSSMatMGUTEFTHiggs_mAmu.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --MuInput=<value>\n"
      "  --mA2Input=<value>\n"
...
struct MSSMatMGUTEFTHiggs_mAmu_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
MSSMatMGUTEFTHiggs_mAmu_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   MSSMatMGUTEFTHiggs_mAmu_input_parameters& input)
{
   ...
   MSSMatMGUTEFTHiggs_mAmu_scan_result result;
...
void scan(int solver_type, MSSMatMGUTEFTHiggs_mAmu_input_parameters& input,
