...
const int MSSMatMGUTEFTHiggs_mAmu_soft_parameters::numberOfParameters;

MSSMatMGUTEFTHiggs_mAmu_soft_parameters::MSSMatMGUTEFTHiggs_mAmu_soft_parameters(const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input_)
   : MSSMatMGUTEFTHiggs_mAmu_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSMatMGUTEFTHiggs_mAmu_soft_parameters::MSSMatMGUTEFTHiggs_mAmu_soft_parameters(
   const MSSMatMGUTEFTHiggs_mAmu_susy_parameters& susy_model
   ...
   : MSSMatMGUTEFTHiggs_mAmu_susy_parameters(susy_model)
...
Eigen::ArrayXd MSSMatMGUTEFTHiggs_mAmu_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMatMGUTEFTHiggs_mAmu_soft_parameters MSSMatMGUTEFTHiggs_mAmu_soft_parameters::calc_beta(int loops) const
{
   ...
   const MSSMatMGUTEFTHiggs_mAmu_susy_parameters susy_betas(MSSMatMGUTEFTHiggs_mAmu_susy_parameters::calc_beta(loops));

   return MSSMatMGUTEFTHiggs_mAmu_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

MSSMatMGUTEFTHiggs_mAmu_soft_parameters MSSMatMGUTEFTHiggs_mAmu_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MSSMatMGUTEFTHiggs_mAmu_soft_parameters::clear()
{
   MSSMatMGUTEFTHiggs_mAmu_susy_parameters::clear();
...
Eigen::ArrayXd MSSMatMGUTEFTHiggs_mAmu_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MSSMatMGUTEFTHiggs_mAmu_susy_parameters::get());
...
void MSSMatMGUTEFTHiggs_mAmu_soft_parameters::print(std::ostream& ostr) const
{
   MSSMatMGUTEFTHiggs_mAmu_susy_parameters::print(ostr);
...
void MSSMatMGUTEFTHiggs_mAmu_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MSSMatMGUTEFTHiggs_mAmu_susy_parameters::set(pars);
...
MSSMatMGUTEFTHiggs_mAmu_soft_parameters::Soft_traces MSSMatMGUTEFTHiggs_mAmu_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSMatMGUTEFTHiggs_mAmu_soft_parameters& soft_pars)
{
