...
#ifndef MSSMatMGUTEFTHiggs_mAmu_susy_parameters_H
#define MSSMatMGUTEFTHiggs_mAmu_susy_parameters_H
...
class MSSMatMGUTEFTHiggs_mAmu_susy_parameters : public Beta_function {
public:
   explicit MSSMatMGUTEFTHiggs_mAmu_susy_parameters(const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input_ = MSSMatMGUTEFTHiggs_mAmu_input_parameters());
   MSSMatMGUTEFTHiggs_mAmu_susy_parameters(double scale_, int loops_, int thresholds_, const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   , const Eigen::Matrix<double,3,3>& Yu_, double Mu_, double g1_, double g2_,
   double g3_, double vd_, double vu_
);
   MSSMatMGUTEFTHiggs_mAmu_susy_parameters(const MSSMatMGUTEFTHiggs_mAmu_susy_parameters&) = default;
   MSSMatMGUTEFTHiggs_mAmu_susy_parameters(MSSMatMGUTEFTHiggs_mAmu_susy_parameters&&) = default;
   virtual ~MSSMatMGUTEFTHiggs_mAmu_susy_parameters() = default;
   MSSMatMGUTEFTHiggs_mAmu_susy_parameters& operator=(const MSSMatMGUTEFTHiggs_mAmu_susy_parameters&) = default;
   MSSMatMGUTEFTHiggs_mAmu_susy_parameters& operator=(MSSMatMGUTEFTHiggs_mAmu_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const MSSMatMGUTEFTHiggs_mAmu_input_parameters& get_input() const;
   MSSMatMGUTEFTHiggs_mAmu_input_parameters& get_input();
   void set_input_parameters(const MSSMatMGUTEFTHiggs_mAmu_input_parameters&);

   MSSMatMGUTEFTHiggs_mAmu_susy_parameters calc_beta() const;
   MSSMatMGUTEFTHiggs_mAmu_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMatMGUTEFTHiggs_mAmu_susy_parameters&);
