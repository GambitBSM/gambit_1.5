...
#ifndef MSSMatMGUTEFTHiggs_mAmu_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MSSMatMGUTEFTHiggs_mAmu_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MSSMatMGUTEFTHiggs_mAmu_low_scale_constraint.hpp"
...
template<>
class MSSMatMGUTEFTHiggs_mAmu_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MSSMatMGUTEFTHiggs_mAmu_low_scale_constraint() = default;
   MSSMatMGUTEFTHiggs_mAmu_low_scale_constraint(MSSMatMGUTEFTHiggs_mAmu<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSMatMGUTEFTHiggs_mAmu_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MSSMatMGUTEFTHiggs_mAmu low-scale constraint"; }
