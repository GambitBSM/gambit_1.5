...
#define CLASSNAME MSSMatMGUTEFTHiggs_mAmu_weinberg_angle
 ...
 */
CLASSNAME::MSSMatMGUTEFTHiggs_mAmu_weinberg_angle(
...
void CLASSNAME::set_model(const MSSMatMGUTEFTHiggs_mAmu_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * MSSMatMGUTEFTHiggs_mAmu_info::normalization_g1;
   const double g2 = MODEL->get_g2() * MSSMatMGUTEFTHiggs_mAmu_info::normalization_g2;
