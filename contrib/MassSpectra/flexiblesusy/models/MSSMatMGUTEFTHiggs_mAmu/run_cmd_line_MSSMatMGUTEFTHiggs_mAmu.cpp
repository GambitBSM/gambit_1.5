...
{
   std::cout <<
      "Usage: run_cmd_line_MSSMatMGUTEFTHiggs_mAmu.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --MuInput=<value>\n"
      "  --mA2Input=<value>\n"
...
int run_solver(const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input)
{
   ...
   // SLHA output
   SLHAea::Coll slhaea(MSSMatMGUTEFTHiggs_mAmu_slha_io::fill_slhaea(
...
int run(int solver_type, const MSSMatMGUTEFTHiggs_mAmu_input_parameters& input)
{
   int exit_code = 0;
