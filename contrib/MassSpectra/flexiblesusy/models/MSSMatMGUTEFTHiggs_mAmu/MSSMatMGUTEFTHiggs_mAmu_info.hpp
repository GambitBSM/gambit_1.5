...
#ifndef MSSMatMGUTEFTHiggs_mAmu_INFO_H
#define MSSMatMGUTEFTHiggs_mAmu_INFO_H
...
namespace MSSMatMGUTEFTHiggs_mAmu_info {
   ...
   class MSSMatMGUTEFTHiggs_mAmu_particle_names : public Names {
   public:
      virtual ~MSSMatMGUTEFTHiggs_mAmu_particle_names() = default;
   ...
   class MSSMatMGUTEFTHiggs_mAmu_parameter_names : public Names {
   public:
      virtual ~MSSMatMGUTEFTHiggs_mAmu_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSMatMGUTEFTHiggs_mAmu_particle_names  particle_names_getter{};
   const MSSMatMGUTEFTHiggs_mAmu_parameter_names parameter_names_getter{};
