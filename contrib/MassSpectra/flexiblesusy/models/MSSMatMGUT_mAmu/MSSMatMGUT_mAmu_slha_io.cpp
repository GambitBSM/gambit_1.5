...
MSSMatMGUT_mAmu_slha_io::MSSMatMGUT_mAmu_slha_io()
   : slha_io()
   , print_imaginary_parts_of_majorana_mixings(false)
{
}

void MSSMatMGUT_mAmu_slha_io::clear()
{
   slha_io.clear();
}

void MSSMatMGUT_mAmu_slha_io::set_print_imaginary_parts_of_majorana_mixings(bool flag)
{
 ...
 */
void MSSMatMGUT_mAmu_slha_io::set_extpar(const MSSMatMGUT_mAmu_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMatMGUT_mAmu_slha_io::set_imminpar(const MSSMatMGUT_mAmu_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMatMGUT_mAmu_slha_io::set_imextpar(const MSSMatMGUT_mAmu_input_parameters& input)
{
 ...
 */
void MSSMatMGUT_mAmu_slha_io::set_modsel(const SLHA_io::Modsel& modsel)
{
 ...
 * @param input struct of input parameters
 */
void MSSMatMGUT_mAmu_slha_io::set_minpar(const MSSMatMGUT_mAmu_input_parameters& input)
{
 ...
 * @param input struct of input parameters
 */
void MSSMatMGUT_mAmu_slha_io::set_input(const MSSMatMGUT_mAmu_input_parameters& input)
{
   set_minpar(input);
   set_extpar(input);
   set_imminpar(input);
 ...
 */
void MSSMatMGUT_mAmu_slha_io::set_physical_input(const Physical_input& input)
{
 ...
 */
void MSSMatMGUT_mAmu_slha_io::set_settings(const Spectrum_generator_settings& settings)
{
 ...
 */
void MSSMatMGUT_mAmu_slha_io::set_sminputs(const softsusy::QedQcd& qedqcd)
{
 ...
 */
void MSSMatMGUT_mAmu_slha_io::set_spinfo(const Spectrum_generator_problems& problems)
{
 ...
 * @param problems struct with parameter point problems
 */
void MSSMatMGUT_mAmu_slha_io::set_spinfo(const Problems& problems)
{
   set_spinfo(problems.get_problem_strings(), problems.get_warning_strings());
}
 ...
 */
void MSSMatMGUT_mAmu_slha_io::set_spinfo(
   ...
   const std::vector<std::string>& warnings)
{
   ...
   spinfo << FORMAT_SPINFO(5, MSSMatMGUT_mAmu_info::model_name)
 ...
 */
void MSSMatMGUT_mAmu_slha_io::set_mass(const MSSMatMGUT_mAmu_physical& physical,
 ...
 */
void MSSMatMGUT_mAmu_slha_io::set_mixing_matrices(const MSSMatMGUT_mAmu_physical& physical,
...
void MSSMatMGUT_mAmu_slha_io::set_ckm(
...
void MSSMatMGUT_mAmu_slha_io::set_pmns(
 ...
 */
void MSSMatMGUT_mAmu_slha_io::write_to(const std::string& output) const
{
   if (output == "-")
 ...
 */
double MSSMatMGUT_mAmu_slha_io::get_parameter_output_scale() const
{
 ...
 */
void MSSMatMGUT_mAmu_slha_io::read_from_file(const std::string& file_name)
{
 ...
 */
void MSSMatMGUT_mAmu_slha_io::read_from_source(const std::string& source)
{
 ...
 */
void MSSMatMGUT_mAmu_slha_io::read_from_stream(std::istream& istr)
{
 ...
 */
void MSSMatMGUT_mAmu_slha_io::fill(MSSMatMGUT_mAmu_input_parameters& input) const
{
 ...
 */
void MSSMatMGUT_mAmu_slha_io::fill_drbar_parameters(MSSMatMGUT_mAmu_mass_eigenstates& model) const
{
 ...
 * @param model model class to be filled
 */
void MSSMatMGUT_mAmu_slha_io::fill(MSSMatMGUT_mAmu_mass_eigenstates& model) const
{
   fill_drbar_parameters(model);

   MSSMatMGUT_mAmu_physical physical_hk;
 ...
 */
void MSSMatMGUT_mAmu_slha_io::fill(Physical_input& input) const
{
   slha_io.fill(input);
}
 ...
 */
void MSSMatMGUT_mAmu_slha_io::fill(Spectrum_generator_settings& settings) const
{
   slha_io.fill(settings);
}

void MSSMatMGUT_mAmu_slha_io::fill_minpar_tuple(MSSMatMGUT_mAmu_input_parameters& input,
...
void MSSMatMGUT_mAmu_slha_io::fill_extpar_tuple(MSSMatMGUT_mAmu_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMatMGUT_mAmu_slha_io::fill_imminpar_tuple(MSSMatMGUT_mAmu_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
...
void MSSMatMGUT_mAmu_slha_io::fill_imextpar_tuple(MSSMatMGUT_mAmu_input_parameters& input,
                                                int key, double value)
{
   switch (key) {
 ...
 */
void MSSMatMGUT_mAmu_slha_io::fill_physical(MSSMatMGUT_mAmu_physical& physical) const
{
   {
 ...
 */
double MSSMatMGUT_mAmu_slha_io::read_scale() const
{
