...
// File generated at Wed 25 Oct 2017 18:03:50

#ifndef MSSMatMGUT_mAmu_SLHA_IO_H
#define MSSMatMGUT_mAmu_SLHA_IO_H
...
struct MSSMatMGUT_mAmu_input_parameters;
class Spectrum_generator_settings;

template <class T>
class MSSMatMGUT_mAmu;

struct MSSMatMGUT_mAmu_scales {
   double HighScale{0.}, SUSYScale{0.}, LowScale{0.};
   double pole_mass_scale{0.};
};

class MSSMatMGUT_mAmu_slha_io {
public:
   MSSMatMGUT_mAmu_slha_io();

   void clear();

   void fill(softsusy::QedQcd& qedqcd) const { slha_io.fill(qedqcd); }
   void fill(MSSMatMGUT_mAmu_input_parameters&) const;
   void fill(MSSMatMGUT_mAmu_mass_eigenstates&) const;
   template <class Model> void fill(MSSMatMGUT_mAmu_slha<Model>&) const;
   ...
   template <class Model> void set_extra(const MSSMatMGUT_mAmu_slha<Model>&, const MSSMatMGUT_mAmu_scales&, const MSSMatMGUT_mAmu_observables&);
   void set_input(const MSSMatMGUT_mAmu_input_parameters&);
   ...
   template <class Model> void set_spectrum(const MSSMatMGUT_mAmu_slha<Model>&);
   template <class T> void set_spectrum(const MSSMatMGUT_mAmu<T>&);
   ...
   static void fill_minpar_tuple(MSSMatMGUT_mAmu_input_parameters&, int, double);
   static void fill_extpar_tuple(MSSMatMGUT_mAmu_input_parameters&, int, double);
   static void fill_imminpar_tuple(MSSMatMGUT_mAmu_input_parameters&, int, double);
   static void fill_imextpar_tuple(MSSMatMGUT_mAmu_input_parameters&, int, double);

   template <class Model>
   static void fill_slhaea(SLHAea::Coll&, const MSSMatMGUT_mAmu_slha<Model>&, const softsusy::QedQcd&, const MSSMatMGUT_mAmu_scales&, const MSSMatMGUT_mAmu_observables&);

   template <class Model>
   static SLHAea::Coll fill_slhaea(const MSSMatMGUT_mAmu_slha<Model>&, const softsusy::QedQcd&, const MSSMatMGUT_mAmu_scales&, const MSSMatMGUT_mAmu_observables&);

private:
   SLHA_io slha_io; ///< SLHA io class
   bool print_imaginary_parts_of_majorana_mixings;

   void set_extpar(const MSSMatMGUT_mAmu_input_parameters&);
   void set_imminpar(const MSSMatMGUT_mAmu_input_parameters&);
   void set_imextpar(const MSSMatMGUT_mAmu_input_parameters&);
   void set_minpar(const MSSMatMGUT_mAmu_input_parameters&);
   void set_mass(const MSSMatMGUT_mAmu_physical&, bool);
   void set_mixing_matrices(const MSSMatMGUT_mAmu_physical&, bool);
   template <class Model> void set_model_parameters(const MSSMatMGUT_mAmu_slha<Model>&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   void fill_drbar_parameters(MSSMatMGUT_mAmu_mass_eigenstates&) const;
   void fill_physical(MSSMatMGUT_mAmu_physical&) const;
};
 ...
 */
template <class Model>
void MSSMatMGUT_mAmu_slha_io::fill(MSSMatMGUT_mAmu_slha<Model>& model) const
{
   fill(static_cast<MSSMatMGUT_mAmu_mass_eigenstates&>(model));
   fill_physical(model.get_physical_slha());
}

template <class Model>
void MSSMatMGUT_mAmu_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const MSSMatMGUT_mAmu_slha<Model>& model,
   const softsusy::QedQcd& qedqcd, const MSSMatMGUT_mAmu_scales& scales,
   const MSSMatMGUT_mAmu_observables& observables)
{
   MSSMatMGUT_mAmu_slha_io slha_io;
   const MSSMatMGUT_mAmu_input_parameters& input = model.get_input();
...
template <class Model>
SLHAea::Coll MSSMatMGUT_mAmu_slha_io::fill_slhaea(
   const MSSMatMGUT_mAmu_slha<Model>& model, const softsusy::QedQcd& qedqcd,
   const MSSMatMGUT_mAmu_scales& scales, const MSSMatMGUT_mAmu_observables& observables)
{
   SLHAea::Coll slhaea;
   MSSMatMGUT_mAmu_slha_io::fill_slhaea(slhaea, model, qedqcd, scales, observables);
 ...
 */
template <class Model>
void MSSMatMGUT_mAmu_slha_io::set_model_parameters(const MSSMatMGUT_mAmu_slha<Model>& model)
{
   {
 ...
 */
template <class Model>
void MSSMatMGUT_mAmu_slha_io::set_extra(
   const MSSMatMGUT_mAmu_slha<Model>& model, const MSSMatMGUT_mAmu_scales& scales,
   const MSSMatMGUT_mAmu_observables& observables)
{
   const MSSMatMGUT_mAmu_physical physical(model.get_physical_slha());
 ...
 */
template <class... Ts>
void MSSMatMGUT_mAmu_slha_io::set_spectrum(const std::tuple<Ts...>& models)
{
   Set_spectrum<MSSMatMGUT_mAmu_slha_io> ss(this);
 ...
 */
template <class T>
void MSSMatMGUT_mAmu_slha_io::set_spectrum(const MSSMatMGUT_mAmu<T>& model)
{
   set_spectrum(MSSMatMGUT_mAmu_slha<MSSMatMGUT_mAmu<T> >(model));
}
 ...
 */
template <class Model>
void MSSMatMGUT_mAmu_slha_io::set_spectrum(const MSSMatMGUT_mAmu_slha<Model>& model)
{
   const MSSMatMGUT_mAmu_physical physical(model.get_physical_slha());
