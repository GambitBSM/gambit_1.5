...
#ifndef MSSMatMGUT_mAmu_WEINBERG_ANGLE_H
#define MSSMatMGUT_mAmu_WEINBERG_ANGLE_H
...
/**
 * @class MSSMatMGUT_mAmu_weinberg_angle
...
public:
   ...
   MSSMatMGUT_mAmu_weinberg_angle(const MSSMatMGUT_mAmu_mass_eigenstates*, const Sm_parameters&);
   ...
   void set_model(const MSSMatMGUT_mAmu_mass_eigenstates*);  ///< set pointer to investigated model
...
private:
   ...
   const MSSMatMGUT_mAmu_mass_eigenstates* model{nullptr}; ///< pointer to investigated model
