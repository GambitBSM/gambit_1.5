...
/**
 * @file MSSMatMGUT_mAmu_ewsb_solver_interface.hpp
 *
 * @brief contains interface for EWSB solver
 *
 * This file was generated at Thu 12 Oct 2017 13:53:44 with FlexibleSUSY
 * 2.0.0 (git commit: unknown) and SARAH 4.11.0 .
 */

#ifndef MSSMatMGUT_mAmu_EWSB_SOLVER_INTERFACE_H
#define MSSMatMGUT_mAmu_EWSB_SOLVER_INTERFACE_H
...
class MSSMatMGUT_mAmu_ewsb_solver_interface {
public:
   virtual ~MSSMatMGUT_mAmu_ewsb_solver_interface() {}
   ...
   virtual int solve(MSSMatMGUT_mAmu_mass_eigenstates&) = 0;
};
