Get["models/MSSMatMGUT_mAmu/MSSMatMGUT_mAmu_librarylink.m"];

handle = FSMSSMatMGUT_mAmuOpenHandle[
    fsSettings -> {
...
spectrum    = FSMSSMatMGUT_mAmuCalculateSpectrum[handle];
observables = FSMSSMatMGUT_mAmuCalculateObservables[handle];
FSMSSMatMGUT_mAmuCloseHandle[handle];
