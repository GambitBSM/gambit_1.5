...
MSSMatMGUT_mAmu_convergence_tester<Two_scale>::MSSMatMGUT_mAmu_convergence_tester(
   MSSMatMGUT_mAmu<Two_scale>* model, double accuracy_goal, const Scale_getter& sg)
   : Convergence_tester_DRbar<MSSMatMGUT_mAmu<Two_scale> >(model, accuracy_goal, sg)
{
}

double MSSMatMGUT_mAmu_convergence_tester<Two_scale>::max_rel_diff() const
{
   const MSSMatMGUT_mAmu<Two_scale>& ol = get_last_iteration_model();
   const MSSMatMGUT_mAmu<Two_scale>& ne = get_current_iteration_model();
