...
#ifndef MSSMatMGUT_mAmu_INFO_H
#define MSSMatMGUT_mAmu_INFO_H
...
namespace MSSMatMGUT_mAmu_info {
   ...
   enum Input_parameters : int { TanBeta, SignMu, MuInput, mA2Input, Aeij0_0,
   ...
   class MSSMatMGUT_mAmu_particle_names : public Names {
   public:
      virtual ~MSSMatMGUT_mAmu_particle_names() = default;
   ...
   class MSSMatMGUT_mAmu_parameter_names : public Names {
   public:
      virtual ~MSSMatMGUT_mAmu_parameter_names() = default;
      virtual const std::string& get(int index) const override {
   ...
   const MSSMatMGUT_mAmu_particle_names  particle_names_getter{};
   const MSSMatMGUT_mAmu_parameter_names parameter_names_getter{};
