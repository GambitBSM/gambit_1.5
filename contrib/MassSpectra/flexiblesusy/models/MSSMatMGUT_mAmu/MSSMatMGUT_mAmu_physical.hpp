...
#ifndef MSSMatMGUT_mAmu_PHYSICAL_H
#define MSSMatMGUT_mAmu_PHYSICAL_H
...
struct MSSMatMGUT_mAmu_physical {
   void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMatMGUT_mAmu_physical&);
