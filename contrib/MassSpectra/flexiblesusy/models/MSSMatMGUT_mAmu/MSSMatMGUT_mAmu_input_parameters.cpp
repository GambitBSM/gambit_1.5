...
// File generated at Thu 12 Oct 2017 13:53:13
...
Eigen::ArrayXd MSSMatMGUT_mAmu_input_parameters::get() const
{
...
void MSSMatMGUT_mAmu_input_parameters::set(const Eigen::ArrayXd& pars)
{
   TanBeta = pars(0);
   SignMu = pars(1);
   MuInput = pars(2);
...
std::ostream& operator<<(std::ostream& ostr, const MSSMatMGUT_mAmu_input_parameters& input)
{
