...
#ifndef MSSMatMGUT_mAmu_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define MSSMatMGUT_mAmu_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "MSSMatMGUT_mAmu_low_scale_constraint.hpp"
...
template<>
class MSSMatMGUT_mAmu_low_scale_constraint<Two_scale> : public Single_scale_constraint {
public:
   MSSMatMGUT_mAmu_low_scale_constraint() = default;
   MSSMatMGUT_mAmu_low_scale_constraint(MSSMatMGUT_mAmu<Two_scale>*, const softsusy::QedQcd&);
   virtual ~MSSMatMGUT_mAmu_low_scale_constraint() = default;
   virtual void apply() override;
   virtual double get_scale() const override;
   virtual std::string name() const override { return "MSSMatMGUT_mAmu low-scale constraint"; }
