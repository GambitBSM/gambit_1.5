...
// File generated at Sun 24 Sep 2017 15:46:24
...
const int MSSMatMGUT_mAmu_soft_parameters::numberOfParameters;

MSSMatMGUT_mAmu_soft_parameters::MSSMatMGUT_mAmu_soft_parameters(const MSSMatMGUT_mAmu_input_parameters& input_)
   : MSSMatMGUT_mAmu_susy_parameters(input_)
{
   set_number_of_parameters(numberOfParameters);
}

MSSMatMGUT_mAmu_soft_parameters::MSSMatMGUT_mAmu_soft_parameters(
   const MSSMatMGUT_mAmu_susy_parameters& susy_model
   ...
   : MSSMatMGUT_mAmu_susy_parameters(susy_model)
...
Eigen::ArrayXd MSSMatMGUT_mAmu_soft_parameters::beta() const
{
   return calc_beta().get().unaryExpr(Chop<double>(get_zero_threshold()));
}

MSSMatMGUT_mAmu_soft_parameters MSSMatMGUT_mAmu_soft_parameters::calc_beta(int loops) const
{
   ...
   const MSSMatMGUT_mAmu_susy_parameters susy_betas(MSSMatMGUT_mAmu_susy_parameters::calc_beta(loops));

   return MSSMatMGUT_mAmu_soft_parameters(susy_betas, beta_TYd, beta_TYe, beta_TYu, beta_BMu, beta_mq2, beta_ml2, beta_mHd2, beta_mHu2, beta_md2, beta_mu2, beta_me2, beta_MassB, beta_MassWB, beta_MassG);
}

MSSMatMGUT_mAmu_soft_parameters MSSMatMGUT_mAmu_soft_parameters::calc_beta() const
{
   return calc_beta(get_loops());
}

void MSSMatMGUT_mAmu_soft_parameters::clear()
{
   MSSMatMGUT_mAmu_susy_parameters::clear();
...
Eigen::ArrayXd MSSMatMGUT_mAmu_soft_parameters::get() const
{
   Eigen::ArrayXd pars(MSSMatMGUT_mAmu_susy_parameters::get());
...
void MSSMatMGUT_mAmu_soft_parameters::print(std::ostream& ostr) const
{
   MSSMatMGUT_mAmu_susy_parameters::print(ostr);
...
void MSSMatMGUT_mAmu_soft_parameters::set(const Eigen::ArrayXd& pars)
{
   MSSMatMGUT_mAmu_susy_parameters::set(pars);
...
MSSMatMGUT_mAmu_soft_parameters::Soft_traces MSSMatMGUT_mAmu_soft_parameters::calc_soft_traces(int loops) const
{
...
std::ostream& operator<<(std::ostream& ostr, const MSSMatMGUT_mAmu_soft_parameters& soft_pars)
{
