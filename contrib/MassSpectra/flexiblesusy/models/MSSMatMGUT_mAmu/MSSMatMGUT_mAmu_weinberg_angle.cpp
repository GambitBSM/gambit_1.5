...
// File generated at Sun 24 Sep 2017 15:48:23
...
#define CLASSNAME MSSMatMGUT_mAmu_weinberg_angle
 ...
 */
CLASSNAME::MSSMatMGUT_mAmu_weinberg_angle(
...
void CLASSNAME::set_model(const MSSMatMGUT_mAmu_mass_eigenstates* model_)
{
   model = model_;
}
...
{
   const double gY = MODEL->get_g1() * MSSMatMGUT_mAmu_info::normalization_g1;
   const double g2 = MODEL->get_g2() * MSSMatMGUT_mAmu_info::normalization_g2;
