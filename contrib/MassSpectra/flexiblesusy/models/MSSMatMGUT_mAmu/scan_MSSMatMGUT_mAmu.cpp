...
{
   std::cout <<
      "Usage: scan_MSSMatMGUT_mAmu.x [options]\n"
      "Options:\n"
      "  --TanBeta=<value>\n"
      "  --SignMu=<value>\n"
      "  --MuInput=<value>\n"
...
struct MSSMatMGUT_mAmu_scan_result {
   Spectrum_generator_problems problems;
   double higgs{0.};
};

template <class solver_type>
MSSMatMGUT_mAmu_scan_result run_parameter_point(const softsusy::QedQcd& qedqcd,
   MSSMatMGUT_mAmu_input_parameters& input)
{
   ...
   MSSMatMGUT_mAmu_scan_result result;
...
void scan(int solver_type, MSSMatMGUT_mAmu_input_parameters& input,
