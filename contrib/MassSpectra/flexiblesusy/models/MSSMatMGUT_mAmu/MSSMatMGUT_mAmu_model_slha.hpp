...
/**
 * @file MSSMatMGUT_mAmu_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

// File generated at Sun 24 Sep 2017 15:48:16

#ifndef MSSMatMGUT_mAmu_SLHA_H
#define MSSMatMGUT_mAmu_SLHA_H
...
class MSSMatMGUT_mAmu_slha : public Model {
public:
   explicit MSSMatMGUT_mAmu_slha(const MSSMatMGUT_mAmu_input_parameters& input_ = MSSMatMGUT_mAmu_input_parameters());
   explicit MSSMatMGUT_mAmu_slha(const Model&, bool do_convert_masses_to_slha = true);
   MSSMatMGUT_mAmu_slha(const MSSMatMGUT_mAmu_slha&) = default;
   MSSMatMGUT_mAmu_slha(MSSMatMGUT_mAmu_slha&&) = default;
   virtual ~MSSMatMGUT_mAmu_slha() = default;
   MSSMatMGUT_mAmu_slha& operator=(const MSSMatMGUT_mAmu_slha&) = default;
   MSSMatMGUT_mAmu_slha& operator=(MSSMatMGUT_mAmu_slha&&) = default;
   ...
   const MSSMatMGUT_mAmu_physical& get_physical_slha() const; ///< returns pole masses to SLHA convention
   MSSMatMGUT_mAmu_physical& get_physical_slha(); ///< returns pole masses to SLHA convention
...
private:
   MSSMatMGUT_mAmu_physical physical_slha{}; ///< contains the pole masses and mixings in slha convention
...
template <class Model>
MSSMatMGUT_mAmu_slha<Model>::MSSMatMGUT_mAmu_slha(const MSSMatMGUT_mAmu_input_parameters& input_)
   : Model(input_)
{
}
 ...
 */
template <class Model>
MSSMatMGUT_mAmu_slha<Model>::MSSMatMGUT_mAmu_slha(const Model& model_,
...
template <class Model>
void MSSMatMGUT_mAmu_slha<Model>::clear()
{
   Model::clear();
   physical_slha.clear();
}
...
template <class Model>
void MSSMatMGUT_mAmu_slha<Model>::calculate_spectrum()
{
...
template <class Model>
void MSSMatMGUT_mAmu_slha<Model>::convert_to_slha()
{
...
template <class Model>
void MSSMatMGUT_mAmu_slha<Model>::calculate_ckm_matrix()
{
...
template <class Model>
void MSSMatMGUT_mAmu_slha<Model>::calculate_pmns_matrix()
{
 ...
 */
template <class Model>
void MSSMatMGUT_mAmu_slha<Model>::convert_yukawa_couplings_to_slha()
{
 ...
 */
template <class Model>
void MSSMatMGUT_mAmu_slha<Model>::convert_trilinear_couplings_to_slha()
{
 ...
 */
template <class Model>
void MSSMatMGUT_mAmu_slha<Model>::convert_soft_squared_masses_to_slha()
{
...
template <class Model>
const MSSMatMGUT_mAmu_physical& MSSMatMGUT_mAmu_slha<Model>::get_physical_slha() const
{
   return physical_slha;
}

template <class Model>
MSSMatMGUT_mAmu_physical& MSSMatMGUT_mAmu_slha<Model>::get_physical_slha()
{
   return physical_slha;
}

template <class Model>
void MSSMatMGUT_mAmu_slha<Model>::print(std::ostream& ostr) const
{
   Model::print(ostr);
...
template <class Model>
void MSSMatMGUT_mAmu_slha<Model>::set_convert_masses_to_slha(bool flag)
{
   convert_masses_to_slha = flag;
}

template <class Model>
std::ostream& operator<<(std::ostream& ostr, const MSSMatMGUT_mAmu_slha<Model>& model)
{
   model.print(ostr);
   return ostr;
}
