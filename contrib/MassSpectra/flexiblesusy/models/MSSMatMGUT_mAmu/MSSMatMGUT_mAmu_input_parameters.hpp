...
#ifndef MSSMatMGUT_mAmu_INPUT_PARAMETERS_H
#define MSSMatMGUT_mAmu_INPUT_PARAMETERS_H
...
std::ostream& operator<<(std::ostream&, const MSSMatMGUT_mAmu_input_parameters&);
