...
class MSSMatMGUT_mAmu_susy_parameters : public Beta_function {
public:
   explicit MSSMatMGUT_mAmu_susy_parameters(const MSSMatMGUT_mAmu_input_parameters& input_ = MSSMatMGUT_mAmu_input_parameters());
   MSSMatMGUT_mAmu_susy_parameters(double scale_, int loops_, int thresholds_, const MSSMatMGUT_mAmu_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,3>& Ye_
   , const Eigen::Matrix<double,3,3>& Yu_, double Mu_, double g1_, double g2_,
   double g3_, double vd_, double vu_
);
   MSSMatMGUT_mAmu_susy_parameters(const MSSMatMGUT_mAmu_susy_parameters&) = default;
   MSSMatMGUT_mAmu_susy_parameters(MSSMatMGUT_mAmu_susy_parameters&&) = default;
   virtual ~MSSMatMGUT_mAmu_susy_parameters() = default;
   MSSMatMGUT_mAmu_susy_parameters& operator=(const MSSMatMGUT_mAmu_susy_parameters&) = default;
   MSSMatMGUT_mAmu_susy_parameters& operator=(MSSMatMGUT_mAmu_susy_parameters&&) = default;

   virtual Eigen::ArrayXd beta() const override;
   virtual Eigen::ArrayXd get() const override;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&) override;
   const MSSMatMGUT_mAmu_input_parameters& get_input() const;
   MSSMatMGUT_mAmu_input_parameters& get_input();
   void set_input_parameters(const MSSMatMGUT_mAmu_input_parameters&);

   MSSMatMGUT_mAmu_susy_parameters calc_beta() const;
   MSSMatMGUT_mAmu_susy_parameters calc_beta(int) const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const MSSMatMGUT_mAmu_susy_parameters&);
