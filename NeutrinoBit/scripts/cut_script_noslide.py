...
with h5py.File(out_file_path, 'w') as out_f:
    ...
    for dataset_name in group.keys():
        ...
        if dataset_name == "LogLike":
          masked_set = group[dataset_name][mask][cuts] - group["#RHN_coupling_slide @NeutrinoBit::coupling_slide"][mask][cuts]
          print group["#RHN_coupling_slide @NeutrinoBit::coupling_slide"][mask][cuts]
        else:
