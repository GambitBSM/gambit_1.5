...
///  \file
///
///  "Header" declarations for VectorDMSpec class
...
#ifndef VectorDMSPEC_HEAD_H
#define VectorDMSPEC_HEAD_H
...
namespace Gambit 
{
   ...
   template <>
   template <class MI>
   struct SpecTraits<SpecBit::VectorDMSpec<MI>>
   {
      static std::string name() { return "VectorDMSpec"; }
   ...
   {
      template <class MI>
      class VectorDMSpec : public Spec<VectorDMSpec<MI>>
      {
         private:
            str backend_name;
            str backend_version;
         ...
         public:
            ...
            //constructors
            VectorDMSpec();
            VectorDMSpec(MI, str backend_name, str backend_version);
            ...
            template<class VectorDMlike>
            void get_lowe_data_from(VectorDMlike &othermodel)
            {
