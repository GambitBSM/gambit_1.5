...
namespace Gambit
{
  ...
  namespace SpecBit
  {
    ...
    void fill_map_from_SingletDMZ3spectrum(std::map<std::string,double>&, const Spectrum&);
    ...
    void get_SingletDM_spectrum_as_map (std::map<std::string,double>& specmap)
    {
      ...
      fill_map_from_SingletDMspectrum(specmap, singletdmspec);
		...
		void get_SingletDMZ3_spectrum_as_map (std::map<std::string,double>& specmap)
    {
      namespace myPipe = Pipes::get_SingletDMZ3_spectrum_as_map;
      const Spectrum& singletdmspec(*myPipe::Dep::SingletDMZ3_spectrum);
      fill_map_from_SingletDMZ3spectrum(specmap, singletdmspec);
    }
    ...
    void fill_map_from_SingletDMZ3spectrum(std::map<std::string,double>& specmap, const Spectrum& singletdmspec)
    {
      /// Add everything... use spectrum contents routines to automate task
      static const SpectrumContents::SingletDMZ3 contents;
      static const std::vector<SpectrumParameter> required_parameters = contents.all_parameters();
