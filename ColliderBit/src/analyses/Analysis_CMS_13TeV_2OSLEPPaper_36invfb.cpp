...
namespace Gambit {
  namespace ColliderBit {
	...
	cutflowFile<<"$\\sigma (pp\\to \\tilde{\\chi}_{1}^{\\pm}, \\tilde{\\chi}_{2}^{0})$ &"<<setprecision(4)<<xsecCMS_550_200<<" $fb$ &"<<setprecision(4)<<xsec<<"$fb$ &"<<setprecision(4)<<xsec/xsecCMS_550_200<<" & 1\\\\ \\hline"<<
endl;
