    ...
    public:
      ...
      void collect_results() {
       ...
       // cutflowFile.close();
        ...
        const int SR_labels[SR_size] = {1, 2, 3, 4, 5, 6, 7, 8, 9};
        const double SR_nums[SR_size] = {
          _numSR1, _numSR2, _numSR3, _numSR4, _numSR5, _numSR6, _numSR7, _numSR8, _numSR9,
        };

        // Observed event counts
        static const double OBSNUM[SR_size] = {
          793., 57., 29., 2., 0., 82., 9., 5., 1.
        };
        // Background estimates
        static const double BKGNUM[SR_size] = {
          793., 54.9, 21.6, 6., 2.5, 82., 7.6, 5.6, 1.3
        };
        // Background uncertainties, same-flavor signal regions
        static const double BKGERR[SR_size] = {
          32.2, 7., 5.6, 1.9, 0.9, 9.5, 2.8, 1.6, 0.4,
        };
