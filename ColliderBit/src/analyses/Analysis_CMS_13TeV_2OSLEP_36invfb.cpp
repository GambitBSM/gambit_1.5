...
namespace Gambit {
  namespace ColliderBit {
    ...
    class Analysis_CMS_13TeV_2OSLEPPaper_36invfb : public HEPUtilsAnalysis {
    private:
    ...
    public:
      ...
      Analysis_CMS_13TeV_2OSLEPPaper_36invfb() 
      {
        _numSR1=0;
        _numSR2=0;
        _numSR3=0;
      ...
      void analyze(const HEPUtils::Event* event) 
      {
        ...
        for (size_t j=0;j<NCUTS;j++)
        {
          if(
            ...
            (j==8 && preselection && (baselineMuons.size()+baselineElectrons.size())==2 &&  mll>86. && mll<96. && nSignalJets>=2 && pT_j1>35. && deltaPhi_met_j0>0.4 && deltaPhi_met_j1>0.4 && nSignalBJets==0 && mT2>80. && mjj<150.) ||

            (j==9 && preselection && (baselineMuons.size()+baselineElectrons.size())==2 &&  mll>86. && mll<96. && nSignalJets>=2 && pT_j1>35. && deltaPhi_met_j0>0.4 && deltaPhi_met_j1>0.4 && nSignalBJets==0 && mT2>80. && mjj<150. && met>100.) ||

            (j==10 && preselection && (baselineMuons.size()+baselineElectrons.size())==2 &&  mll>86. && mll<96. && nSignalJets>=2 && pT_j1>35. && deltaPhi_met_j0>0.4 && deltaPhi_met_j1>0.4 && nSignalBJets==0 && mT2>80. && mjj<150. && met>150.) ||

            (j==11 && preselection && (baselineMuons.size()+baselineElectrons.size())==2 &&  mll>86. && mll<96. && nSignalJets>=2 && pT_j1>35. && deltaPhi_met_j0>0.4 && deltaPhi_met_j1>0.4 && nSignalBJets==0 && mT2>80. && mjj<150. && met>250.) ||

            (j==12 && preselection && (baselineMuons.size()+baselineElectrons.size())==2 &&  mll>86. && mll<96. && nSignalJets>=2 && pT_j1>35. && deltaPhi_met_j0>0.4 && deltaPhi_met_j1>0.4 && nSignalBJets==0 && mT2>80. && mjj<150. && met>350.) 
            )
      ...
      void add(BaseAnalysis* other) 
      {
        ...
        Analysis_CMS_13TeV_2OSLEPPaper_36invfb* specificOther
                = dynamic_cast<Analysis_CMS_13TeV_2OSLEPPaper_36invfb*>(other);
      ...
      void collect_results() 
      {
        ...
        // results_SR1.analysis_name = "Analysis_CMS_13TeV_2OSLEPPaper_36invfb";
        ...
        // results_SR2.analysis_name = "Analysis_CMS_13TeV_2OSLEPPaper_36invfb";
        ...
        // results_SR3.analysis_name = "Analysis_CMS_13TeV_2OSLEPPaper_36invfb";
        ...
        // results_SR4.analysis_name = "Analysis_CMS_13TeV_2OSLEPPaper_36invfb";
        ...
        // results_SR5.analysis_name = "Analysis_CMS_13TeV_2OSLEPPaper_36invfb";
        ...
        // results_SR6.analysis_name = "Analysis_CMS_13TeV_2OSLEPPaper_36invfb";
        ...
        // results_SR7.analysis_name = "Analysis_CMS_13TeV_2OSLEPPaper_36invfb";
        ...
        // results_SR8.analysis_name = "Analysis_CMS_13TeV_2OSLEPPaper_36invfb";
        ...
        // results_SR9.analysis_name = "Analysis_CMS_13TeV_2OSLEPPaper_36invfb";
    ...
    // Factory fn
    DEFINE_ANALYSIS_FACTORY(CMS_13TeV_2OSLEPPaper_36invfb)
