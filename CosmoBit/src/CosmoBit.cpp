...
namespace Gambit
{
  ...
  namespace CosmoBit
  {
    ...
    void set_baseline_classy_input(pybind11::dict &result)
    {
      ...
      if (ModelInUse("cosmo_nuisance_Planck_lite") || ModelInUse("cosmo_nuisance_Planck_TTTEEE")|| ModelInUse("cosmo_nuisance_Planck_TT") || ModelInUse("plik_dx11dr2_HM_v18_TT"))
      {
